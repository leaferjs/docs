...
```html [editor.min]
<script src="https://unpkg.com/@leafer-in/editor@2.0.7/dist/editor.min.js"></script>
<script src="https://unpkg.com/@leafer-in/resize@2.0.7/dist/resize.min.js"></script>
<script>
...
```html [editor]
<script src="https://unpkg.com/@leafer-in/editor@2.0.7/dist/editor.js"></script>
<script src="https://unpkg.com/@leafer-in/resize@2.0.7/dist/resize.js"></script>
<script>
  const { Editor } = LeaferIN.editor
</script>
```
