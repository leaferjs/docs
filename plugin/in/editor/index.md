...
```html [editor.min]
<script src="https://unpkg.com/@leafer-in/editor@1.9.9/dist/editor.min.js"></script>
<script src="https://unpkg.com/@leafer-in/resize@1.9.9/dist/resize.min.js"></script>
<script>
...
```html [editor]
<script src="https://unpkg.com/@leafer-in/editor@1.9.9/dist/editor.js"></script>
<script src="https://unpkg.com/@leafer-in/resize@1.9.9/dist/resize.js"></script>
<script>
  const { Editor } = LeaferIN.editor
</script>
```
