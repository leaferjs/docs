...
<script src="https://unpkg.com/@leafer-in/motion-path@1.9.3/dist/motion-path.min.js"></script>
```

```html [motion-path]
<script src="https://unpkg.com/@leafer-in/motion-path@1.9.3/dist/motion-path.js"></script>
```
