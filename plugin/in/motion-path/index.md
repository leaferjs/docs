...
<script src="https://unpkg.com/@leafer-in/motion-path@1.6.7/dist/motion-path.min.js"></script>
```

```html [motion-path]
<script src="https://unpkg.com/@leafer-in/motion-path@1.6.7/dist/motion-path.js"></script>
```
