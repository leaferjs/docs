...
```html [animate.min]
<script src="https://unpkg.com/@leafer-in/animate@1.9.2/dist/animate.min.js"></script>
...
```html [animate]
<script src="https://unpkg.com/@leafer-in/animate@1.9.2/dist/animate.js"></script>
