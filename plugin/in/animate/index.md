...
```html [animate.min]
<script src="https://unpkg.com/@leafer-in/animate@1.9.6/dist/animate.min.js"></script>
<script src="https://unpkg.com/@leafer-in/color@1.9.6/dist/color.min.js"></script>
<script>
...
```html [animate]
<script src="https://unpkg.com/@leafer-in/animate@1.9.6/dist/animate.js"></script>
<script src="https://unpkg.com/@leafer-in/color@1.9.6/dist/color.js"></script>
<script>
  const { Animate } = LeaferIN.animate
</script>
```
