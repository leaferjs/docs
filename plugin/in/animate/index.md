...
```html [animate.min]
<script src="https://unpkg.com/@leafer-in/animate@1.9.10/dist/animate.min.js"></script>
...
```html [animate]
<script src="https://unpkg.com/@leafer-in/animate@1.9.10/dist/animate.js"></script>
