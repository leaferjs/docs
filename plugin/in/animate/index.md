...
```html [animate.min]
<script src="https://unpkg.com/@leafer-in/animate@1.5.1/dist/animate.min.js"></script>
<script src="https://unpkg.com/@leafer-in/color@1.5.1/dist/color.min.js"></script>
<script>
...
```html [animate]
<script src="https://unpkg.com/@leafer-in/animate@1.5.1/dist/animate.js"></script>
<script src="https://unpkg.com/@leafer-in/color@1.5.1/dist/color.js"></script>
<script>
  const { Animate } = LeaferIN.animate
</script>
```
