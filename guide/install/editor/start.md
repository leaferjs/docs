...
```html [web.min]
<script src="https://unpkg.com/leafer-editor@1.9.4/dist/web.min.js"></script>
<script>
...
<script type="module">
  import {
    ...
    Editor,
    Arrow,
  } from 'https://unpkg.com/leafer-editor@1.9.4/dist/web.module.min.js'
  // ...
</script>
```
...
<script type="module">
  import {
    ...
    Editor,
    Arrow,
  } from 'https://unpkg.com/leafer-editor@1.9.4/dist/web.module.js'
  // ...
</script>
```
