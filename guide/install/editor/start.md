...
```html [web.min]
<script src="https://unpkg.com/leafer-editor@1.12.2/dist/web.min.js"></script>
<script>
...
```html [web]
<script src="https://unpkg.com/leafer-editor@1.12.2/dist/web.js"></script>
<script>
  const { Leafer, Editor, Arrow } = LeaferUI
  // ...
</script>
...
<script type="module">
  import {
    ...
    Editor,
    Arrow,
  } from 'https://unpkg.com/leafer-editor@1.12.2/dist/web.module.min.js'
  // ...
</script>
```
...
<script type="module">
  import {
    ...
    Editor,
    Arrow,
  } from 'https://unpkg.com/leafer-editor@1.12.2/dist/web.module.js'
  // ...
</script>
```
