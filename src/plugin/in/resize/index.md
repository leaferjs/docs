...
```html [resize.min]
<script src="https://unpkg.com/@leafer-in/resize@1.0.0-rc.28/dist/resize.min.js"></script>
```

```html [resize]
<script src="https://unpkg.com/@leafer-in/resize@1.0.0-rc.28/dist/resize.js"></script>
```
