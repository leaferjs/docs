...
```html [arrow.min]
<script src="https://unpkg.com/@leafer-in/arrow@1.0.0-rc.28/dist/arrow.min.js"></script>
<script>
...
```html [arrow]
<script src="https://unpkg.com/@leafer-in/arrow@1.0.0-rc.28/dist/arrow.js"></script>
<script>
  const { Arrow } = LeaferIN.arrow
</script>
```
