...
```html [animate.min]
<script src="https://unpkg.com/@leafer-in/animate@1.0.6/dist/animate.min.js"></script>
<script>
...
```html [animate]
<script src="https://unpkg.com/@leafer-in/animate@1.0.6/dist/animate.js"></script>
<script>
  const { Animate } = LeaferIN.animate
</script>
```
