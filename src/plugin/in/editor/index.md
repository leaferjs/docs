...
```html [editor.min]
<script src="https://unpkg.com/@leafer-in/editor@1.0.0-rc.28/dist/editor.min.js"></script>
<script>
...
```html [editor]
<script src="https://unpkg.com/@leafer-in/editor@1.0.0-rc.28/dist/editor.js"></script>
<script>
  const { Editor } = LeaferIN.editor
</script>
```
