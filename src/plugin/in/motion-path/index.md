...
<script src="https://unpkg.com/@leafer-in/motion-path@1.0.10/dist/motion-path.min.js"></script>
```

```html [motion-path]
<script src="https://unpkg.com/@leafer-in/motion-path@1.0.10/dist/motion-path.js"></script>
```
