...
```html [state.min]
<script src="https://unpkg.com/@leafer-in/state@1.0.0-rc.28/dist/state.min.js"></script>
```

```html [state]
<script src="https://unpkg.com/@leafer-in/state@1.0.0-rc.28/dist/state.js"></script>
```
