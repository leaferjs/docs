...
```html [view.min]
<script src="https://unpkg.com/@leafer-in/view@1.0.0-rc.28/dist/view.min.js"></script>
```

```html [view]
<script src="https://unpkg.com/@leafer-in/view@1.0.0-rc.28/dist/view.js"></script>
```
