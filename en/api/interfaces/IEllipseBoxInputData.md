# Interface: IEllipseBoxInputData
...
- [id](IEllipseBoxInputData.md#id)
- [name](IEllipseBoxInputData.md#name)
- [className](IEllipseBoxInputData.md#classname)
- [blendMode](IEllipseBoxInputData.md#blendmode)
- [opacity](IEllipseBoxInputData.md#opacity)
- [visible](IEllipseBoxInputData.md#visible)
- [selected](IEllipseBoxInputData.md#selected)
- [disabled](IEllipseBoxInputData.md#disabled)
- [locked](IEllipseBoxInputData.md#locked)
- [zIndex](IEllipseBoxInputData.md#zindex)
- [dim](IEllipseBoxInputData.md#dim)
- [dimskip](IEllipseBoxInputData.md#dimskip)
- [bright](IEllipseBoxInputData.md#bright)
- [mask](IEllipseBoxInputData.md#mask)
- [eraser](IEllipseBoxInputData.md#eraser)
- [filter](IEllipseBoxInputData.md#filter)
- [complex](IEllipseBoxInputData.md#complex)
- [x](IEllipseBoxInputData.md#x)
- [y](IEllipseBoxInputData.md#y)
- [width](IEllipseBoxInputData.md#width)
- [height](IEllipseBoxInputData.md#height)
- [scaleX](IEllipseBoxInputData.md#scalex)
- [scaleY](IEllipseBoxInputData.md#scaley)
- [scaleFixed](IEllipseBoxInputData.md#scalefixed)
- [rotation](IEllipseBoxInputData.md#rotation)
- [skewX](IEllipseBoxInputData.md#skewx)
- [skewY](IEllipseBoxInputData.md#skewy)
- [scale](IEllipseBoxInputData.md#scale)
- [offsetX](IEllipseBoxInputData.md#offsetx)
- [offsetY](IEllipseBoxInputData.md#offsety)
- [scrollX](IEllipseBoxInputData.md#scrollx)
- [scrollY](IEllipseBoxInputData.md#scrolly)
- [origin](IEllipseBoxInputData.md#origin)
- [around](IEllipseBoxInputData.md#around)
- [lazy](IEllipseBoxInputData.md#lazy)
- [pixelRatio](IEllipseBoxInputData.md#pixelratio)
- [renderSpread](IEllipseBoxInputData.md#renderspread)
- [path](IEllipseBoxInputData.md#path)
- [windingRule](IEllipseBoxInputData.md#windingrule)
- [closed](IEllipseBoxInputData.md#closed)
- [flow](IEllipseBoxInputData.md#flow)
- [padding](IEllipseBoxInputData.md#padding)
- [gap](IEllipseBoxInputData.md#gap)
- [flowAlign](IEllipseBoxInputData.md#flowalign)
- [flowWrap](IEllipseBoxInputData.md#flowwrap)
- [itemBox](IEllipseBoxInputData.md#itembox)
- [inFlow](IEllipseBoxInputData.md#inflow)
- [autoWidth](IEllipseBoxInputData.md#autowidth)
- [autoHeight](IEllipseBoxInputData.md#autoheight)
- [lockRatio](IEllipseBoxInputData.md#lockratio)
- [autoBox](IEllipseBoxInputData.md#autobox)
- [widthRange](IEllipseBoxInputData.md#widthrange)
- [heightRange](IEllipseBoxInputData.md#heightrange)
- [draggable](IEllipseBoxInputData.md#draggable)
- [dragBounds](IEllipseBoxInputData.md#dragbounds)
- [dragBoundsType](IEllipseBoxInputData.md#dragboundstype)
- [editable](IEllipseBoxInputData.md#editable)
- [hittable](IEllipseBoxInputData.md#hittable)
- [hitFill](IEllipseBoxInputData.md#hitfill)
- [hitStroke](IEllipseBoxInputData.md#hitstroke)
- [hitBox](IEllipseBoxInputData.md#hitbox)
- [hitChildren](IEllipseBoxInputData.md#hitchildren)
- [hitSelf](IEllipseBoxInputData.md#hitself)
- [hitRadius](IEllipseBoxInputData.md#hitradius)
- [button](IEllipseBoxInputData.md#button)
- [cursor](IEllipseBoxInputData.md#cursor)
- [motionPath](IEllipseBoxInputData.md#motionpath)
- [motionPrecision](IEllipseBoxInputData.md#motionprecision)
- [motion](IEllipseBoxInputData.md#motion)
- [motionRotation](IEllipseBoxInputData.md#motionrotation)
- [normalStyle](IEllipseBoxInputData.md#normalstyle)
- [event](IEllipseBoxInputData.md#event)
- [data](IEllipseBoxInputData.md#data)
- [tag](IEllipseBoxInputData.md#tag)
- [cornerRadius](IEllipseBoxInputData.md#cornerradius)
- [cornerSmoothing](IEllipseBoxInputData.md#cornersmoothing)
- [fill](IEllipseBoxInputData.md#fill)
- [stroke](IEllipseBoxInputData.md#stroke)
- [startArrow](IEllipseBoxInputData.md#startarrow)
- [endArrow](IEllipseBoxInputData.md#endarrow)
- [strokeAlign](IEllipseBoxInputData.md#strokealign)
- [strokeWidth](IEllipseBoxInputData.md#strokewidth)
- [strokeScaleFixed](IEllipseBoxInputData.md#strokescalefixed)
- [strokeCap](IEllipseBoxInputData.md#strokecap)
- [strokeJoin](IEllipseBoxInputData.md#strokejoin)
- [dashPattern](IEllipseBoxInputData.md#dashpattern)
- [dashOffset](IEllipseBoxInputData.md#dashoffset)
- [miterLimit](IEllipseBoxInputData.md#miterlimit)
- [fontFamily](IEllipseBoxInputData.md#fontfamily)
- [fontSize](IEllipseBoxInputData.md#fontsize)
- [fontWeight](IEllipseBoxInputData.md#fontweight)
- [italic](IEllipseBoxInputData.md#italic)
- [textCase](IEllipseBoxInputData.md#textcase)
- [textDecoration](IEllipseBoxInputData.md#textdecoration)
- [letterSpacing](IEllipseBoxInputData.md#letterspacing)
- [lineHeight](IEllipseBoxInputData.md#lineheight)
- [paraIndent](IEllipseBoxInputData.md#paraindent)
- [paraSpacing](IEllipseBoxInputData.md#paraspacing)
- [writingMode](IEllipseBoxInputData.md#writingmode)
- [textAlign](IEllipseBoxInputData.md#textalign)
- [verticalAlign](IEllipseBoxInputData.md#verticalalign)
- [autoSizeAlign](IEllipseBoxInputData.md#autosizealign)
- [textWrap](IEllipseBoxInputData.md#textwrap)
- [textOverflow](IEllipseBoxInputData.md#textoverflow)
- [shadow](IEllipseBoxInputData.md#shadow)
- [innerShadow](IEllipseBoxInputData.md#innershadow)
- [blur](IEllipseBoxInputData.md#blur)
- [backgroundBlur](IEllipseBoxInputData.md#backgroundblur)
- [grayscale](IEllipseBoxInputData.md#grayscale)
- [startAngle](IEllipseBoxInputData.md#startangle)
- [endAngle](IEllipseBoxInputData.md#endangle)
- [innerRadius](IEllipseBoxInputData.md#innerradius)
- [overflow](IEllipseBoxInputData.md#overflow)
- [scrollConfig](IEllipseBoxInputData.md#scrollconfig)
- [resizeChildren](IEllipseBoxInputData.md#resizechildren)
- [textBox](IEllipseBoxInputData.md#textbox)
- [animation](IEllipseBoxInputData.md#animation)
- [animationOut](IEllipseBoxInputData.md#animationout)
- [transition](IEllipseBoxInputData.md#transition)
- [transitionOut](IEllipseBoxInputData.md#transitionout)
- [states](IEllipseBoxInputData.md#states)
- [state](IEllipseBoxInputData.md#state)
- [hoverStyle](IEllipseBoxInputData.md#hoverstyle)
- [pressStyle](IEllipseBoxInputData.md#pressstyle)
- [focusStyle](IEllipseBoxInputData.md#focusstyle)
- [selectedStyle](IEllipseBoxInputData.md#selectedstyle)
- [disabledStyle](IEllipseBoxInputData.md#disabledstyle)
- [placeholderStyle](IEllipseBoxInputData.md#placeholderstyle)
- [placeholderColor](IEllipseBoxInputData.md#placeholdercolor)
- [placeholderDelay](IEllipseBoxInputData.md#placeholderdelay)
- [editConfig](IEllipseBoxInputData.md#editconfig)
- [editOuter](IEllipseBoxInputData.md#editouter)
- [editInner](IEllipseBoxInputData.md#editinner)
- [children](IEllipseBoxInputData.md#children)
