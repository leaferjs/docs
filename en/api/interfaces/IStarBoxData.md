...
- [\_\_leaf](IStarBoxData.md#__leaf)
- [\_\_input](IStarBoxData.md#__input)
- [\_\_middle](IStarBoxData.md#__middle)
- [\_\_single](IStarBoxData.md#__single)
- [\_\_willDestroy](IStarBoxData.md#__willdestroy)
- [id](IStarBoxData.md#id)
- [name](IStarBoxData.md#name)
- [className](IStarBoxData.md#classname)
- [blendMode](IStarBoxData.md#blendmode)
- [opacity](IStarBoxData.md#opacity)
- [visible](IStarBoxData.md#visible)
- [selected](IStarBoxData.md#selected)
- [disabled](IStarBoxData.md#disabled)
- [locked](IStarBoxData.md#locked)
- [zIndex](IStarBoxData.md#zindex)
- [dim](IStarBoxData.md#dim)
- [dimskip](IStarBoxData.md#dimskip)
- [bright](IStarBoxData.md#bright)
- [mask](IStarBoxData.md#mask)
- [eraser](IStarBoxData.md#eraser)
- [filter](IStarBoxData.md#filter)
- [complex](IStarBoxData.md#complex)
- [x](IStarBoxData.md#x)
- [y](IStarBoxData.md#y)
- [width](IStarBoxData.md#width)
- [height](IStarBoxData.md#height)
- [scaleX](IStarBoxData.md#scalex)
- [scaleY](IStarBoxData.md#scaley)
- [scaleFixed](IStarBoxData.md#scalefixed)
- [rotation](IStarBoxData.md#rotation)
- [skewX](IStarBoxData.md#skewx)
- [skewY](IStarBoxData.md#skewy)
- [offsetX](IStarBoxData.md#offsetx)
- [offsetY](IStarBoxData.md#offsety)
- [scrollX](IStarBoxData.md#scrollx)
- [scrollY](IStarBoxData.md#scrolly)
- [origin](IStarBoxData.md#origin)
- [around](IStarBoxData.md#around)
- [lazy](IStarBoxData.md#lazy)
- [pixelRatio](IStarBoxData.md#pixelratio)
- [renderSpread](IStarBoxData.md#renderspread)
- [path](IStarBoxData.md#path)
- [windingRule](IStarBoxData.md#windingrule)
- [closed](IStarBoxData.md#closed)
- [flow](IStarBoxData.md#flow)
- [padding](IStarBoxData.md#padding)
- [gap](IStarBoxData.md#gap)
- [flowAlign](IStarBoxData.md#flowalign)
- [flowWrap](IStarBoxData.md#flowwrap)
- [itemBox](IStarBoxData.md#itembox)
- [inFlow](IStarBoxData.md#inflow)
- [autoWidth](IStarBoxData.md#autowidth)
- [autoHeight](IStarBoxData.md#autoheight)
- [lockRatio](IStarBoxData.md#lockratio)
- [autoBox](IStarBoxData.md#autobox)
- [widthRange](IStarBoxData.md#widthrange)
- [heightRange](IStarBoxData.md#heightrange)
- [draggable](IStarBoxData.md#draggable)
- [dragBounds](IStarBoxData.md#dragbounds)
- [dragBoundsType](IStarBoxData.md#dragboundstype)
- [editable](IStarBoxData.md#editable)
- [hittable](IStarBoxData.md#hittable)
- [hitFill](IStarBoxData.md#hitfill)
- [hitStroke](IStarBoxData.md#hitstroke)
- [hitBox](IStarBoxData.md#hitbox)
- [hitChildren](IStarBoxData.md#hitchildren)
- [hitSelf](IStarBoxData.md#hitself)
- [hitRadius](IStarBoxData.md#hitradius)
- [button](IStarBoxData.md#button)
- [cursor](IStarBoxData.md#cursor)
- [motionPath](IStarBoxData.md#motionpath)
- [motionPrecision](IStarBoxData.md#motionprecision)
- [motion](IStarBoxData.md#motion)
- [motionRotation](IStarBoxData.md#motionrotation)
- [normalStyle](IStarBoxData.md#normalstyle)
- [data](IStarBoxData.md#data)
- [\_\_childBranchNumber](IStarBoxData.md#__childbranchnumber)
- [\_\_complex](IStarBoxData.md#__complex)
- [\_\_complexData](IStarBoxData.md#__complexdata)
- [\_\_naturalWidth](IStarBoxData.md#__naturalwidth)
- [\_\_naturalHeight](IStarBoxData.md#__naturalheight)
- [\_\_autoWidth](IStarBoxData.md#__autowidth)
- [\_\_autoHeight](IStarBoxData.md#__autoheight)
- [\_\_autoSide](IStarBoxData.md#__autoside)
- [\_\_autoSize](IStarBoxData.md#__autosize)
- [\_\_useNaturalRatio](IStarBoxData.md#__usenaturalratio)
- [\_\_isLinePath](IStarBoxData.md#__islinepath)
- [\_\_blendMode](IStarBoxData.md#__blendmode)
- [\_\_useStroke](IStarBoxData.md#__usestroke)
- [\_\_useArrow](IStarBoxData.md#__usearrow)
- [\_\_useEffect](IStarBoxData.md#__useeffect)
- [\_\_usePathBox](IStarBoxData.md#__usepathbox)
- [\_\_useDim](IStarBoxData.md#__usedim)
- [\_\_pathInputed](IStarBoxData.md#__pathinputed)
- [\_\_pathForRender](IStarBoxData.md#__pathforrender)
- [\_\_path2DForRender](IStarBoxData.md#__path2dforrender)
- [\_\_startArrowPath](IStarBoxData.md#__startarrowpath)
- [\_\_endArrowPath](IStarBoxData.md#__endarrowpath)
- [\_\_pathForMotion](IStarBoxData.md#__pathformotion)
- [cornerRadius](IStarBoxData.md#cornerradius)
- [cornerSmoothing](IStarBoxData.md#cornersmoothing)
- [fill](IStarBoxData.md#fill)
- [borderWidth](IStarBoxData.md#borderwidth)
- [borderRadius](IStarBoxData.md#borderradius)
- [stroke](IStarBoxData.md#stroke)
- [startArrow](IStarBoxData.md#startarrow)
- [endArrow](IStarBoxData.md#endarrow)
- [strokeAlign](IStarBoxData.md#strokealign)
- [strokeWidth](IStarBoxData.md#strokewidth)
- [strokeWidths](IStarBoxData.md#strokewidths)
- [strokeScaleFixed](IStarBoxData.md#strokescalefixed)
- [strokeCap](IStarBoxData.md#strokecap)
- [strokeJoin](IStarBoxData.md#strokejoin)
- [dashPattern](IStarBoxData.md#dashpattern)
- [dashOffset](IStarBoxData.md#dashoffset)
- [miterLimit](IStarBoxData.md#miterlimit)
- [fontFamily](IStarBoxData.md#fontfamily)
- [fontSize](IStarBoxData.md#fontsize)
- [fontWeight](IStarBoxData.md#fontweight)
- [italic](IStarBoxData.md#italic)
- [textCase](IStarBoxData.md#textcase)
- [textDecoration](IStarBoxData.md#textdecoration)
- [letterSpacing](IStarBoxData.md#letterspacing)
- [lineHeight](IStarBoxData.md#lineheight)
- [paraIndent](IStarBoxData.md#paraindent)
- [paraSpacing](IStarBoxData.md#paraspacing)
- [writingMode](IStarBoxData.md#writingmode)
- [textAlign](IStarBoxData.md#textalign)
- [verticalAlign](IStarBoxData.md#verticalalign)
- [autoSizeAlign](IStarBoxData.md#autosizealign)
- [textWrap](IStarBoxData.md#textwrap)
- [textOverflow](IStarBoxData.md#textoverflow)
- [shadow](IStarBoxData.md#shadow)
- [innerShadow](IStarBoxData.md#innershadow)
- [blur](IStarBoxData.md#blur)
- [backgroundBlur](IStarBoxData.md#backgroundblur)
- [grayscale](IStarBoxData.md#grayscale)
- [corners](IStarBoxData.md#corners)
- [innerRadius](IStarBoxData.md#innerradius)
- [overflow](IStarBoxData.md#overflow)
- [scrollConfig](IStarBoxData.md#scrollconfig)
- [resizeChildren](IStarBoxData.md#resizechildren)
- [textBox](IStarBoxData.md#textbox)
- [animation](IStarBoxData.md#animation)
- [animationOut](IStarBoxData.md#animationout)
- [transition](IStarBoxData.md#transition)
- [transitionOut](IStarBoxData.md#transitionout)
- [states](IStarBoxData.md#states)
- [state](IStarBoxData.md#state)
- [hoverStyle](IStarBoxData.md#hoverstyle)
- [pressStyle](IStarBoxData.md#pressstyle)
- [focusStyle](IStarBoxData.md#focusstyle)
- [selectedStyle](IStarBoxData.md#selectedstyle)
- [disabledStyle](IStarBoxData.md#disabledstyle)
- [placeholderStyle](IStarBoxData.md#placeholderstyle)
- [placeholderColor](IStarBoxData.md#placeholdercolor)
- [placeholderDelay](IStarBoxData.md#placeholderdelay)
- [editConfig](IStarBoxData.md#editconfig)
- [editOuter](IStarBoxData.md#editouter)
- [editInner](IStarBoxData.md#editinner)
- [scale](IStarBoxData.md#scale)
- [\_\_isFills](IStarBoxData.md#__isfills)
- [\_\_isStrokes](IStarBoxData.md#__isstrokes)
- [\_\_strokeWidth](IStarBoxData.md#__strokewidth)
- [\_\_maxStrokeWidth](IStarBoxData.md#__maxstrokewidth)
- [\_\_strokeWidthCache](IStarBoxData.md#__strokewidthcache)
- [\_\_hasMultiStrokeStyle](IStarBoxData.md#__hasmultistrokestyle)
- [\_\_hasMultiPaint](IStarBoxData.md#__hasmultipaint)
- [\_\_isAlphaPixelFill](IStarBoxData.md#__isalphapixelfill)
- [\_\_isAlphaPixelStroke](IStarBoxData.md#__isalphapixelstroke)
- [\_\_isTransparentFill](IStarBoxData.md#__istransparentfill)
- [\_\_isTransparentStroke](IStarBoxData.md#__istransparentstroke)
- [\_\_isHitPixel](IStarBoxData.md#__ishitpixel)
- [\_\_isCanvas](IStarBoxData.md#__iscanvas)
- [\_\_isFastShadow](IStarBoxData.md#__isfastshadow)
- [\_\_fillAfterStroke](IStarBoxData.md#__fillafterstroke)
- [\_\_drawAfterFill](IStarBoxData.md#__drawafterfill)
- [\_\_clipAfterFill](IStarBoxData.md#__clipafterfill)
- [\_\_hasSurface](IStarBoxData.md#__hassurface)
- [\_\_blendLayer](IStarBoxData.md#__blendlayer)
- [\_\_boxStroke](IStarBoxData.md#__boxstroke)
- [\_\_font](IStarBoxData.md#__font)
- [\_\_textDrawData](IStarBoxData.md#__textdrawdata)
- [\_\_needComputePaint](IStarBoxData.md#__needcomputepaint)

### Methods

- [\_\_get](IStarBoxData.md#__get)
- [\_\_getData](IStarBoxData.md#__getdata)
- [\_\_setInput](IStarBoxData.md#__setinput)
- [\_\_getInput](IStarBoxData.md#__getinput)
- [\_\_removeInput](IStarBoxData.md#__removeinput)
- [\_\_getInputData](IStarBoxData.md#__getinputdata)
- [\_\_setMiddle](IStarBoxData.md#__setmiddle)
- [\_\_getMiddle](IStarBoxData.md#__getmiddle)
- [destroy](IStarBoxData.md#destroy)
- [\_\_checkSingle](IStarBoxData.md#__checksingle)
- [\_\_removeNaturalSize](IStarBoxData.md#__removenaturalsize)
- [\_\_computePaint](IStarBoxData.md#__computepaint)
- [\_\_getRealStrokeWidth](IStarBoxData.md#__getrealstrokewidth)
- [\_\_setPaint](IStarBoxData.md#__setpaint)
- [\_\_removePaint](IStarBoxData.md#__removepaint)
