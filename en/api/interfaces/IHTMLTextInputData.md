...
- [scaleFixed](IHTMLTextInputData.md#scalefixed)
...
- [renderSpread](IHTMLTextInputData.md#renderspread)
...
- [autoBox](IHTMLTextInputData.md#autobox)
...
- [dragBoundsType](IHTMLTextInputData.md#dragboundstype)
...
- [strokeScaleFixed](IHTMLTextInputData.md#strokescalefixed)
...
- [foreground](IHTMLTextInputData.md#foreground)
- [background](IHTMLTextInputData.md#background)
...
- [state](IHTMLTextInputData.md#state)
