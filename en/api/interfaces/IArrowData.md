...
- [\_\_willDestroy](IArrowData.md#__willdestroy)
- [id](IArrowData.md#id)
...
- [scaleFixed](IArrowData.md#scalefixed)
...
- [flowAlign](IArrowData.md#flowalign)
...
- [\_\_complexData](IArrowData.md#__complexdata)
...
- [\_\_startArrowPath](IArrowData.md#__startarrowpath)
- [\_\_endArrowPath](IArrowData.md#__endarrowpath)
...
- [strokeScaleFixed](IArrowData.md#strokescalefixed)
- [strokeCap](IArrowData.md#strokecap)
- [strokeJoin](IArrowData.md#strokejoin)
- [dashPattern](IArrowData.md#dashpattern)
...
- [\_\_strokeWidthCache](IArrowData.md#__strokewidthcache)
