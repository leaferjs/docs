...
- [scaleFixed](ILeaferInputData.md#scalefixed)
...
- [renderSpread](ILeaferInputData.md#renderspread)
...
- [heightRange](ILeaferInputData.md#heightrange)
- [draggable](ILeaferInputData.md#draggable)
- [dragBounds](ILeaferInputData.md#dragbounds)
- [dragBoundsType](ILeaferInputData.md#dragboundstype)
...
- [strokeScaleFixed](ILeaferInputData.md#strokescalefixed)
...
- [focusStyle](ILeaferInputData.md#focusstyle)
...
- [placeholderColor](ILeaferInputData.md#placeholdercolor)
- [placeholderDelay](ILeaferInputData.md#placeholderdelay)
...
[IGroupInputData](IGroupInputData.md).[bright](IGroupInputData.md#bright)
...
[IGroupInputData](IGroupInputData.md).[complex](IGroupInputData.md#complex)
...
[IGroupInputData](IGroupInputData.md).[scaleFixed](IGroupInputData.md#scalefixed)
...
[IGroupInputData](IGroupInputData.md).[strokeScaleFixed](IGroupInputData.md#strokescalefixed)
