...
- [`IGroup`](IGroup.md)
  ...
  ↳↳ [`IEllipseBox`](IEllipseBox.md)

  ↳↳ [`IPolygonBox`](IPolygonBox.md)

  ↳↳ [`IStarBox`](IStarBox.md)

  ↳↳ [`IPathBox`](IPathBox.md)

  ↳↳ [`IImageBox`](IImageBox.md)
...
- [bright](IBox.md#bright)
- [mask](IBox.md#mask)
- [eraser](IBox.md#eraser)
- [filter](IBox.md#filter)
- [complex](IBox.md#complex)
- [x](IBox.md#x)
- [y](IBox.md#y)
- [width](IBox.md#width)
...
- [\_\_nowWorldShapeBounds](IBox.md#__nowworldshapebounds)
...
- [strokeScaleFixed](IBox.md#strokescalefixed)
...
- [startLinker](IBox.md#startlinker)
- [endLinker](IBox.md#endlinker)
- [\_\_box](IBox.md#__box)
- [\_\_animate](IBox.md#__animate)
- [pen](IBox.md#pen)
...
- [\_\_getNowWorld](IBox.md#__getnowworld)
...
- [\_\_updateMotionPath](IBox.md#__updatemotionpath)
...
- [clearProxyData](IBox.md#clearproxydata)
- [find](IBox.md#find)
...
▸ **get**\<`K`\>(`name`): [`IBox`](IBox.md)[`K`]

#### Type parameters

| Name | Type                            |
| :--- | :------------------------------ |
| `K`  | extends keyof [`IBox`](IBox.md) |
