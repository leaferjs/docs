...
- [id](IStarBoxInputData.md#id)
- [name](IStarBoxInputData.md#name)
- [className](IStarBoxInputData.md#classname)
- [blendMode](IStarBoxInputData.md#blendmode)
- [opacity](IStarBoxInputData.md#opacity)
- [visible](IStarBoxInputData.md#visible)
- [selected](IStarBoxInputData.md#selected)
- [disabled](IStarBoxInputData.md#disabled)
- [locked](IStarBoxInputData.md#locked)
- [zIndex](IStarBoxInputData.md#zindex)
- [dim](IStarBoxInputData.md#dim)
- [dimskip](IStarBoxInputData.md#dimskip)
- [bright](IStarBoxInputData.md#bright)
- [mask](IStarBoxInputData.md#mask)
- [eraser](IStarBoxInputData.md#eraser)
- [filter](IStarBoxInputData.md#filter)
- [complex](IStarBoxInputData.md#complex)
- [x](IStarBoxInputData.md#x)
- [y](IStarBoxInputData.md#y)
- [width](IStarBoxInputData.md#width)
- [height](IStarBoxInputData.md#height)
- [scaleX](IStarBoxInputData.md#scalex)
- [scaleY](IStarBoxInputData.md#scaley)
- [scaleFixed](IStarBoxInputData.md#scalefixed)
- [rotation](IStarBoxInputData.md#rotation)
- [skewX](IStarBoxInputData.md#skewx)
- [skewY](IStarBoxInputData.md#skewy)
- [scale](IStarBoxInputData.md#scale)
- [offsetX](IStarBoxInputData.md#offsetx)
- [offsetY](IStarBoxInputData.md#offsety)
- [scrollX](IStarBoxInputData.md#scrollx)
- [scrollY](IStarBoxInputData.md#scrolly)
- [origin](IStarBoxInputData.md#origin)
- [around](IStarBoxInputData.md#around)
- [lazy](IStarBoxInputData.md#lazy)
- [pixelRatio](IStarBoxInputData.md#pixelratio)
- [renderSpread](IStarBoxInputData.md#renderspread)
- [path](IStarBoxInputData.md#path)
- [windingRule](IStarBoxInputData.md#windingrule)
- [closed](IStarBoxInputData.md#closed)
- [flow](IStarBoxInputData.md#flow)
- [padding](IStarBoxInputData.md#padding)
- [gap](IStarBoxInputData.md#gap)
- [flowAlign](IStarBoxInputData.md#flowalign)
- [flowWrap](IStarBoxInputData.md#flowwrap)
- [itemBox](IStarBoxInputData.md#itembox)
- [inFlow](IStarBoxInputData.md#inflow)
- [autoWidth](IStarBoxInputData.md#autowidth)
- [autoHeight](IStarBoxInputData.md#autoheight)
- [lockRatio](IStarBoxInputData.md#lockratio)
- [autoBox](IStarBoxInputData.md#autobox)
- [widthRange](IStarBoxInputData.md#widthrange)
- [heightRange](IStarBoxInputData.md#heightrange)
- [draggable](IStarBoxInputData.md#draggable)
- [dragBounds](IStarBoxInputData.md#dragbounds)
- [dragBoundsType](IStarBoxInputData.md#dragboundstype)
- [editable](IStarBoxInputData.md#editable)
- [hittable](IStarBoxInputData.md#hittable)
- [hitFill](IStarBoxInputData.md#hitfill)
- [hitStroke](IStarBoxInputData.md#hitstroke)
- [hitBox](IStarBoxInputData.md#hitbox)
- [hitChildren](IStarBoxInputData.md#hitchildren)
- [hitSelf](IStarBoxInputData.md#hitself)
- [hitRadius](IStarBoxInputData.md#hitradius)
- [button](IStarBoxInputData.md#button)
- [cursor](IStarBoxInputData.md#cursor)
- [motionPath](IStarBoxInputData.md#motionpath)
- [motionPrecision](IStarBoxInputData.md#motionprecision)
- [motion](IStarBoxInputData.md#motion)
- [motionRotation](IStarBoxInputData.md#motionrotation)
- [normalStyle](IStarBoxInputData.md#normalstyle)
- [event](IStarBoxInputData.md#event)
- [data](IStarBoxInputData.md#data)
- [tag](IStarBoxInputData.md#tag)
- [cornerRadius](IStarBoxInputData.md#cornerradius)
- [cornerSmoothing](IStarBoxInputData.md#cornersmoothing)
- [fill](IStarBoxInputData.md#fill)
- [stroke](IStarBoxInputData.md#stroke)
- [startArrow](IStarBoxInputData.md#startarrow)
- [endArrow](IStarBoxInputData.md#endarrow)
- [strokeAlign](IStarBoxInputData.md#strokealign)
- [strokeWidth](IStarBoxInputData.md#strokewidth)
- [strokeScaleFixed](IStarBoxInputData.md#strokescalefixed)
- [strokeCap](IStarBoxInputData.md#strokecap)
- [strokeJoin](IStarBoxInputData.md#strokejoin)
- [dashPattern](IStarBoxInputData.md#dashpattern)
- [dashOffset](IStarBoxInputData.md#dashoffset)
- [miterLimit](IStarBoxInputData.md#miterlimit)
- [fontFamily](IStarBoxInputData.md#fontfamily)
- [fontSize](IStarBoxInputData.md#fontsize)
- [fontWeight](IStarBoxInputData.md#fontweight)
- [italic](IStarBoxInputData.md#italic)
- [textCase](IStarBoxInputData.md#textcase)
- [textDecoration](IStarBoxInputData.md#textdecoration)
- [letterSpacing](IStarBoxInputData.md#letterspacing)
- [lineHeight](IStarBoxInputData.md#lineheight)
- [paraIndent](IStarBoxInputData.md#paraindent)
- [paraSpacing](IStarBoxInputData.md#paraspacing)
- [writingMode](IStarBoxInputData.md#writingmode)
- [textAlign](IStarBoxInputData.md#textalign)
- [verticalAlign](IStarBoxInputData.md#verticalalign)
- [autoSizeAlign](IStarBoxInputData.md#autosizealign)
- [textWrap](IStarBoxInputData.md#textwrap)
- [textOverflow](IStarBoxInputData.md#textoverflow)
- [shadow](IStarBoxInputData.md#shadow)
- [innerShadow](IStarBoxInputData.md#innershadow)
- [blur](IStarBoxInputData.md#blur)
- [backgroundBlur](IStarBoxInputData.md#backgroundblur)
- [grayscale](IStarBoxInputData.md#grayscale)
- [corners](IStarBoxInputData.md#corners)
- [innerRadius](IStarBoxInputData.md#innerradius)
- [overflow](IStarBoxInputData.md#overflow)
- [scrollConfig](IStarBoxInputData.md#scrollconfig)
- [resizeChildren](IStarBoxInputData.md#resizechildren)
- [textBox](IStarBoxInputData.md#textbox)
- [animation](IStarBoxInputData.md#animation)
- [animationOut](IStarBoxInputData.md#animationout)
- [transition](IStarBoxInputData.md#transition)
- [transitionOut](IStarBoxInputData.md#transitionout)
- [states](IStarBoxInputData.md#states)
- [state](IStarBoxInputData.md#state)
- [hoverStyle](IStarBoxInputData.md#hoverstyle)
- [pressStyle](IStarBoxInputData.md#pressstyle)
- [focusStyle](IStarBoxInputData.md#focusstyle)
- [selectedStyle](IStarBoxInputData.md#selectedstyle)
- [disabledStyle](IStarBoxInputData.md#disabledstyle)
- [placeholderStyle](IStarBoxInputData.md#placeholderstyle)
- [placeholderColor](IStarBoxInputData.md#placeholdercolor)
- [placeholderDelay](IStarBoxInputData.md#placeholderdelay)
- [editConfig](IStarBoxInputData.md#editconfig)
- [editOuter](IStarBoxInputData.md#editouter)
- [editInner](IStarBoxInputData.md#editinner)
- [children](IStarBoxInputData.md#children)
