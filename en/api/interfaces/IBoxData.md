...
- [`IGroupData`](IGroupData.md)
  ...
  ↳↳ [`IEllipseBoxData`](IEllipseBoxData.md)

  ↳↳ [`IPolygonBoxData`](IPolygonBoxData.md)

  ↳↳ [`IStarBoxData`](IStarBoxData.md)

  ↳↳ [`IPathBoxData`](IPathBoxData.md)

  ↳↳ [`IImageBoxData`](IImageBoxData.md)
...
- [\_\_willDestroy](IBoxData.md#__willdestroy)
- [id](IBoxData.md#id)
...
- [scaleFixed](IBoxData.md#scalefixed)
...
- [\_\_complexData](IBoxData.md#__complexdata)
...
- [\_\_startArrowPath](IBoxData.md#__startarrowpath)
- [\_\_endArrowPath](IBoxData.md#__endarrowpath)
...
- [strokeScaleFixed](IBoxData.md#strokescalefixed)
...
- [\_\_strokeWidthCache](IBoxData.md#__strokewidthcache)
