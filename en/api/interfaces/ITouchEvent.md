...
- [origin](ITouchEvent.md#origin)
- [type](ITouchEvent.md#type)
- [target](ITouchEvent.md#target)
- [current](ITouchEvent.md#current)
- [bubbles](ITouchEvent.md#bubbles)
- [phase](ITouchEvent.md#phase)
- [isStopDefault](ITouchEvent.md#isstopdefault)
- [isStop](ITouchEvent.md#isstop)
- [isStopNow](ITouchEvent.md#isstopnow)
- [x](ITouchEvent.md#x)
- [y](ITouchEvent.md#y)
- [altKey](ITouchEvent.md#altkey)
- [ctrlKey](ITouchEvent.md#ctrlkey)
- [shiftKey](ITouchEvent.md#shiftkey)
- [metaKey](ITouchEvent.md#metakey)
- [spaceKey](ITouchEvent.md#spacekey)
- [left](ITouchEvent.md#left)
- [right](ITouchEvent.md#right)
- [middle](ITouchEvent.md#middle)
- [buttons](ITouchEvent.md#buttons)
- [path](ITouchEvent.md#path)
- [throughPath](ITouchEvent.md#throughpath)
- [time](ITouchEvent.md#time)

### Methods

- [stopDefault](ITouchEvent.md#stopdefault)
- [stopNow](ITouchEvent.md#stopnow)
- [stop](ITouchEvent.md#stop)
- [isHoldKeys](ITouchEvent.md#isholdkeys)
- [getBoxPoint](ITouchEvent.md#getboxpoint)
- [getInnerPoint](ITouchEvent.md#getinnerpoint)
- [getLocalPoint](ITouchEvent.md#getlocalpoint)
- [getPagePoint](ITouchEvent.md#getpagepoint)
- [getInner](ITouchEvent.md#getinner)
- [getLocal](ITouchEvent.md#getlocal)
- [getPage](ITouchEvent.md#getpage)
