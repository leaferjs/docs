...
- [id](ISelectArea.md#id)
- [name](ISelectArea.md#name)
- [className](ISelectArea.md#classname)
- [blendMode](ISelectArea.md#blendmode)
- [opacity](ISelectArea.md#opacity)
- [visible](ISelectArea.md#visible)
- [selected](ISelectArea.md#selected)
- [disabled](ISelectArea.md#disabled)
- [locked](ISelectArea.md#locked)
- [zIndex](ISelectArea.md#zindex)
- [dim](ISelectArea.md#dim)
- [dimskip](ISelectArea.md#dimskip)
- [bright](ISelectArea.md#bright)
- [mask](ISelectArea.md#mask)
- [eraser](ISelectArea.md#eraser)
- [filter](ISelectArea.md#filter)
- [complex](ISelectArea.md#complex)
- [x](ISelectArea.md#x)
- [y](ISelectArea.md#y)
- [width](ISelectArea.md#width)
- [height](ISelectArea.md#height)
- [scaleX](ISelectArea.md#scalex)
- [scaleY](ISelectArea.md#scaley)
- [scaleFixed](ISelectArea.md#scalefixed)
- [rotation](ISelectArea.md#rotation)
- [skewX](ISelectArea.md#skewx)
- [skewY](ISelectArea.md#skewy)
- [scale](ISelectArea.md#scale)
- [offsetX](ISelectArea.md#offsetx)
- [offsetY](ISelectArea.md#offsety)
- [scrollX](ISelectArea.md#scrollx)
- [scrollY](ISelectArea.md#scrolly)
- [origin](ISelectArea.md#origin)
- [around](ISelectArea.md#around)
- [lazy](ISelectArea.md#lazy)
- [pixelRatio](ISelectArea.md#pixelratio)
- [renderSpread](ISelectArea.md#renderspread)
- [path](ISelectArea.md#path)
- [windingRule](ISelectArea.md#windingrule)
- [closed](ISelectArea.md#closed)
- [flow](ISelectArea.md#flow)
- [padding](ISelectArea.md#padding)
- [gap](ISelectArea.md#gap)
- [flowAlign](ISelectArea.md#flowalign)
- [flowWrap](ISelectArea.md#flowwrap)
- [itemBox](ISelectArea.md#itembox)
- [inFlow](ISelectArea.md#inflow)
- [autoWidth](ISelectArea.md#autowidth)
- [autoHeight](ISelectArea.md#autoheight)
- [lockRatio](ISelectArea.md#lockratio)
- [autoBox](ISelectArea.md#autobox)
- [widthRange](ISelectArea.md#widthrange)
- [heightRange](ISelectArea.md#heightrange)
- [draggable](ISelectArea.md#draggable)
- [dragBounds](ISelectArea.md#dragbounds)
- [dragBoundsType](ISelectArea.md#dragboundstype)
- [editable](ISelectArea.md#editable)
- [hittable](ISelectArea.md#hittable)
- [hitFill](ISelectArea.md#hitfill)
- [hitStroke](ISelectArea.md#hitstroke)
- [hitBox](ISelectArea.md#hitbox)
- [hitChildren](ISelectArea.md#hitchildren)
- [hitSelf](ISelectArea.md#hitself)
- [hitRadius](ISelectArea.md#hitradius)
- [button](ISelectArea.md#button)
- [cursor](ISelectArea.md#cursor)
- [motionPath](ISelectArea.md#motionpath)
- [motionPrecision](ISelectArea.md#motionprecision)
- [motion](ISelectArea.md#motion)
- [motionRotation](ISelectArea.md#motionrotation)
- [normalStyle](ISelectArea.md#normalstyle)
- [event](ISelectArea.md#event)
- [data](ISelectArea.md#data)
- [tag](ISelectArea.md#tag)
- [\_\_tag](ISelectArea.md#__tag)
- [innerName](ISelectArea.md#innername)
- [\_\_DataProcessor](ISelectArea.md#__dataprocessor)
- [\_\_LayoutProcessor](ISelectArea.md#__layoutprocessor)
- [leaferIsCreated](ISelectArea.md#leaferiscreated)
- [leaferIsReady](ISelectArea.md#leaferisready)
- [isApp](ISelectArea.md#isapp)
- [isLeafer](ISelectArea.md#isleafer)
- [isBranch](ISelectArea.md#isbranch)
- [isBranchLeaf](ISelectArea.md#isbranchleaf)
- [isOutside](ISelectArea.md#isoutside)
- [skipJSON](ISelectArea.md#skipjson)
- [syncEventer](ISelectArea.md#synceventer)
- [lockNormalStyle](ISelectArea.md#locknormalstyle)
- [\_\_layout](ISelectArea.md#__layout)
- [\_\_world](ISelectArea.md#__world)
- [\_\_local](ISelectArea.md#__local)
- [\_\_nowWorld](ISelectArea.md#__nowworld)
- [\_\_cameraWorld](ISelectArea.md#__cameraworld)
- [\_\_nowWorldShapeBounds](ISelectArea.md#__nowworldshapebounds)
- [\_\_localMatrix](ISelectArea.md#__localmatrix)
- [\_\_localBoxBounds](ISelectArea.md#__localboxbounds)
- [\_\_worldOpacity](ISelectArea.md#__worldopacity)
- [worldTransform](ISelectArea.md#worldtransform)
- [localTransform](ISelectArea.md#localtransform)
- [\_\_scrollWorld](ISelectArea.md#__scrollworld)
- [scrollWorldTransform](ISelectArea.md#scrollworldtransform)
- [boxBounds](ISelectArea.md#boxbounds)
- [renderBounds](ISelectArea.md#renderbounds)
- [worldBoxBounds](ISelectArea.md#worldboxbounds)
- [worldStrokeBounds](ISelectArea.md#worldstrokebounds)
- [worldRenderBounds](ISelectArea.md#worldrenderbounds)
- [worldOpacity](ISelectArea.md#worldopacity)
- [\_\_level](ISelectArea.md#__level)
- [\_\_tempNumber](ISelectArea.md#__tempnumber)
- [\_\_worldFlipped](ISelectArea.md#__worldflipped)
- [\_\_hasAutoLayout](ISelectArea.md#__hasautolayout)
- [\_\_hasMotionPath](ISelectArea.md#__hasmotionpath)
- [\_\_hasComplex](ISelectArea.md#__hascomplex)
- [\_\_hasMask](ISelectArea.md#__hasmask)
- [\_\_hasEraser](ISelectArea.md#__haseraser)
- [\_\_hitCanvas](ISelectArea.md#__hitcanvas)
- [\_\_flowBounds](ISelectArea.md#__flowbounds)
- [\_\_widthGrow](ISelectArea.md#__widthgrow)
- [\_\_heightGrow](ISelectArea.md#__heightgrow)
- [\_\_hasGrow](ISelectArea.md#__hasgrow)
- [\_\_onlyHitMask](ISelectArea.md#__onlyhitmask)
- [\_\_ignoreHitWorld](ISelectArea.md#__ignorehitworld)
- [\_\_inLazyBounds](ISelectArea.md#__inlazybounds)
- [pathInputed](ISelectArea.md#pathinputed)
- [isAutoWidth](ISelectArea.md#isautowidth)
- [isAutoHeight](ISelectArea.md#isautoheight)
- [destroyed](ISelectArea.md#destroyed)
- [topChildren](ISelectArea.md#topchildren)
- [innerId](ISelectArea.md#innerid)
- [\_\_captureMap](ISelectArea.md#__capturemap)
- [\_\_bubbleMap](ISelectArea.md#__bubblemap)
- [\_\_hasLocalEvent](ISelectArea.md#__haslocalevent)
- [\_\_hasWorldEvent](ISelectArea.md#__hasworldevent)
- [cornerRadius](ISelectArea.md#cornerradius)
- [cornerSmoothing](ISelectArea.md#cornersmoothing)
- [fill](ISelectArea.md#fill)
- [stroke](ISelectArea.md#stroke)
- [startArrow](ISelectArea.md#startarrow)
- [endArrow](ISelectArea.md#endarrow)
- [strokeAlign](ISelectArea.md#strokealign)
- [strokeWidth](ISelectArea.md#strokewidth)
- [strokeScaleFixed](ISelectArea.md#strokescalefixed)
- [strokeCap](ISelectArea.md#strokecap)
- [strokeJoin](ISelectArea.md#strokejoin)
- [dashPattern](ISelectArea.md#dashpattern)
- [dashOffset](ISelectArea.md#dashoffset)
- [miterLimit](ISelectArea.md#miterlimit)
- [shadow](ISelectArea.md#shadow)
- [innerShadow](ISelectArea.md#innershadow)
- [blur](ISelectArea.md#blur)
- [backgroundBlur](ISelectArea.md#backgroundblur)
- [grayscale](ISelectArea.md#grayscale)
- [\_\_](ISelectArea.md#__)
- [children](ISelectArea.md#children)
- [childlessJSON](ISelectArea.md#childlessjson)
- [app](ISelectArea.md#app)
- [leafer](ISelectArea.md#leafer)
- [parent](ISelectArea.md#parent)
- [zoomLayer](ISelectArea.md#zoomlayer)
- [isFrame](ISelectArea.md#isframe)
- [isOverflow](ISelectArea.md#isoverflow)
- [useFastShadow](ISelectArea.md#usefastshadow)
- [proxyData](ISelectArea.md#proxydata)
- [\_\_proxyData](ISelectArea.md#__proxydata)
- [animation](ISelectArea.md#animation)
- [animationOut](ISelectArea.md#animationout)
- [startLinker](ISelectArea.md#startlinker)
- [endLinker](ISelectArea.md#endlinker)
- [\_\_box](ISelectArea.md#__box)
- [\_\_animate](ISelectArea.md#__animate)
- [pen](ISelectArea.md#pen)
- [transition](ISelectArea.md#transition)
- [transitionOut](ISelectArea.md#transitionout)
- [states](ISelectArea.md#states)
- [state](ISelectArea.md#state)
- [hoverStyle](ISelectArea.md#hoverstyle)
- [pressStyle](ISelectArea.md#pressstyle)
- [focusStyle](ISelectArea.md#focusstyle)
- [selectedStyle](ISelectArea.md#selectedstyle)
- [disabledStyle](ISelectArea.md#disabledstyle)
- [placeholderStyle](ISelectArea.md#placeholderstyle)
- [placeholderColor](ISelectArea.md#placeholdercolor)
- [placeholderDelay](ISelectArea.md#placeholderdelay)
- [editConfig](ISelectArea.md#editconfig)
- [editOuter](ISelectArea.md#editouter)
- [editInner](ISelectArea.md#editinner)

### Methods

- [setStyle](ISelectArea.md#setstyle)
- [setBounds](ISelectArea.md#setbounds)
- [resetCustom](ISelectArea.md#resetcustom)
- [waitParent](ISelectArea.md#waitparent)
- [waitLeafer](ISelectArea.md#waitleafer)
- [nextRender](ISelectArea.md#nextrender)
- [removeNextRender](ISelectArea.md#removenextrender)
- [\_\_bindLeafer](ISelectArea.md#__bindleafer)
- [setAttr](ISelectArea.md#setattr)
- [getAttr](ISelectArea.md#getattr)
- [getComputedAttr](ISelectArea.md#getcomputedattr)
- [toString](ISelectArea.md#tostring)
- [toSVG](ISelectArea.md#tosvg)
- [\_\_SVG](ISelectArea.md#__svg)
- [toHTML](ISelectArea.md#tohtml)
- [\_\_setAttr](ISelectArea.md#__setattr)
- [\_\_getAttr](ISelectArea.md#__getattr)
- [setProxyAttr](ISelectArea.md#setproxyattr)
- [getProxyAttr](ISelectArea.md#getproxyattr)
- [focus](ISelectArea.md#focus)
- [updateState](ISelectArea.md#updatestate)
- [updateLayout](ISelectArea.md#updatelayout)
- [forceUpdate](ISelectArea.md#forceupdate)
- [forceRender](ISelectArea.md#forcerender)
- [\_\_extraUpdate](ISelectArea.md#__extraupdate)
- [\_\_updateWorldMatrix](ISelectArea.md#__updateworldmatrix)
- [\_\_updateLocalMatrix](ISelectArea.md#__updatelocalmatrix)
- [\_\_updateWorldBounds](ISelectArea.md#__updateworldbounds)
- [\_\_updateLocalBounds](ISelectArea.md#__updatelocalbounds)
- [\_\_updateLocalBoxBounds](ISelectArea.md#__updatelocalboxbounds)
- [\_\_updateLocalStrokeBounds](ISelectArea.md#__updatelocalstrokebounds)
- [\_\_updateLocalRenderBounds](ISelectArea.md#__updatelocalrenderbounds)
- [\_\_updateContentBounds](ISelectArea.md#__updatecontentbounds)
- [\_\_updateBoxBounds](ISelectArea.md#__updateboxbounds)
- [\_\_updateStrokeBounds](ISelectArea.md#__updatestrokebounds)
- [\_\_updateRenderBounds](ISelectArea.md#__updaterenderbounds)
- [\_\_updateAutoLayout](ISelectArea.md#__updateautolayout)
- [\_\_updateFlowLayout](ISelectArea.md#__updateflowlayout)
- [\_\_updateNaturalSize](ISelectArea.md#__updatenaturalsize)
- [\_\_updateStrokeSpread](ISelectArea.md#__updatestrokespread)
- [\_\_updateRenderSpread](ISelectArea.md#__updaterenderspread)
- [\_\_onUpdateSize](ISelectArea.md#__onupdatesize)
- [\_\_updateEraser](ISelectArea.md#__updateeraser)
- [\_\_updateMask](ISelectArea.md#__updatemask)
- [\_\_renderMask](ISelectArea.md#__rendermask)
- [\_\_renderEraser](ISelectArea.md#__rendereraser)
- [\_\_getNowWorld](ISelectArea.md#__getnowworld)
- [getClampRenderScale](ISelectArea.md#getclamprenderscale)
- [getRenderScaleData](ISelectArea.md#getrenderscaledata)
- [getTransform](ISelectArea.md#gettransform)
- [getBounds](ISelectArea.md#getbounds)
- [getLayoutBounds](ISelectArea.md#getlayoutbounds)
- [getLayoutPoints](ISelectArea.md#getlayoutpoints)
- [getWorldBounds](ISelectArea.md#getworldbounds)
- [worldToLocal](ISelectArea.md#worldtolocal)
- [localToWorld](ISelectArea.md#localtoworld)
- [worldToInner](ISelectArea.md#worldtoinner)
- [innerToWorld](ISelectArea.md#innertoworld)
- [getBoxPoint](ISelectArea.md#getboxpoint)
- [getBoxPointByInner](ISelectArea.md#getboxpointbyinner)
- [getInnerPoint](ISelectArea.md#getinnerpoint)
- [getInnerPointByBox](ISelectArea.md#getinnerpointbybox)
- [getInnerPointByLocal](ISelectArea.md#getinnerpointbylocal)
- [getLocalPoint](ISelectArea.md#getlocalpoint)
- [getLocalPointByInner](ISelectArea.md#getlocalpointbyinner)
- [getPagePoint](ISelectArea.md#getpagepoint)
- [getWorldPoint](ISelectArea.md#getworldpoint)
- [getWorldPointByBox](ISelectArea.md#getworldpointbybox)
- [getWorldPointByLocal](ISelectArea.md#getworldpointbylocal)
- [getWorldPointByPage](ISelectArea.md#getworldpointbypage)
- [setTransform](ISelectArea.md#settransform)
- [transform](ISelectArea.md#transform)
- [move](ISelectArea.md#move)
- [moveInner](ISelectArea.md#moveinner)
- [scaleOf](ISelectArea.md#scaleof)
- [rotateOf](ISelectArea.md#rotateof)
- [skewOf](ISelectArea.md#skewof)
- [transformWorld](ISelectArea.md#transformworld)
- [moveWorld](ISelectArea.md#moveworld)
- [scaleOfWorld](ISelectArea.md#scaleofworld)
- [rotateOfWorld](ISelectArea.md#rotateofworld)
- [skewOfWorld](ISelectArea.md#skewofworld)
- [flip](ISelectArea.md#flip)
- [scaleResize](ISelectArea.md#scaleresize)
- [\_\_scaleResize](ISelectArea.md#__scaleresize)
- [resizeWidth](ISelectArea.md#resizewidth)
- [resizeHeight](ISelectArea.md#resizeheight)
- [hit](ISelectArea.md#hit)
- [\_\_hitWorld](ISelectArea.md#__hitworld)
- [\_\_hit](ISelectArea.md#__hit)
- [\_\_hitFill](ISelectArea.md#__hitfill)
- [\_\_hitStroke](ISelectArea.md#__hitstroke)
- [\_\_hitPixel](ISelectArea.md#__hitpixel)
- [\_\_drawHitPath](ISelectArea.md#__drawhitpath)
- [\_\_updateHitCanvas](ISelectArea.md#__updatehitcanvas)
- [\_\_render](ISelectArea.md#__render)
- [\_\_drawFast](ISelectArea.md#__drawfast)
- [\_\_draw](ISelectArea.md#__draw)
- [\_\_clip](ISelectArea.md#__clip)
- [\_\_renderShape](ISelectArea.md#__rendershape)
- [\_\_drawShape](ISelectArea.md#__drawshape)
- [\_\_updateWorldOpacity](ISelectArea.md#__updateworldopacity)
- [\_\_updateChange](ISelectArea.md#__updatechange)
- [\_\_drawPath](ISelectArea.md#__drawpath)
- [\_\_drawRenderPath](ISelectArea.md#__drawrenderpath)
- [\_\_updatePath](ISelectArea.md#__updatepath)
- [\_\_updateRenderPath](ISelectArea.md#__updaterenderpath)
- [getMotionPathData](ISelectArea.md#getmotionpathdata)
- [getMotionPoint](ISelectArea.md#getmotionpoint)
- [getMotionTotal](ISelectArea.md#getmotiontotal)
- [\_\_updateMotionPath](ISelectArea.md#__updatemotionpath)
- [\_\_runAnimation](ISelectArea.md#__runanimation)
- [\_\_emitLifeEvent](ISelectArea.md#__emitlifeevent)
- [\_\_updateSortChildren](ISelectArea.md#__updatesortchildren)
- [dropTo](ISelectArea.md#dropto)
- [\_\_realSetAttr](ISelectArea.md#__realsetattr)
- [emitPropertyEvent](ISelectArea.md#emitpropertyevent)
- [destroyEventer](ISelectArea.md#destroyeventer)
- [on](ISelectArea.md#on)
- [off](ISelectArea.md#off)
- [on\_](ISelectArea.md#on_)
- [off\_](ISelectArea.md#off_)
- [once](ISelectArea.md#once)
- [emit](ISelectArea.md#emit)
- [emitEvent](ISelectArea.md#emitevent)
- [hasEvent](ISelectArea.md#hasevent)
- [destroy](ISelectArea.md#destroy)
- [pick](ISelectArea.md#pick)
- [add](ISelectArea.md#add)
- [addAt](ISelectArea.md#addat)
- [addAfter](ISelectArea.md#addafter)
- [addBefore](ISelectArea.md#addbefore)
- [addMany](ISelectArea.md#addmany)
- [remove](ISelectArea.md#remove)
- [removeAll](ISelectArea.md#removeall)
- [clear](ISelectArea.md#clear)
- [reset](ISelectArea.md#reset)
- [set](ISelectArea.md#set)
- [toJSON](ISelectArea.md#tojson)
- [get](ISelectArea.md#get)
- [createProxyData](ISelectArea.md#createproxydata)
- [clearProxyData](ISelectArea.md#clearproxydata)
- [find](ISelectArea.md#find)
- [findTag](ISelectArea.md#findtag)
- [findOne](ISelectArea.md#findone)
- [findId](ISelectArea.md#findid)
- [getPath](ISelectArea.md#getpath)
- [getPathString](ISelectArea.md#getpathstring)
- [asPath](ISelectArea.md#aspath)
- [load](ISelectArea.md#load)
- [\_\_drawPathByData](ISelectArea.md#__drawpathbydata)
- [\_\_drawPathByBox](ISelectArea.md#__drawpathbybox)
- [\_\_drawAfterFill](ISelectArea.md#__drawafterfill)
- [\_\_drawContent](ISelectArea.md#__drawcontent)
- [drawImagePlaceholder](ISelectArea.md#drawimageplaceholder)
- [animate](ISelectArea.md#animate)
- [killAnimate](ISelectArea.md#killanimate)
- [export](ISelectArea.md#export)
- [syncExport](ISelectArea.md#syncexport)
- [clone](ISelectArea.md#clone)
...
| `userStyle?` | [`IRectInputData`](IRectInputData.md) |
...
[src/in/packages/interface/src/editor/ISelectArea.ts:4](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/ISelectArea.ts#L4)
...
[src/in/packages/interface/src/editor/ISelectArea.ts:5](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/ISelectArea.ts#L5)
...
▸ **get**\<`K`\>(`name`): [`ISelectArea`](ISelectArea.md)[`K`]

#### Type parameters

| Name | Type                                          |
| :--- | :-------------------------------------------- |
| `K`  | extends keyof [`ISelectArea`](ISelectArea.md) |
