...
- [id](IPathBoxInputData.md#id)
- [name](IPathBoxInputData.md#name)
- [className](IPathBoxInputData.md#classname)
- [blendMode](IPathBoxInputData.md#blendmode)
- [opacity](IPathBoxInputData.md#opacity)
- [visible](IPathBoxInputData.md#visible)
- [selected](IPathBoxInputData.md#selected)
- [disabled](IPathBoxInputData.md#disabled)
- [locked](IPathBoxInputData.md#locked)
- [zIndex](IPathBoxInputData.md#zindex)
- [dim](IPathBoxInputData.md#dim)
- [dimskip](IPathBoxInputData.md#dimskip)
- [bright](IPathBoxInputData.md#bright)
- [mask](IPathBoxInputData.md#mask)
- [eraser](IPathBoxInputData.md#eraser)
- [filter](IPathBoxInputData.md#filter)
- [complex](IPathBoxInputData.md#complex)
- [x](IPathBoxInputData.md#x)
- [y](IPathBoxInputData.md#y)
- [width](IPathBoxInputData.md#width)
- [height](IPathBoxInputData.md#height)
- [scaleX](IPathBoxInputData.md#scalex)
- [scaleY](IPathBoxInputData.md#scaley)
- [scaleFixed](IPathBoxInputData.md#scalefixed)
- [rotation](IPathBoxInputData.md#rotation)
- [skewX](IPathBoxInputData.md#skewx)
- [skewY](IPathBoxInputData.md#skewy)
- [scale](IPathBoxInputData.md#scale)
- [offsetX](IPathBoxInputData.md#offsetx)
- [offsetY](IPathBoxInputData.md#offsety)
- [scrollX](IPathBoxInputData.md#scrollx)
- [scrollY](IPathBoxInputData.md#scrolly)
- [origin](IPathBoxInputData.md#origin)
- [around](IPathBoxInputData.md#around)
- [lazy](IPathBoxInputData.md#lazy)
- [pixelRatio](IPathBoxInputData.md#pixelratio)
- [renderSpread](IPathBoxInputData.md#renderspread)
- [path](IPathBoxInputData.md#path)
- [windingRule](IPathBoxInputData.md#windingrule)
- [closed](IPathBoxInputData.md#closed)
- [flow](IPathBoxInputData.md#flow)
- [padding](IPathBoxInputData.md#padding)
- [gap](IPathBoxInputData.md#gap)
- [flowAlign](IPathBoxInputData.md#flowalign)
- [flowWrap](IPathBoxInputData.md#flowwrap)
- [itemBox](IPathBoxInputData.md#itembox)
- [inFlow](IPathBoxInputData.md#inflow)
- [autoWidth](IPathBoxInputData.md#autowidth)
- [autoHeight](IPathBoxInputData.md#autoheight)
- [lockRatio](IPathBoxInputData.md#lockratio)
- [autoBox](IPathBoxInputData.md#autobox)
- [widthRange](IPathBoxInputData.md#widthrange)
- [heightRange](IPathBoxInputData.md#heightrange)
- [draggable](IPathBoxInputData.md#draggable)
- [dragBounds](IPathBoxInputData.md#dragbounds)
- [dragBoundsType](IPathBoxInputData.md#dragboundstype)
- [editable](IPathBoxInputData.md#editable)
- [hittable](IPathBoxInputData.md#hittable)
- [hitFill](IPathBoxInputData.md#hitfill)
- [hitStroke](IPathBoxInputData.md#hitstroke)
- [hitBox](IPathBoxInputData.md#hitbox)
- [hitChildren](IPathBoxInputData.md#hitchildren)
- [hitSelf](IPathBoxInputData.md#hitself)
- [hitRadius](IPathBoxInputData.md#hitradius)
- [button](IPathBoxInputData.md#button)
- [cursor](IPathBoxInputData.md#cursor)
- [motionPath](IPathBoxInputData.md#motionpath)
- [motionPrecision](IPathBoxInputData.md#motionprecision)
- [motion](IPathBoxInputData.md#motion)
- [motionRotation](IPathBoxInputData.md#motionrotation)
- [normalStyle](IPathBoxInputData.md#normalstyle)
- [event](IPathBoxInputData.md#event)
- [data](IPathBoxInputData.md#data)
- [tag](IPathBoxInputData.md#tag)
- [cornerRadius](IPathBoxInputData.md#cornerradius)
- [cornerSmoothing](IPathBoxInputData.md#cornersmoothing)
- [fill](IPathBoxInputData.md#fill)
- [stroke](IPathBoxInputData.md#stroke)
- [startArrow](IPathBoxInputData.md#startarrow)
- [endArrow](IPathBoxInputData.md#endarrow)
- [strokeAlign](IPathBoxInputData.md#strokealign)
- [strokeWidth](IPathBoxInputData.md#strokewidth)
- [strokeScaleFixed](IPathBoxInputData.md#strokescalefixed)
- [strokeCap](IPathBoxInputData.md#strokecap)
- [strokeJoin](IPathBoxInputData.md#strokejoin)
- [dashPattern](IPathBoxInputData.md#dashpattern)
- [dashOffset](IPathBoxInputData.md#dashoffset)
- [miterLimit](IPathBoxInputData.md#miterlimit)
- [fontFamily](IPathBoxInputData.md#fontfamily)
- [fontSize](IPathBoxInputData.md#fontsize)
- [fontWeight](IPathBoxInputData.md#fontweight)
- [italic](IPathBoxInputData.md#italic)
- [textCase](IPathBoxInputData.md#textcase)
- [textDecoration](IPathBoxInputData.md#textdecoration)
- [letterSpacing](IPathBoxInputData.md#letterspacing)
- [lineHeight](IPathBoxInputData.md#lineheight)
- [paraIndent](IPathBoxInputData.md#paraindent)
- [paraSpacing](IPathBoxInputData.md#paraspacing)
- [writingMode](IPathBoxInputData.md#writingmode)
- [textAlign](IPathBoxInputData.md#textalign)
- [verticalAlign](IPathBoxInputData.md#verticalalign)
- [autoSizeAlign](IPathBoxInputData.md#autosizealign)
- [textWrap](IPathBoxInputData.md#textwrap)
- [textOverflow](IPathBoxInputData.md#textoverflow)
- [shadow](IPathBoxInputData.md#shadow)
- [innerShadow](IPathBoxInputData.md#innershadow)
- [blur](IPathBoxInputData.md#blur)
- [backgroundBlur](IPathBoxInputData.md#backgroundblur)
- [grayscale](IPathBoxInputData.md#grayscale)
- [overflow](IPathBoxInputData.md#overflow)
- [scrollConfig](IPathBoxInputData.md#scrollconfig)
- [resizeChildren](IPathBoxInputData.md#resizechildren)
- [textBox](IPathBoxInputData.md#textbox)
- [animation](IPathBoxInputData.md#animation)
- [animationOut](IPathBoxInputData.md#animationout)
- [transition](IPathBoxInputData.md#transition)
- [transitionOut](IPathBoxInputData.md#transitionout)
- [states](IPathBoxInputData.md#states)
- [state](IPathBoxInputData.md#state)
- [hoverStyle](IPathBoxInputData.md#hoverstyle)
- [pressStyle](IPathBoxInputData.md#pressstyle)
- [focusStyle](IPathBoxInputData.md#focusstyle)
- [selectedStyle](IPathBoxInputData.md#selectedstyle)
- [disabledStyle](IPathBoxInputData.md#disabledstyle)
- [placeholderStyle](IPathBoxInputData.md#placeholderstyle)
- [placeholderColor](IPathBoxInputData.md#placeholdercolor)
- [placeholderDelay](IPathBoxInputData.md#placeholderdelay)
- [editConfig](IPathBoxInputData.md#editconfig)
- [editOuter](IPathBoxInputData.md#editouter)
- [editInner](IPathBoxInputData.md#editinner)
- [children](IPathBoxInputData.md#children)
