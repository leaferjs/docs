...
- [bright](IUI.md#bright)
- [mask](IUI.md#mask)
- [eraser](IUI.md#eraser)
- [filter](IUI.md#filter)
- [complex](IUI.md#complex)
- [x](IUI.md#x)
- [y](IUI.md#y)
- [width](IUI.md#width)
...
- [dragBoundsType](IUI.md#dragboundstype)
...
- [\_\_nowWorldShapeBounds](IUI.md#__nowworldshapebounds)
...
- [\_\_scrollWorld](IUI.md#__scrollworld)
- [scrollWorldTransform](IUI.md#scrollworldtransform)
...
- [\_\_hasComplex](IUI.md#__hascomplex)
...
- [topChildren](IUI.md#topchildren)
...
- [strokeScaleFixed](IUI.md#strokescalefixed)
...
- [startLinker](IUI.md#startlinker)
- [endLinker](IUI.md#endlinker)
- [\_\_box](IUI.md#__box)
...
- [emitPropertyEvent](IUI.md#emitpropertyevent)
...
- [clearProxyData](IUI.md#clearproxydata)
- [find](IUI.md#find)
...
[IStrokeAttrData](IStrokeAttrData.md).[strokeScaleFixed](IStrokeAttrData.md#strokescalefixed)
...
▸ **get**\<`K`\>(`name`): [`IUI`](IUI.md)[`K`]

#### Type parameters

| Name | Type                          |
| :--- | :---------------------------- |
| `K`  | extends keyof [`IUI`](IUI.md) |
