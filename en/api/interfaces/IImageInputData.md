...
- [scaleFixed](IImageInputData.md#scalefixed)
...
- [renderSpread](IImageInputData.md#renderspread)
...
- [lockRatio](IImageInputData.md#lockratio)
...
- [dragBoundsType](IImageInputData.md#dragboundstype)
...
- [strokeScaleFixed](IImageInputData.md#strokescalefixed)
...
- [foreground](IImageInputData.md#foreground)
- [background](IImageInputData.md#background)
...
- [states](IImageInputData.md#states)
...
- [placeholderDelay](IImageInputData.md#placeholderdelay)
