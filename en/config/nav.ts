...
export const nav: DefaultTheme.NavItem[] = [{
  text: '✨ AI',
  items: [{
    text: "Ask AI - Context7",
    link: "https://context7.com/leaverjs/ai-docs?tab=chat"
  }, {
    text: "Ask AI - DeepWiki",
    link: "https://deepwiki.com/leaverjs/ai-docs"
  }, {
    text: 'MCP & Skills',
    link: 'https://context7.com/leaferjs/ai-docs'
  }, {
    text: "Leafer AI Knowledge Base",
  ...
  text: "Ecosystem",
  items: [{
    text: "Official PxGrow Ecosystem",
