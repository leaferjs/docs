...
\- 🌸 [Rect](../reference/display/Rect.md),[Box](../reference/display/Box.md) supports setting four separate sides via strokeWidth

\- 🌸 [Polygon](../reference/display/Polygon.md#startangle-number),[Star](../reference/display/Star.md#startangle-number) add startAngle properties, offsetting starting angle.

#### 🌷 感谢反馈

@click's trailer does not see @Grid
...
&#x20;[@johnnhan](https://github.com/johnnhan) [@liesauer](https://github.com/liesauer) [@Xdy1579883916](https://github.com/Xdy1579883916) [@ZhengNan-coder](https://github.com/ZhengNan-coder) @小志 @闰土 @Mapotato @走到群众中去
