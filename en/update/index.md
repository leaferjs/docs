...
🌸 \- [在线建筑绘制和 3D 预览](https://nxtspace.github.io/Nxtspace-Web/#/editor) @Nxtspace
...
\- 优化框选功能， editable 的组元素需设置 hitChildren 为 false，避免同时选中父子元素
...
\- 元素限制拖动范围后，光标拖拽超出区域后，元素未缩放到最小的问题
...
[@bvvy](https://github.com/bvvy) @闰土 @6oosen @风
...
\- 🌸 Ellipse 元素支持 [closed](../reference/display/Ellipse.md#closed-boolean) 属性，设为 false 可用于绘制非闭合的弧线，更省性能

#### 🪲 修复

\- 🌸 自动布局的图片元素更新后，未触发父级排版更新的问题

\- 🌸 上个版本移除空方法后，使用 view 插件时，未引入 animate 插件依赖会报错的问题

#### 🌿 优化

\- 🌸 完善 Ellipse 元素的各种特殊情况，以支持扩展形状编辑工具
...
\- 单个元素中存在多条闭合路径，设置 cornerRadius 后不符合预期的问题
...
\- fill 支持高性能 brush 几何纹理扩展、优化 opacity 效果
