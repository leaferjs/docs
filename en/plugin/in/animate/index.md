...
```html [animate.min]
<script src="https://unpkg.com/@leafer-in/animate@2.2.2/dist/animate.min.js"></script>
...
```html [animate]
<script src="https://unpkg.com/@leafer-in/animate@2.2.2/dist/animate.js"></script>
