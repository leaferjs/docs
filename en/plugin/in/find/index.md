...
You need to install the find plugin to use this feature. [Visit GitHub repository](https://github.com/leaferjs/leafer-in/tree/main/packages/find).
...
```html [find.min]
<script src="https://unpkg.com/@leafer-in/find@2.1.11/dist/find.min.js"></script>
```

```html [find]
<script src="https://unpkg.com/@leafer-in/find@2.1.11/dist/find.js"></script>
```
