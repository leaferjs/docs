...
<script src="https://unpkg.com/@leafer-in/scale-fixed@2.2.4/dist/scale-fixed.min.js"></script>
```

```html [scale-fixed]
<script src="https://unpkg.com/@leafer-in/scale-fixed@2.2.4/dist/scale-fixed.js"></script>
```
