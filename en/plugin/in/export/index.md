...
You need to install the export plugin to use this feature. [Visit GitHub repository](https://github.com/leaferjs/leafer-in/tree/main/packages/export).
...
```html [export.min]
<script src="https://unpkg.com/@leafer-in/export@2.1.10/dist/export.min.js"></script>
```

```html [export]
<script src="https://unpkg.com/@leafer-in/export@2.1.10/dist/export.js"></script>
```
