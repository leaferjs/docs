...
```html [arrow.min]
<script src="https://unpkg.com/@leafer-in/arrow@2.2.0/dist/arrow.min.js"></script>
<script>
...
```html [arrow]
<script src="https://unpkg.com/@leafer-in/arrow@2.2.0/dist/arrow.js"></script>
<script>
  const { Arrow } = LeaferIN.arrow
</script>
```
...
interface IPathDataArrow {
  ...
  fill?: boolean // since v2.2.0, supports filled arrows (stroke must not be transparent; use opacity instead)
}
