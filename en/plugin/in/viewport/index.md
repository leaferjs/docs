...
You need to install the viewport plugin to use it. [Visit Github repository](https://github.com/leaferjs/leafer-in/tree/main/packages/viewport).
...
```html [viewport.min]
<script src="https://unpkg.com/@leafer-in/viewport@2.1.10/dist/viewport.min.js"></script>
```

```html [viewport]
<script src="https://unpkg.com/@leafer-in/viewport@2.1.10/dist/viewport.js"></script>
```
...
### [Viewport Zoom & Pan](../../../guide/advanced/viewport.md)
