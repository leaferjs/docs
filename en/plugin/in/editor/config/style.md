...
To use the [bounding box](../../../../guide/advanced/bounds.md) of an element as the rendering path, you can employ 'box' or 'stroke' (stroke bounding box).
...
### Highlight and bring element to front
