...
You need to install the bright plugin to use it. [Click here to visit the Github repository](https://github.com/leaferjs/leafer-in/tree/main/packages/bright).
...
```html [bright.min]
<script src="https://unpkg.com/@leafer-in/bright@2.1.11/dist/bright.min.js"></script>
```

```html [bright]
<script src="https://unpkg.com/@leafer-in/bright@2.1.11/dist/bright.js"></script>
```
