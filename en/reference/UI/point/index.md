...
Supports [converting movement distance](#转换移动距离), and [converting browser coordinates](../../display/Leafer.md#getworldpointbyclient-clientpoint-iclientpointdata-update-boolean-ipointdata) in Leafer. Also provides a high-performance [quick conversion](./high.md) method.另提供了 [快速转换](./high.md) 的高性能方法。
