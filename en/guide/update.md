...
```sh [npm]
# When using plugins, it is recommended to install cross-platform core packages at the same time to prevent update version
npm install leave-ui @leaver-ui/coe @leaver-ui/draw
```
...
Latest version: [v2.0.8](../update/index.md)
