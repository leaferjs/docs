...
```html [web.min]
<script src="https://unpkg.com/leafer-ui@2.1.8/dist/web.min.js"></script>
<script>
...
```html [web]
<script src="https://unpkg.com/leafer-ui@2.1.8/dist/web.js"></script>
<script>
  const { Leafer } = LeaferUI // global variable containing all leafer-ui features
...
```html [module.min]
<script type="module">
  import { Leafer } from 'https://unpkg.com/leafer-ui@2.1.8/dist/web.module.min.js'
  // ...
</script>
```
...
```html [module]
<script type="module">
  import { Leafer } from 'https://unpkg.com/leafer-ui@2.1.8/dist/web.module.js'
  // ...
</script>
```
