...
设置矩阵数据，来源于布局数据 {x,y, scaleX,scaleY,rotation, skewX, skewY}，支持设置 [origin](../UI/origin.md)、[around](../UI/around.md)。
...
分解矩阵，获取布局数据 {x,y, scaleX,scaleY,rotation, skewX, skewY}, 支持设置 [origin](../UI/origin.md)、[around](../UI/around.md) 再转换, firstSkewY 表示优先转换 skewY。
