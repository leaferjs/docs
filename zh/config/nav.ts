...
export const nav: DefaultTheme.NavItem[] = [
    ...
    {
        text: '文档', activeMatch: '/(guide)|(reference)|(plugin)/', items: [
            { text: '概览', link: '/guide/', },
            { text: '快速入门', link: '/guide/basic/leafer', },
            { text: '参考', link: '/reference/display/Leafer', },
            { text: '图形编辑器', link: '/plugin/in/editor/', },
            { text: '示例', link: 'https://www.leaferjs.com/examples/', target: '_self' },
    ...
    {
        text: 'v2.1.10', activeMatch: '/blog/', items: [
            { text: '更新日志', link: '/update/' },
            { text: '博客', link: '/blog/' },
            { text: '愿景', link: '/guide/#使命与愿景' },
            { text: '文化', link: '/guide/#卓越文化' },
            { text: '常见问题', link: '/guide/problem/' },
            { text: '提问指南', link: '/guide/question.md' },
            { text: 'Bug与建议', link: 'https://github.com/leaferjs/leafer-ui/issues' },
            { text: '知乎问答', link: 'https://www.zhihu.com/topic/736459154/unanswered' },
            { text: '技术交流群', link: 'https://www.leaferjs.com/#contact' },
        ]
    },
