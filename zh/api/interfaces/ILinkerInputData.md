...
- [id](ILinkerInputData.md#id)
- [name](ILinkerInputData.md#name)
- [className](ILinkerInputData.md#classname)
- [blendMode](ILinkerInputData.md#blendmode)
- [opacity](ILinkerInputData.md#opacity)
- [visible](ILinkerInputData.md#visible)
- [selected](ILinkerInputData.md#selected)
- [disabled](ILinkerInputData.md#disabled)
- [locked](ILinkerInputData.md#locked)
- [zIndex](ILinkerInputData.md#zindex)
- [dim](ILinkerInputData.md#dim)
- [dimskip](ILinkerInputData.md#dimskip)
- [bright](ILinkerInputData.md#bright)
- [mask](ILinkerInputData.md#mask)
- [eraser](ILinkerInputData.md#eraser)
- [filter](ILinkerInputData.md#filter)
- [complex](ILinkerInputData.md#complex)
- [x](ILinkerInputData.md#x)
- [y](ILinkerInputData.md#y)
- [width](ILinkerInputData.md#width)
- [height](ILinkerInputData.md#height)
- [scaleX](ILinkerInputData.md#scalex)
- [scaleY](ILinkerInputData.md#scaley)
- [scaleFixed](ILinkerInputData.md#scalefixed)
- [rotation](ILinkerInputData.md#rotation)
- [skewX](ILinkerInputData.md#skewx)
- [skewY](ILinkerInputData.md#skewy)
- [scale](ILinkerInputData.md#scale)
- [offsetX](ILinkerInputData.md#offsetx)
- [offsetY](ILinkerInputData.md#offsety)
- [scrollX](ILinkerInputData.md#scrollx)
- [scrollY](ILinkerInputData.md#scrolly)
- [origin](ILinkerInputData.md#origin)
- [around](ILinkerInputData.md#around)
- [lazy](ILinkerInputData.md#lazy)
- [pixelRatio](ILinkerInputData.md#pixelratio)
- [renderSpread](ILinkerInputData.md#renderspread)
- [path](ILinkerInputData.md#path)
- [windingRule](ILinkerInputData.md#windingrule)
- [closed](ILinkerInputData.md#closed)
- [flow](ILinkerInputData.md#flow)
- [padding](ILinkerInputData.md#padding)
- [gap](ILinkerInputData.md#gap)
- [flowAlign](ILinkerInputData.md#flowalign)
- [flowWrap](ILinkerInputData.md#flowwrap)
- [itemBox](ILinkerInputData.md#itembox)
- [inFlow](ILinkerInputData.md#inflow)
- [autoWidth](ILinkerInputData.md#autowidth)
- [autoHeight](ILinkerInputData.md#autoheight)
- [lockRatio](ILinkerInputData.md#lockratio)
- [autoBox](ILinkerInputData.md#autobox)
- [widthRange](ILinkerInputData.md#widthrange)
- [heightRange](ILinkerInputData.md#heightrange)
- [draggable](ILinkerInputData.md#draggable)
- [dragBounds](ILinkerInputData.md#dragbounds)
- [dragBoundsType](ILinkerInputData.md#dragboundstype)
- [editable](ILinkerInputData.md#editable)
- [hittable](ILinkerInputData.md#hittable)
- [hitFill](ILinkerInputData.md#hitfill)
- [hitStroke](ILinkerInputData.md#hitstroke)
- [hitBox](ILinkerInputData.md#hitbox)
- [hitChildren](ILinkerInputData.md#hitchildren)
- [hitSelf](ILinkerInputData.md#hitself)
- [hitRadius](ILinkerInputData.md#hitradius)
- [button](ILinkerInputData.md#button)
- [cursor](ILinkerInputData.md#cursor)
- [motionPath](ILinkerInputData.md#motionpath)
- [motionPrecision](ILinkerInputData.md#motionprecision)
- [motion](ILinkerInputData.md#motion)
- [motionRotation](ILinkerInputData.md#motionrotation)
- [normalStyle](ILinkerInputData.md#normalstyle)
- [event](ILinkerInputData.md#event)
- [data](ILinkerInputData.md#data)
- [tag](ILinkerInputData.md#tag)
- [cornerRadius](ILinkerInputData.md#cornerradius)
- [cornerSmoothing](ILinkerInputData.md#cornersmoothing)
- [fill](ILinkerInputData.md#fill)
- [stroke](ILinkerInputData.md#stroke)
- [startArrow](ILinkerInputData.md#startarrow)
- [endArrow](ILinkerInputData.md#endarrow)
- [strokeAlign](ILinkerInputData.md#strokealign)
- [strokeWidth](ILinkerInputData.md#strokewidth)
- [strokeScaleFixed](ILinkerInputData.md#strokescalefixed)
- [strokeCap](ILinkerInputData.md#strokecap)
- [strokeJoin](ILinkerInputData.md#strokejoin)
- [dashPattern](ILinkerInputData.md#dashpattern)
- [dashOffset](ILinkerInputData.md#dashoffset)
- [miterLimit](ILinkerInputData.md#miterlimit)
- [fontFamily](ILinkerInputData.md#fontfamily)
- [fontSize](ILinkerInputData.md#fontsize)
- [fontWeight](ILinkerInputData.md#fontweight)
- [italic](ILinkerInputData.md#italic)
- [textCase](ILinkerInputData.md#textcase)
- [textDecoration](ILinkerInputData.md#textdecoration)
- [letterSpacing](ILinkerInputData.md#letterspacing)
- [lineHeight](ILinkerInputData.md#lineheight)
- [paraIndent](ILinkerInputData.md#paraindent)
- [paraSpacing](ILinkerInputData.md#paraspacing)
- [writingMode](ILinkerInputData.md#writingmode)
- [textAlign](ILinkerInputData.md#textalign)
- [verticalAlign](ILinkerInputData.md#verticalalign)
- [autoSizeAlign](ILinkerInputData.md#autosizealign)
- [textWrap](ILinkerInputData.md#textwrap)
- [textOverflow](ILinkerInputData.md#textoverflow)
- [shadow](ILinkerInputData.md#shadow)
- [innerShadow](ILinkerInputData.md#innershadow)
- [blur](ILinkerInputData.md#blur)
- [backgroundBlur](ILinkerInputData.md#backgroundblur)
- [grayscale](ILinkerInputData.md#grayscale)
- [toPoint](ILinkerInputData.md#topoint)
- [points](ILinkerInputData.md#points)
- [curve](ILinkerInputData.md#curve)
- [startPoint](ILinkerInputData.md#startpoint)
- [endPoint](ILinkerInputData.md#endpoint)
- [animation](ILinkerInputData.md#animation)
- [animationOut](ILinkerInputData.md#animationout)
- [transition](ILinkerInputData.md#transition)
- [transitionOut](ILinkerInputData.md#transitionout)
- [states](ILinkerInputData.md#states)
- [state](ILinkerInputData.md#state)
- [hoverStyle](ILinkerInputData.md#hoverstyle)
- [pressStyle](ILinkerInputData.md#pressstyle)
- [focusStyle](ILinkerInputData.md#focusstyle)
- [selectedStyle](ILinkerInputData.md#selectedstyle)
- [disabledStyle](ILinkerInputData.md#disabledstyle)
- [placeholderStyle](ILinkerInputData.md#placeholderstyle)
- [placeholderColor](ILinkerInputData.md#placeholdercolor)
- [placeholderDelay](ILinkerInputData.md#placeholderdelay)
- [editConfig](ILinkerInputData.md#editconfig)
- [editOuter](ILinkerInputData.md#editouter)
- [editInner](ILinkerInputData.md#editinner)
- [children](ILinkerInputData.md#children)
