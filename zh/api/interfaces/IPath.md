...
- [dim](IPath.md#dim)
- [dimskip](IPath.md#dimskip)
- [bright](IPath.md#bright)
- [mask](IPath.md#mask)
- [eraser](IPath.md#eraser)
- [filter](IPath.md#filter)
- [complex](IPath.md#complex)
- [x](IPath.md#x)
- [y](IPath.md#y)
...
- [scaleFixed](IPath.md#scalefixed)
...
- [renderSpread](IPath.md#renderspread)
- [path](IPath.md#path)
...
- [draggable](IPath.md#draggable)
- [dragBounds](IPath.md#dragbounds)
- [dragBoundsType](IPath.md#dragboundstype)
...
- [\_\_nowWorldShapeBounds](IPath.md#__nowworldshapebounds)
...
- [\_\_scrollWorld](IPath.md#__scrollworld)
- [scrollWorldTransform](IPath.md#scrollworldtransform)
...
- [\_\_hasComplex](IPath.md#__hascomplex)
...
- [\_\_inLazyBounds](IPath.md#__inlazybounds)
- [pathInputed](IPath.md#pathinputed)
- [isAutoWidth](IPath.md#isautowidth)
- [isAutoHeight](IPath.md#isautoheight)
- [destroyed](IPath.md#destroyed)
- [topChildren](IPath.md#topchildren)
- [innerId](IPath.md#innerid)
- [\_\_captureMap](IPath.md#__capturemap)
- [\_\_bubbleMap](IPath.md#__bubblemap)
- [\_\_hasLocalEvent](IPath.md#__haslocalevent)
- [\_\_hasWorldEvent](IPath.md#__hasworldevent)
...
- [strokeScaleFixed](IPath.md#strokescalefixed)
...
- [useFastShadow](IPath.md#usefastshadow)
...
- [startLinker](IPath.md#startlinker)
- [endLinker](IPath.md#endlinker)
- [\_\_box](IPath.md#__box)
...
- [placeholderColor](IPath.md#placeholdercolor)
- [placeholderDelay](IPath.md#placeholderdelay)
...
- [getClampRenderScale](IPath.md#getclamprenderscale)
- [getRenderScaleData](IPath.md#getrenderscaledata)
...
- [getPagePoint](IPath.md#getpagepoint)
...
- [\_\_drawShape](IPath.md#__drawshape)
...
- [emitPropertyEvent](IPath.md#emitpropertyevent)
...
- [clearProxyData](IPath.md#clearproxydata)
- [find](IPath.md#find)
...
- [drawImagePlaceholder](IPath.md#drawimageplaceholder)
- [animate](IPath.md#animate)
- [killAnimate](IPath.md#killanimate)
- [export](IPath.md#export)
- [syncExport](IPath.md#syncexport)
...
[src/ui/packages/interface/src/IUI.ts:153](https://github.com/leaferjs/leafer-ui/blob/88373cdd6f1051b44f1295f2d1866778d0675b15/packages/interface/src/IUI.ts#L153)
...
▸ **get**\<`K`\>(`name`): [`IPath`](IPath.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IPath`](IPath.md) |
