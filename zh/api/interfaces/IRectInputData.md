...
- [`IUIBaseInputData`](IUIBaseInputData.md)
  ...
  ↳↳ [`IBackgroundBoxStyle`](IBackgroundBoxStyle.md)
...
- [id](IRectInputData.md#id)
- [name](IRectInputData.md#name)
- [className](IRectInputData.md#classname)
- [blendMode](IRectInputData.md#blendmode)
- [opacity](IRectInputData.md#opacity)
- [visible](IRectInputData.md#visible)
- [selected](IRectInputData.md#selected)
- [disabled](IRectInputData.md#disabled)
- [locked](IRectInputData.md#locked)
- [zIndex](IRectInputData.md#zindex)
- [dim](IRectInputData.md#dim)
- [dimskip](IRectInputData.md#dimskip)
- [bright](IRectInputData.md#bright)
- [mask](IRectInputData.md#mask)
- [eraser](IRectInputData.md#eraser)
- [filter](IRectInputData.md#filter)
- [complex](IRectInputData.md#complex)
- [x](IRectInputData.md#x)
- [y](IRectInputData.md#y)
- [width](IRectInputData.md#width)
- [height](IRectInputData.md#height)
- [scaleX](IRectInputData.md#scalex)
- [scaleY](IRectInputData.md#scaley)
- [scaleFixed](IRectInputData.md#scalefixed)
- [rotation](IRectInputData.md#rotation)
- [skewX](IRectInputData.md#skewx)
- [skewY](IRectInputData.md#skewy)
- [scale](IRectInputData.md#scale)
- [offsetX](IRectInputData.md#offsetx)
- [offsetY](IRectInputData.md#offsety)
- [scrollX](IRectInputData.md#scrollx)
- [scrollY](IRectInputData.md#scrolly)
- [origin](IRectInputData.md#origin)
- [around](IRectInputData.md#around)
- [lazy](IRectInputData.md#lazy)
- [pixelRatio](IRectInputData.md#pixelratio)
- [renderSpread](IRectInputData.md#renderspread)
- [path](IRectInputData.md#path)
- [windingRule](IRectInputData.md#windingrule)
- [closed](IRectInputData.md#closed)
- [flow](IRectInputData.md#flow)
- [padding](IRectInputData.md#padding)
- [gap](IRectInputData.md#gap)
- [flowAlign](IRectInputData.md#flowalign)
- [flowWrap](IRectInputData.md#flowwrap)
- [itemBox](IRectInputData.md#itembox)
- [inFlow](IRectInputData.md#inflow)
- [autoWidth](IRectInputData.md#autowidth)
- [autoHeight](IRectInputData.md#autoheight)
- [lockRatio](IRectInputData.md#lockratio)
- [autoBox](IRectInputData.md#autobox)
- [widthRange](IRectInputData.md#widthrange)
- [heightRange](IRectInputData.md#heightrange)
- [draggable](IRectInputData.md#draggable)
- [dragBounds](IRectInputData.md#dragbounds)
- [dragBoundsType](IRectInputData.md#dragboundstype)
- [editable](IRectInputData.md#editable)
- [hittable](IRectInputData.md#hittable)
- [hitFill](IRectInputData.md#hitfill)
- [hitStroke](IRectInputData.md#hitstroke)
- [hitBox](IRectInputData.md#hitbox)
- [hitChildren](IRectInputData.md#hitchildren)
- [hitSelf](IRectInputData.md#hitself)
- [hitRadius](IRectInputData.md#hitradius)
- [button](IRectInputData.md#button)
- [cursor](IRectInputData.md#cursor)
- [motionPath](IRectInputData.md#motionpath)
- [motionPrecision](IRectInputData.md#motionprecision)
- [motion](IRectInputData.md#motion)
- [motionRotation](IRectInputData.md#motionrotation)
- [normalStyle](IRectInputData.md#normalstyle)
- [event](IRectInputData.md#event)
- [data](IRectInputData.md#data)
- [tag](IRectInputData.md#tag)
- [cornerRadius](IRectInputData.md#cornerradius)
- [cornerSmoothing](IRectInputData.md#cornersmoothing)
- [fill](IRectInputData.md#fill)
- [stroke](IRectInputData.md#stroke)
- [startArrow](IRectInputData.md#startarrow)
- [endArrow](IRectInputData.md#endarrow)
- [strokeAlign](IRectInputData.md#strokealign)
- [strokeWidth](IRectInputData.md#strokewidth)
- [strokeScaleFixed](IRectInputData.md#strokescalefixed)
- [strokeCap](IRectInputData.md#strokecap)
- [strokeJoin](IRectInputData.md#strokejoin)
- [dashPattern](IRectInputData.md#dashpattern)
- [dashOffset](IRectInputData.md#dashoffset)
- [miterLimit](IRectInputData.md#miterlimit)
- [fontFamily](IRectInputData.md#fontfamily)
- [fontSize](IRectInputData.md#fontsize)
- [fontWeight](IRectInputData.md#fontweight)
- [italic](IRectInputData.md#italic)
- [textCase](IRectInputData.md#textcase)
- [textDecoration](IRectInputData.md#textdecoration)
- [letterSpacing](IRectInputData.md#letterspacing)
- [lineHeight](IRectInputData.md#lineheight)
- [paraIndent](IRectInputData.md#paraindent)
- [paraSpacing](IRectInputData.md#paraspacing)
- [writingMode](IRectInputData.md#writingmode)
- [textAlign](IRectInputData.md#textalign)
- [verticalAlign](IRectInputData.md#verticalalign)
- [autoSizeAlign](IRectInputData.md#autosizealign)
- [textWrap](IRectInputData.md#textwrap)
- [textOverflow](IRectInputData.md#textoverflow)
- [shadow](IRectInputData.md#shadow)
- [innerShadow](IRectInputData.md#innershadow)
- [blur](IRectInputData.md#blur)
- [backgroundBlur](IRectInputData.md#backgroundblur)
- [grayscale](IRectInputData.md#grayscale)
- [animation](IRectInputData.md#animation)
- [animationOut](IRectInputData.md#animationout)
- [transition](IRectInputData.md#transition)
- [transitionOut](IRectInputData.md#transitionout)
- [states](IRectInputData.md#states)
- [state](IRectInputData.md#state)
- [hoverStyle](IRectInputData.md#hoverstyle)
- [pressStyle](IRectInputData.md#pressstyle)
- [focusStyle](IRectInputData.md#focusstyle)
- [selectedStyle](IRectInputData.md#selectedstyle)
- [disabledStyle](IRectInputData.md#disabledstyle)
- [placeholderStyle](IRectInputData.md#placeholderstyle)
- [placeholderColor](IRectInputData.md#placeholdercolor)
- [placeholderDelay](IRectInputData.md#placeholderdelay)
- [editConfig](IRectInputData.md#editconfig)
- [editOuter](IRectInputData.md#editouter)
- [editInner](IRectInputData.md#editinner)
- [children](IRectInputData.md#children)
