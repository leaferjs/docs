...
- [scaleFixed](IRect.md#scalefixed)
...
- [\_\_nowWorldShapeBounds](IRect.md#__nowworldshapebounds)
...
- [\_\_hasComplex](IRect.md#__hascomplex)
...
- [strokeScaleFixed](IRect.md#strokescalefixed)
...
- [startLinker](IRect.md#startlinker)
- [endLinker](IRect.md#endlinker)
...
- [clearProxyData](IRect.md#clearproxydata)
- [find](IRect.md#find)
...
▸ **get**\<`K`\>(`name`): [`IRect`](IRect.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IRect`](IRect.md) |
