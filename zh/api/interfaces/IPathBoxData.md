...
- [\_\_leaf](IPathBoxData.md#__leaf)
- [\_\_input](IPathBoxData.md#__input)
- [\_\_middle](IPathBoxData.md#__middle)
- [\_\_single](IPathBoxData.md#__single)
- [\_\_willDestroy](IPathBoxData.md#__willdestroy)
- [id](IPathBoxData.md#id)
- [name](IPathBoxData.md#name)
- [className](IPathBoxData.md#classname)
- [blendMode](IPathBoxData.md#blendmode)
- [opacity](IPathBoxData.md#opacity)
- [visible](IPathBoxData.md#visible)
- [selected](IPathBoxData.md#selected)
- [disabled](IPathBoxData.md#disabled)
- [locked](IPathBoxData.md#locked)
- [zIndex](IPathBoxData.md#zindex)
- [dim](IPathBoxData.md#dim)
- [dimskip](IPathBoxData.md#dimskip)
- [bright](IPathBoxData.md#bright)
- [mask](IPathBoxData.md#mask)
- [eraser](IPathBoxData.md#eraser)
- [filter](IPathBoxData.md#filter)
- [complex](IPathBoxData.md#complex)
- [x](IPathBoxData.md#x)
- [y](IPathBoxData.md#y)
- [width](IPathBoxData.md#width)
- [height](IPathBoxData.md#height)
- [scaleX](IPathBoxData.md#scalex)
- [scaleY](IPathBoxData.md#scaley)
- [scaleFixed](IPathBoxData.md#scalefixed)
- [rotation](IPathBoxData.md#rotation)
- [skewX](IPathBoxData.md#skewx)
- [skewY](IPathBoxData.md#skewy)
- [offsetX](IPathBoxData.md#offsetx)
- [offsetY](IPathBoxData.md#offsety)
- [scrollX](IPathBoxData.md#scrollx)
- [scrollY](IPathBoxData.md#scrolly)
- [origin](IPathBoxData.md#origin)
- [around](IPathBoxData.md#around)
- [lazy](IPathBoxData.md#lazy)
- [pixelRatio](IPathBoxData.md#pixelratio)
- [renderSpread](IPathBoxData.md#renderspread)
- [path](IPathBoxData.md#path)
- [windingRule](IPathBoxData.md#windingrule)
- [closed](IPathBoxData.md#closed)
- [flow](IPathBoxData.md#flow)
- [padding](IPathBoxData.md#padding)
- [gap](IPathBoxData.md#gap)
- [flowAlign](IPathBoxData.md#flowalign)
- [flowWrap](IPathBoxData.md#flowwrap)
- [itemBox](IPathBoxData.md#itembox)
- [inFlow](IPathBoxData.md#inflow)
- [autoWidth](IPathBoxData.md#autowidth)
- [autoHeight](IPathBoxData.md#autoheight)
- [lockRatio](IPathBoxData.md#lockratio)
- [autoBox](IPathBoxData.md#autobox)
- [widthRange](IPathBoxData.md#widthrange)
- [heightRange](IPathBoxData.md#heightrange)
- [draggable](IPathBoxData.md#draggable)
- [dragBounds](IPathBoxData.md#dragbounds)
- [dragBoundsType](IPathBoxData.md#dragboundstype)
- [editable](IPathBoxData.md#editable)
- [hittable](IPathBoxData.md#hittable)
- [hitFill](IPathBoxData.md#hitfill)
- [hitStroke](IPathBoxData.md#hitstroke)
- [hitBox](IPathBoxData.md#hitbox)
- [hitChildren](IPathBoxData.md#hitchildren)
- [hitSelf](IPathBoxData.md#hitself)
- [hitRadius](IPathBoxData.md#hitradius)
- [button](IPathBoxData.md#button)
- [cursor](IPathBoxData.md#cursor)
- [motionPath](IPathBoxData.md#motionpath)
- [motionPrecision](IPathBoxData.md#motionprecision)
- [motion](IPathBoxData.md#motion)
- [motionRotation](IPathBoxData.md#motionrotation)
- [normalStyle](IPathBoxData.md#normalstyle)
- [data](IPathBoxData.md#data)
- [\_\_childBranchNumber](IPathBoxData.md#__childbranchnumber)
- [\_\_complex](IPathBoxData.md#__complex)
- [\_\_complexData](IPathBoxData.md#__complexdata)
- [\_\_naturalWidth](IPathBoxData.md#__naturalwidth)
- [\_\_naturalHeight](IPathBoxData.md#__naturalheight)
- [\_\_autoWidth](IPathBoxData.md#__autowidth)
- [\_\_autoHeight](IPathBoxData.md#__autoheight)
- [\_\_autoSide](IPathBoxData.md#__autoside)
- [\_\_autoSize](IPathBoxData.md#__autosize)
- [\_\_useNaturalRatio](IPathBoxData.md#__usenaturalratio)
- [\_\_isLinePath](IPathBoxData.md#__islinepath)
- [\_\_blendMode](IPathBoxData.md#__blendmode)
- [\_\_useStroke](IPathBoxData.md#__usestroke)
- [\_\_useArrow](IPathBoxData.md#__usearrow)
- [\_\_useEffect](IPathBoxData.md#__useeffect)
- [\_\_usePathBox](IPathBoxData.md#__usepathbox)
- [\_\_useDim](IPathBoxData.md#__usedim)
- [\_\_pathInputed](IPathBoxData.md#__pathinputed)
- [\_\_pathForRender](IPathBoxData.md#__pathforrender)
- [\_\_path2DForRender](IPathBoxData.md#__path2dforrender)
- [\_\_startArrowPath](IPathBoxData.md#__startarrowpath)
- [\_\_endArrowPath](IPathBoxData.md#__endarrowpath)
- [\_\_pathForMotion](IPathBoxData.md#__pathformotion)
- [cornerRadius](IPathBoxData.md#cornerradius)
- [cornerSmoothing](IPathBoxData.md#cornersmoothing)
- [fill](IPathBoxData.md#fill)
- [borderWidth](IPathBoxData.md#borderwidth)
- [borderRadius](IPathBoxData.md#borderradius)
- [stroke](IPathBoxData.md#stroke)
- [startArrow](IPathBoxData.md#startarrow)
- [endArrow](IPathBoxData.md#endarrow)
- [strokeAlign](IPathBoxData.md#strokealign)
- [strokeWidth](IPathBoxData.md#strokewidth)
- [strokeWidths](IPathBoxData.md#strokewidths)
- [strokeScaleFixed](IPathBoxData.md#strokescalefixed)
- [strokeCap](IPathBoxData.md#strokecap)
- [strokeJoin](IPathBoxData.md#strokejoin)
- [dashPattern](IPathBoxData.md#dashpattern)
- [dashOffset](IPathBoxData.md#dashoffset)
- [miterLimit](IPathBoxData.md#miterlimit)
- [fontFamily](IPathBoxData.md#fontfamily)
- [fontSize](IPathBoxData.md#fontsize)
- [fontWeight](IPathBoxData.md#fontweight)
- [italic](IPathBoxData.md#italic)
- [textCase](IPathBoxData.md#textcase)
- [textDecoration](IPathBoxData.md#textdecoration)
- [letterSpacing](IPathBoxData.md#letterspacing)
- [lineHeight](IPathBoxData.md#lineheight)
- [paraIndent](IPathBoxData.md#paraindent)
- [paraSpacing](IPathBoxData.md#paraspacing)
- [writingMode](IPathBoxData.md#writingmode)
- [textAlign](IPathBoxData.md#textalign)
- [verticalAlign](IPathBoxData.md#verticalalign)
- [autoSizeAlign](IPathBoxData.md#autosizealign)
- [textWrap](IPathBoxData.md#textwrap)
- [textOverflow](IPathBoxData.md#textoverflow)
- [shadow](IPathBoxData.md#shadow)
- [innerShadow](IPathBoxData.md#innershadow)
- [blur](IPathBoxData.md#blur)
- [backgroundBlur](IPathBoxData.md#backgroundblur)
- [grayscale](IPathBoxData.md#grayscale)
- [overflow](IPathBoxData.md#overflow)
- [scrollConfig](IPathBoxData.md#scrollconfig)
- [resizeChildren](IPathBoxData.md#resizechildren)
- [textBox](IPathBoxData.md#textbox)
- [animation](IPathBoxData.md#animation)
- [animationOut](IPathBoxData.md#animationout)
- [transition](IPathBoxData.md#transition)
- [transitionOut](IPathBoxData.md#transitionout)
- [states](IPathBoxData.md#states)
- [state](IPathBoxData.md#state)
- [hoverStyle](IPathBoxData.md#hoverstyle)
- [pressStyle](IPathBoxData.md#pressstyle)
- [focusStyle](IPathBoxData.md#focusstyle)
- [selectedStyle](IPathBoxData.md#selectedstyle)
- [disabledStyle](IPathBoxData.md#disabledstyle)
- [placeholderStyle](IPathBoxData.md#placeholderstyle)
- [placeholderColor](IPathBoxData.md#placeholdercolor)
- [placeholderDelay](IPathBoxData.md#placeholderdelay)
- [editConfig](IPathBoxData.md#editconfig)
- [editOuter](IPathBoxData.md#editouter)
- [editInner](IPathBoxData.md#editinner)
- [scale](IPathBoxData.md#scale)
- [\_\_isFills](IPathBoxData.md#__isfills)
- [\_\_isStrokes](IPathBoxData.md#__isstrokes)
- [\_\_strokeWidth](IPathBoxData.md#__strokewidth)
- [\_\_maxStrokeWidth](IPathBoxData.md#__maxstrokewidth)
- [\_\_strokeWidthCache](IPathBoxData.md#__strokewidthcache)
- [\_\_hasMultiStrokeStyle](IPathBoxData.md#__hasmultistrokestyle)
- [\_\_hasMultiPaint](IPathBoxData.md#__hasmultipaint)
- [\_\_isAlphaPixelFill](IPathBoxData.md#__isalphapixelfill)
- [\_\_isAlphaPixelStroke](IPathBoxData.md#__isalphapixelstroke)
- [\_\_isTransparentFill](IPathBoxData.md#__istransparentfill)
- [\_\_isTransparentStroke](IPathBoxData.md#__istransparentstroke)
- [\_\_isHitPixel](IPathBoxData.md#__ishitpixel)
- [\_\_isCanvas](IPathBoxData.md#__iscanvas)
- [\_\_isFastShadow](IPathBoxData.md#__isfastshadow)
- [\_\_fillAfterStroke](IPathBoxData.md#__fillafterstroke)
- [\_\_drawAfterFill](IPathBoxData.md#__drawafterfill)
- [\_\_clipAfterFill](IPathBoxData.md#__clipafterfill)
- [\_\_hasSurface](IPathBoxData.md#__hassurface)
- [\_\_blendLayer](IPathBoxData.md#__blendlayer)
- [\_\_boxStroke](IPathBoxData.md#__boxstroke)
- [\_\_font](IPathBoxData.md#__font)
- [\_\_textDrawData](IPathBoxData.md#__textdrawdata)
- [\_\_needComputePaint](IPathBoxData.md#__needcomputepaint)

### Methods

- [\_\_get](IPathBoxData.md#__get)
- [\_\_getData](IPathBoxData.md#__getdata)
- [\_\_setInput](IPathBoxData.md#__setinput)
- [\_\_getInput](IPathBoxData.md#__getinput)
- [\_\_removeInput](IPathBoxData.md#__removeinput)
- [\_\_getInputData](IPathBoxData.md#__getinputdata)
- [\_\_setMiddle](IPathBoxData.md#__setmiddle)
- [\_\_getMiddle](IPathBoxData.md#__getmiddle)
- [destroy](IPathBoxData.md#destroy)
- [\_\_checkSingle](IPathBoxData.md#__checksingle)
- [\_\_removeNaturalSize](IPathBoxData.md#__removenaturalsize)
- [\_\_computePaint](IPathBoxData.md#__computepaint)
- [\_\_getRealStrokeWidth](IPathBoxData.md#__getrealstrokewidth)
- [\_\_setPaint](IPathBoxData.md#__setpaint)
- [\_\_removePaint](IPathBoxData.md#__removepaint)
