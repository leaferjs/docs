...
- [config](IScrollBar.md#config)
- [id](IScrollBar.md#id)
- [name](IScrollBar.md#name)
- [className](IScrollBar.md#classname)
- [blendMode](IScrollBar.md#blendmode)
- [opacity](IScrollBar.md#opacity)
- [visible](IScrollBar.md#visible)
- [selected](IScrollBar.md#selected)
- [disabled](IScrollBar.md#disabled)
- [locked](IScrollBar.md#locked)
- [zIndex](IScrollBar.md#zindex)
- [dim](IScrollBar.md#dim)
- [dimskip](IScrollBar.md#dimskip)
- [bright](IScrollBar.md#bright)
- [mask](IScrollBar.md#mask)
- [eraser](IScrollBar.md#eraser)
- [filter](IScrollBar.md#filter)
- [complex](IScrollBar.md#complex)
- [x](IScrollBar.md#x)
- [y](IScrollBar.md#y)
- [width](IScrollBar.md#width)
- [height](IScrollBar.md#height)
- [scaleX](IScrollBar.md#scalex)
- [scaleY](IScrollBar.md#scaley)
- [scaleFixed](IScrollBar.md#scalefixed)
- [rotation](IScrollBar.md#rotation)
- [skewX](IScrollBar.md#skewx)
- [skewY](IScrollBar.md#skewy)
- [scale](IScrollBar.md#scale)
- [offsetX](IScrollBar.md#offsetx)
- [offsetY](IScrollBar.md#offsety)
- [scrollX](IScrollBar.md#scrollx)
- [scrollY](IScrollBar.md#scrolly)
- [origin](IScrollBar.md#origin)
- [around](IScrollBar.md#around)
- [lazy](IScrollBar.md#lazy)
- [pixelRatio](IScrollBar.md#pixelratio)
- [renderSpread](IScrollBar.md#renderspread)
- [path](IScrollBar.md#path)
- [windingRule](IScrollBar.md#windingrule)
- [closed](IScrollBar.md#closed)
- [flow](IScrollBar.md#flow)
- [padding](IScrollBar.md#padding)
- [gap](IScrollBar.md#gap)
- [flowAlign](IScrollBar.md#flowalign)
- [flowWrap](IScrollBar.md#flowwrap)
- [itemBox](IScrollBar.md#itembox)
- [inFlow](IScrollBar.md#inflow)
- [autoWidth](IScrollBar.md#autowidth)
- [autoHeight](IScrollBar.md#autoheight)
- [lockRatio](IScrollBar.md#lockratio)
- [autoBox](IScrollBar.md#autobox)
- [widthRange](IScrollBar.md#widthrange)
- [heightRange](IScrollBar.md#heightrange)
- [draggable](IScrollBar.md#draggable)
- [dragBounds](IScrollBar.md#dragbounds)
- [dragBoundsType](IScrollBar.md#dragboundstype)
- [editable](IScrollBar.md#editable)
- [hittable](IScrollBar.md#hittable)
- [hitFill](IScrollBar.md#hitfill)
- [hitStroke](IScrollBar.md#hitstroke)
- [hitBox](IScrollBar.md#hitbox)
- [hitChildren](IScrollBar.md#hitchildren)
- [hitSelf](IScrollBar.md#hitself)
- [hitRadius](IScrollBar.md#hitradius)
- [button](IScrollBar.md#button)
- [cursor](IScrollBar.md#cursor)
- [motionPath](IScrollBar.md#motionpath)
- [motionPrecision](IScrollBar.md#motionprecision)
- [motion](IScrollBar.md#motion)
- [motionRotation](IScrollBar.md#motionrotation)
- [normalStyle](IScrollBar.md#normalstyle)
- [event](IScrollBar.md#event)
- [data](IScrollBar.md#data)
- [tag](IScrollBar.md#tag)
- [\_\_tag](IScrollBar.md#__tag)
- [innerName](IScrollBar.md#innername)
- [\_\_DataProcessor](IScrollBar.md#__dataprocessor)
- [\_\_LayoutProcessor](IScrollBar.md#__layoutprocessor)
- [leaferIsCreated](IScrollBar.md#leaferiscreated)
- [leaferIsReady](IScrollBar.md#leaferisready)
- [isApp](IScrollBar.md#isapp)
- [isLeafer](IScrollBar.md#isleafer)
- [isBranch](IScrollBar.md#isbranch)
- [isBranchLeaf](IScrollBar.md#isbranchleaf)
- [isOutside](IScrollBar.md#isoutside)
- [skipJSON](IScrollBar.md#skipjson)
- [syncEventer](IScrollBar.md#synceventer)
- [lockNormalStyle](IScrollBar.md#locknormalstyle)
- [\_\_layout](IScrollBar.md#__layout)
- [\_\_world](IScrollBar.md#__world)
- [\_\_local](IScrollBar.md#__local)
- [\_\_nowWorld](IScrollBar.md#__nowworld)
- [\_\_cameraWorld](IScrollBar.md#__cameraworld)
- [\_\_nowWorldShapeBounds](IScrollBar.md#__nowworldshapebounds)
- [\_\_localMatrix](IScrollBar.md#__localmatrix)
- [\_\_localBoxBounds](IScrollBar.md#__localboxbounds)
- [\_\_worldOpacity](IScrollBar.md#__worldopacity)
- [worldTransform](IScrollBar.md#worldtransform)
- [localTransform](IScrollBar.md#localtransform)
- [\_\_scrollWorld](IScrollBar.md#__scrollworld)
- [scrollWorldTransform](IScrollBar.md#scrollworldtransform)
- [boxBounds](IScrollBar.md#boxbounds)
- [renderBounds](IScrollBar.md#renderbounds)
- [worldBoxBounds](IScrollBar.md#worldboxbounds)
- [worldStrokeBounds](IScrollBar.md#worldstrokebounds)
- [worldRenderBounds](IScrollBar.md#worldrenderbounds)
- [worldOpacity](IScrollBar.md#worldopacity)
- [\_\_level](IScrollBar.md#__level)
- [\_\_tempNumber](IScrollBar.md#__tempnumber)
- [\_\_worldFlipped](IScrollBar.md#__worldflipped)
- [\_\_hasAutoLayout](IScrollBar.md#__hasautolayout)
- [\_\_hasMotionPath](IScrollBar.md#__hasmotionpath)
- [\_\_hasComplex](IScrollBar.md#__hascomplex)
- [\_\_hasMask](IScrollBar.md#__hasmask)
- [\_\_hasEraser](IScrollBar.md#__haseraser)
- [\_\_hitCanvas](IScrollBar.md#__hitcanvas)
- [\_\_flowBounds](IScrollBar.md#__flowbounds)
- [\_\_widthGrow](IScrollBar.md#__widthgrow)
- [\_\_heightGrow](IScrollBar.md#__heightgrow)
- [\_\_hasGrow](IScrollBar.md#__hasgrow)
- [\_\_onlyHitMask](IScrollBar.md#__onlyhitmask)
- [\_\_ignoreHitWorld](IScrollBar.md#__ignorehitworld)
- [\_\_inLazyBounds](IScrollBar.md#__inlazybounds)
- [pathInputed](IScrollBar.md#pathinputed)
- [isAutoWidth](IScrollBar.md#isautowidth)
- [isAutoHeight](IScrollBar.md#isautoheight)
- [destroyed](IScrollBar.md#destroyed)
- [topChildren](IScrollBar.md#topchildren)
- [innerId](IScrollBar.md#innerid)
- [\_\_captureMap](IScrollBar.md#__capturemap)
- [\_\_bubbleMap](IScrollBar.md#__bubblemap)
- [\_\_hasLocalEvent](IScrollBar.md#__haslocalevent)
- [\_\_hasWorldEvent](IScrollBar.md#__hasworldevent)
- [cornerRadius](IScrollBar.md#cornerradius)
- [cornerSmoothing](IScrollBar.md#cornersmoothing)
- [fill](IScrollBar.md#fill)
- [stroke](IScrollBar.md#stroke)
- [startArrow](IScrollBar.md#startarrow)
- [endArrow](IScrollBar.md#endarrow)
- [strokeAlign](IScrollBar.md#strokealign)
- [strokeWidth](IScrollBar.md#strokewidth)
- [strokeScaleFixed](IScrollBar.md#strokescalefixed)
- [strokeCap](IScrollBar.md#strokecap)
- [strokeJoin](IScrollBar.md#strokejoin)
- [dashPattern](IScrollBar.md#dashpattern)
- [dashOffset](IScrollBar.md#dashoffset)
- [miterLimit](IScrollBar.md#miterlimit)
- [shadow](IScrollBar.md#shadow)
- [innerShadow](IScrollBar.md#innershadow)
- [blur](IScrollBar.md#blur)
- [backgroundBlur](IScrollBar.md#backgroundblur)
- [grayscale](IScrollBar.md#grayscale)
- [\_\_](IScrollBar.md#__)
- [children](IScrollBar.md#children)
- [childlessJSON](IScrollBar.md#childlessjson)
- [app](IScrollBar.md#app)
- [leafer](IScrollBar.md#leafer)
- [parent](IScrollBar.md#parent)
- [zoomLayer](IScrollBar.md#zoomlayer)
- [isFrame](IScrollBar.md#isframe)
- [isOverflow](IScrollBar.md#isoverflow)
- [useFastShadow](IScrollBar.md#usefastshadow)
- [proxyData](IScrollBar.md#proxydata)
- [\_\_proxyData](IScrollBar.md#__proxydata)
- [animation](IScrollBar.md#animation)
- [animationOut](IScrollBar.md#animationout)
- [startLinker](IScrollBar.md#startlinker)
- [endLinker](IScrollBar.md#endlinker)
- [\_\_box](IScrollBar.md#__box)
- [\_\_animate](IScrollBar.md#__animate)
- [pen](IScrollBar.md#pen)
- [transition](IScrollBar.md#transition)
- [transitionOut](IScrollBar.md#transitionout)
- [states](IScrollBar.md#states)
- [state](IScrollBar.md#state)
- [hoverStyle](IScrollBar.md#hoverstyle)
- [pressStyle](IScrollBar.md#pressstyle)
- [focusStyle](IScrollBar.md#focusstyle)
- [selectedStyle](IScrollBar.md#selectedstyle)
- [disabledStyle](IScrollBar.md#disabledstyle)
- [placeholderStyle](IScrollBar.md#placeholderstyle)
- [placeholderColor](IScrollBar.md#placeholdercolor)
- [placeholderDelay](IScrollBar.md#placeholderdelay)
- [editConfig](IScrollBar.md#editconfig)
- [editOuter](IScrollBar.md#editouter)
- [editInner](IScrollBar.md#editinner)

### Methods

- [changeTheme](IScrollBar.md#changetheme)
- [update](IScrollBar.md#update)
- [resetCustom](IScrollBar.md#resetcustom)
- [waitParent](IScrollBar.md#waitparent)
- [waitLeafer](IScrollBar.md#waitleafer)
- [nextRender](IScrollBar.md#nextrender)
- [removeNextRender](IScrollBar.md#removenextrender)
- [\_\_bindLeafer](IScrollBar.md#__bindleafer)
- [setAttr](IScrollBar.md#setattr)
- [getAttr](IScrollBar.md#getattr)
- [getComputedAttr](IScrollBar.md#getcomputedattr)
- [toString](IScrollBar.md#tostring)
- [toSVG](IScrollBar.md#tosvg)
- [\_\_SVG](IScrollBar.md#__svg)
- [toHTML](IScrollBar.md#tohtml)
- [\_\_setAttr](IScrollBar.md#__setattr)
- [\_\_getAttr](IScrollBar.md#__getattr)
- [setProxyAttr](IScrollBar.md#setproxyattr)
- [getProxyAttr](IScrollBar.md#getproxyattr)
- [focus](IScrollBar.md#focus)
- [updateState](IScrollBar.md#updatestate)
- [updateLayout](IScrollBar.md#updatelayout)
- [forceUpdate](IScrollBar.md#forceupdate)
- [forceRender](IScrollBar.md#forcerender)
- [\_\_extraUpdate](IScrollBar.md#__extraupdate)
- [\_\_updateWorldMatrix](IScrollBar.md#__updateworldmatrix)
- [\_\_updateLocalMatrix](IScrollBar.md#__updatelocalmatrix)
- [\_\_updateWorldBounds](IScrollBar.md#__updateworldbounds)
- [\_\_updateLocalBounds](IScrollBar.md#__updatelocalbounds)
- [\_\_updateLocalBoxBounds](IScrollBar.md#__updatelocalboxbounds)
- [\_\_updateLocalStrokeBounds](IScrollBar.md#__updatelocalstrokebounds)
- [\_\_updateLocalRenderBounds](IScrollBar.md#__updatelocalrenderbounds)
- [\_\_updateContentBounds](IScrollBar.md#__updatecontentbounds)
- [\_\_updateBoxBounds](IScrollBar.md#__updateboxbounds)
- [\_\_updateStrokeBounds](IScrollBar.md#__updatestrokebounds)
- [\_\_updateRenderBounds](IScrollBar.md#__updaterenderbounds)
- [\_\_updateAutoLayout](IScrollBar.md#__updateautolayout)
- [\_\_updateFlowLayout](IScrollBar.md#__updateflowlayout)
- [\_\_updateNaturalSize](IScrollBar.md#__updatenaturalsize)
- [\_\_updateStrokeSpread](IScrollBar.md#__updatestrokespread)
- [\_\_updateRenderSpread](IScrollBar.md#__updaterenderspread)
- [\_\_onUpdateSize](IScrollBar.md#__onupdatesize)
- [\_\_updateEraser](IScrollBar.md#__updateeraser)
- [\_\_updateMask](IScrollBar.md#__updatemask)
- [\_\_renderMask](IScrollBar.md#__rendermask)
- [\_\_renderEraser](IScrollBar.md#__rendereraser)
- [\_\_getNowWorld](IScrollBar.md#__getnowworld)
- [getClampRenderScale](IScrollBar.md#getclamprenderscale)
- [getRenderScaleData](IScrollBar.md#getrenderscaledata)
- [getTransform](IScrollBar.md#gettransform)
- [getBounds](IScrollBar.md#getbounds)
- [getLayoutBounds](IScrollBar.md#getlayoutbounds)
- [getLayoutPoints](IScrollBar.md#getlayoutpoints)
- [getWorldBounds](IScrollBar.md#getworldbounds)
- [worldToLocal](IScrollBar.md#worldtolocal)
- [localToWorld](IScrollBar.md#localtoworld)
- [worldToInner](IScrollBar.md#worldtoinner)
- [innerToWorld](IScrollBar.md#innertoworld)
- [getBoxPoint](IScrollBar.md#getboxpoint)
- [getBoxPointByInner](IScrollBar.md#getboxpointbyinner)
- [getInnerPoint](IScrollBar.md#getinnerpoint)
- [getInnerPointByBox](IScrollBar.md#getinnerpointbybox)
- [getInnerPointByLocal](IScrollBar.md#getinnerpointbylocal)
- [getLocalPoint](IScrollBar.md#getlocalpoint)
- [getLocalPointByInner](IScrollBar.md#getlocalpointbyinner)
- [getPagePoint](IScrollBar.md#getpagepoint)
- [getWorldPoint](IScrollBar.md#getworldpoint)
- [getWorldPointByBox](IScrollBar.md#getworldpointbybox)
- [getWorldPointByLocal](IScrollBar.md#getworldpointbylocal)
- [getWorldPointByPage](IScrollBar.md#getworldpointbypage)
- [setTransform](IScrollBar.md#settransform)
- [transform](IScrollBar.md#transform)
- [move](IScrollBar.md#move)
- [moveInner](IScrollBar.md#moveinner)
- [scaleOf](IScrollBar.md#scaleof)
- [rotateOf](IScrollBar.md#rotateof)
- [skewOf](IScrollBar.md#skewof)
- [transformWorld](IScrollBar.md#transformworld)
- [moveWorld](IScrollBar.md#moveworld)
- [scaleOfWorld](IScrollBar.md#scaleofworld)
- [rotateOfWorld](IScrollBar.md#rotateofworld)
- [skewOfWorld](IScrollBar.md#skewofworld)
- [flip](IScrollBar.md#flip)
- [scaleResize](IScrollBar.md#scaleresize)
- [\_\_scaleResize](IScrollBar.md#__scaleresize)
- [resizeWidth](IScrollBar.md#resizewidth)
- [resizeHeight](IScrollBar.md#resizeheight)
- [hit](IScrollBar.md#hit)
- [\_\_hitWorld](IScrollBar.md#__hitworld)
- [\_\_hit](IScrollBar.md#__hit)
- [\_\_hitFill](IScrollBar.md#__hitfill)
- [\_\_hitStroke](IScrollBar.md#__hitstroke)
- [\_\_hitPixel](IScrollBar.md#__hitpixel)
- [\_\_drawHitPath](IScrollBar.md#__drawhitpath)
- [\_\_updateHitCanvas](IScrollBar.md#__updatehitcanvas)
- [\_\_render](IScrollBar.md#__render)
- [\_\_drawFast](IScrollBar.md#__drawfast)
- [\_\_draw](IScrollBar.md#__draw)
- [\_\_clip](IScrollBar.md#__clip)
- [\_\_renderShape](IScrollBar.md#__rendershape)
- [\_\_drawShape](IScrollBar.md#__drawshape)
- [\_\_updateWorldOpacity](IScrollBar.md#__updateworldopacity)
- [\_\_updateChange](IScrollBar.md#__updatechange)
- [\_\_drawPath](IScrollBar.md#__drawpath)
- [\_\_drawRenderPath](IScrollBar.md#__drawrenderpath)
- [\_\_updatePath](IScrollBar.md#__updatepath)
- [\_\_updateRenderPath](IScrollBar.md#__updaterenderpath)
- [getMotionPathData](IScrollBar.md#getmotionpathdata)
- [getMotionPoint](IScrollBar.md#getmotionpoint)
- [getMotionTotal](IScrollBar.md#getmotiontotal)
- [\_\_updateMotionPath](IScrollBar.md#__updatemotionpath)
- [\_\_runAnimation](IScrollBar.md#__runanimation)
- [\_\_emitLifeEvent](IScrollBar.md#__emitlifeevent)
- [\_\_updateSortChildren](IScrollBar.md#__updatesortchildren)
- [dropTo](IScrollBar.md#dropto)
- [\_\_realSetAttr](IScrollBar.md#__realsetattr)
- [emitPropertyEvent](IScrollBar.md#emitpropertyevent)
- [destroyEventer](IScrollBar.md#destroyeventer)
- [on](IScrollBar.md#on)
- [off](IScrollBar.md#off)
- [on\_](IScrollBar.md#on_)
- [off\_](IScrollBar.md#off_)
- [once](IScrollBar.md#once)
- [emit](IScrollBar.md#emit)
- [emitEvent](IScrollBar.md#emitevent)
- [hasEvent](IScrollBar.md#hasevent)
- [destroy](IScrollBar.md#destroy)
- [pick](IScrollBar.md#pick)
- [add](IScrollBar.md#add)
- [addAt](IScrollBar.md#addat)
- [addAfter](IScrollBar.md#addafter)
- [addBefore](IScrollBar.md#addbefore)
- [addMany](IScrollBar.md#addmany)
- [remove](IScrollBar.md#remove)
- [removeAll](IScrollBar.md#removeall)
- [clear](IScrollBar.md#clear)
- [reset](IScrollBar.md#reset)
- [set](IScrollBar.md#set)
- [toJSON](IScrollBar.md#tojson)
- [get](IScrollBar.md#get)
- [createProxyData](IScrollBar.md#createproxydata)
- [clearProxyData](IScrollBar.md#clearproxydata)
- [find](IScrollBar.md#find)
- [findTag](IScrollBar.md#findtag)
- [findOne](IScrollBar.md#findone)
- [findId](IScrollBar.md#findid)
- [getPath](IScrollBar.md#getpath)
- [getPathString](IScrollBar.md#getpathstring)
- [asPath](IScrollBar.md#aspath)
- [load](IScrollBar.md#load)
- [\_\_drawPathByData](IScrollBar.md#__drawpathbydata)
- [\_\_drawPathByBox](IScrollBar.md#__drawpathbybox)
- [\_\_drawAfterFill](IScrollBar.md#__drawafterfill)
- [\_\_drawContent](IScrollBar.md#__drawcontent)
- [drawImagePlaceholder](IScrollBar.md#drawimageplaceholder)
- [animate](IScrollBar.md#animate)
- [killAnimate](IScrollBar.md#killanimate)
- [export](IScrollBar.md#export)
- [syncExport](IScrollBar.md#syncexport)
- [clone](IScrollBar.md#clone)

## Properties

### config

• **config**: [`IScrollBarConfig`](IScrollBarConfig.md)

#### Defined in

[src/in/packages/interface/src/scroll/IScrollBar.ts:12](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/scroll/IScrollBar.ts#L12)
...
[src/in/packages/interface/src/scroll/IScrollBar.ts:13](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/scroll/IScrollBar.ts#L13)
...
[src/in/packages/interface/src/scroll/IScrollBar.ts:14](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/scroll/IScrollBar.ts#L14)
...
▸ **get**\<`K`\>(`name`): [`IScrollBar`](IScrollBar.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IScrollBar`](IScrollBar.md) |
