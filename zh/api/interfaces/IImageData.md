...
- [\_\_willDestroy](IImageData.md#__willdestroy)
- [id](IImageData.md#id)
...
- [dim](IImageData.md#dim)
- [dimskip](IImageData.md#dimskip)
- [bright](IImageData.md#bright)
- [mask](IImageData.md#mask)
- [eraser](IImageData.md#eraser)
- [filter](IImageData.md#filter)
- [complex](IImageData.md#complex)
- [x](IImageData.md#x)
- [y](IImageData.md#y)
...
- [scaleFixed](IImageData.md#scalefixed)
...
- [renderSpread](IImageData.md#renderspread)
...
- [flowWrap](IImageData.md#flowwrap)
...
- [dragBoundsType](IImageData.md#dragboundstype)
...
- [\_\_complexData](IImageData.md#__complexdata)
...
- [\_\_useStroke](IImageData.md#__usestroke)
- [\_\_useArrow](IImageData.md#__usearrow)
- [\_\_useEffect](IImageData.md#__useeffect)
- [\_\_usePathBox](IImageData.md#__usepathbox)
- [\_\_useDim](IImageData.md#__usedim)
...
- [\_\_startArrowPath](IImageData.md#__startarrowpath)
- [\_\_endArrowPath](IImageData.md#__endarrowpath)
...
- [strokeScaleFixed](IImageData.md#strokescalefixed)
...
- [fontWeight](IImageData.md#fontweight)
...
- [foreground](IImageData.md#foreground)
- [background](IImageData.md#background)
- [\_\_urlType](IImageData.md#__urltype)
...
- [placeholderColor](IImageData.md#placeholdercolor)
- [placeholderDelay](IImageData.md#placeholderdelay)
...
- [\_\_maxStrokeWidth](IImageData.md#__maxstrokewidth)
- [\_\_strokeWidthCache](IImageData.md#__strokewidthcache)
- [\_\_hasMultiStrokeStyle](IImageData.md#__hasmultistrokestyle)
- [\_\_hasMultiPaint](IImageData.md#__hasmultipaint)
- [\_\_isAlphaPixelFill](IImageData.md#__isalphapixelfill)
- [\_\_isAlphaPixelStroke](IImageData.md#__isalphapixelstroke)
- [\_\_isTransparentFill](IImageData.md#__istransparentfill)
- [\_\_isTransparentStroke](IImageData.md#__istransparentstroke)
- [\_\_isHitPixel](IImageData.md#__ishitpixel)
- [\_\_isCanvas](IImageData.md#__iscanvas)
- [\_\_isFastShadow](IImageData.md#__isfastshadow)
- [\_\_fillAfterStroke](IImageData.md#__fillafterstroke)
...
- [\_\_getRealStrokeWidth](IImageData.md#__getrealstrokewidth)
- [\_\_setPaint](IImageData.md#__setpaint)
- [\_\_removePaint](IImageData.md#__removepaint)
