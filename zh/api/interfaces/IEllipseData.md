...
- [\_\_leaf](IEllipseData.md#__leaf)
- [\_\_input](IEllipseData.md#__input)
- [\_\_middle](IEllipseData.md#__middle)
- [\_\_single](IEllipseData.md#__single)
- [\_\_willDestroy](IEllipseData.md#__willdestroy)
- [id](IEllipseData.md#id)
- [name](IEllipseData.md#name)
- [className](IEllipseData.md#classname)
- [blendMode](IEllipseData.md#blendmode)
- [opacity](IEllipseData.md#opacity)
- [visible](IEllipseData.md#visible)
- [selected](IEllipseData.md#selected)
- [disabled](IEllipseData.md#disabled)
- [locked](IEllipseData.md#locked)
- [zIndex](IEllipseData.md#zindex)
- [dim](IEllipseData.md#dim)
- [dimskip](IEllipseData.md#dimskip)
- [bright](IEllipseData.md#bright)
- [mask](IEllipseData.md#mask)
- [eraser](IEllipseData.md#eraser)
- [filter](IEllipseData.md#filter)
- [complex](IEllipseData.md#complex)
- [x](IEllipseData.md#x)
- [y](IEllipseData.md#y)
- [width](IEllipseData.md#width)
- [height](IEllipseData.md#height)
- [scaleX](IEllipseData.md#scalex)
- [scaleY](IEllipseData.md#scaley)
- [scaleFixed](IEllipseData.md#scalefixed)
- [rotation](IEllipseData.md#rotation)
- [skewX](IEllipseData.md#skewx)
- [skewY](IEllipseData.md#skewy)
- [offsetX](IEllipseData.md#offsetx)
- [offsetY](IEllipseData.md#offsety)
- [scrollX](IEllipseData.md#scrollx)
- [scrollY](IEllipseData.md#scrolly)
- [origin](IEllipseData.md#origin)
- [around](IEllipseData.md#around)
- [lazy](IEllipseData.md#lazy)
- [pixelRatio](IEllipseData.md#pixelratio)
- [renderSpread](IEllipseData.md#renderspread)
- [path](IEllipseData.md#path)
- [windingRule](IEllipseData.md#windingrule)
- [closed](IEllipseData.md#closed)
- [flow](IEllipseData.md#flow)
- [padding](IEllipseData.md#padding)
- [gap](IEllipseData.md#gap)
- [flowAlign](IEllipseData.md#flowalign)
- [flowWrap](IEllipseData.md#flowwrap)
- [itemBox](IEllipseData.md#itembox)
- [inFlow](IEllipseData.md#inflow)
- [autoWidth](IEllipseData.md#autowidth)
- [autoHeight](IEllipseData.md#autoheight)
- [lockRatio](IEllipseData.md#lockratio)
- [autoBox](IEllipseData.md#autobox)
- [widthRange](IEllipseData.md#widthrange)
- [heightRange](IEllipseData.md#heightrange)
- [draggable](IEllipseData.md#draggable)
- [dragBounds](IEllipseData.md#dragbounds)
- [dragBoundsType](IEllipseData.md#dragboundstype)
- [editable](IEllipseData.md#editable)
- [hittable](IEllipseData.md#hittable)
- [hitFill](IEllipseData.md#hitfill)
- [hitStroke](IEllipseData.md#hitstroke)
- [hitBox](IEllipseData.md#hitbox)
- [hitChildren](IEllipseData.md#hitchildren)
- [hitSelf](IEllipseData.md#hitself)
- [hitRadius](IEllipseData.md#hitradius)
- [button](IEllipseData.md#button)
- [cursor](IEllipseData.md#cursor)
- [motionPath](IEllipseData.md#motionpath)
- [motionPrecision](IEllipseData.md#motionprecision)
- [motion](IEllipseData.md#motion)
- [motionRotation](IEllipseData.md#motionrotation)
- [normalStyle](IEllipseData.md#normalstyle)
- [data](IEllipseData.md#data)
- [\_\_childBranchNumber](IEllipseData.md#__childbranchnumber)
- [\_\_complex](IEllipseData.md#__complex)
- [\_\_complexData](IEllipseData.md#__complexdata)
- [\_\_naturalWidth](IEllipseData.md#__naturalwidth)
- [\_\_naturalHeight](IEllipseData.md#__naturalheight)
- [\_\_autoWidth](IEllipseData.md#__autowidth)
- [\_\_autoHeight](IEllipseData.md#__autoheight)
- [\_\_autoSide](IEllipseData.md#__autoside)
- [\_\_autoSize](IEllipseData.md#__autosize)
- [\_\_useNaturalRatio](IEllipseData.md#__usenaturalratio)
- [\_\_isLinePath](IEllipseData.md#__islinepath)
- [\_\_blendMode](IEllipseData.md#__blendmode)
- [\_\_useStroke](IEllipseData.md#__usestroke)
- [\_\_useArrow](IEllipseData.md#__usearrow)
- [\_\_useEffect](IEllipseData.md#__useeffect)
- [\_\_usePathBox](IEllipseData.md#__usepathbox)
- [\_\_useDim](IEllipseData.md#__usedim)
- [\_\_pathInputed](IEllipseData.md#__pathinputed)
- [\_\_pathForRender](IEllipseData.md#__pathforrender)
- [\_\_path2DForRender](IEllipseData.md#__path2dforrender)
- [\_\_startArrowPath](IEllipseData.md#__startarrowpath)
- [\_\_endArrowPath](IEllipseData.md#__endarrowpath)
- [\_\_pathForMotion](IEllipseData.md#__pathformotion)
- [cornerRadius](IEllipseData.md#cornerradius)
- [cornerSmoothing](IEllipseData.md#cornersmoothing)
- [fill](IEllipseData.md#fill)
- [borderWidth](IEllipseData.md#borderwidth)
- [borderRadius](IEllipseData.md#borderradius)
- [stroke](IEllipseData.md#stroke)
- [startArrow](IEllipseData.md#startarrow)
- [endArrow](IEllipseData.md#endarrow)
- [strokeAlign](IEllipseData.md#strokealign)
- [strokeWidth](IEllipseData.md#strokewidth)
- [strokeWidths](IEllipseData.md#strokewidths)
- [strokeScaleFixed](IEllipseData.md#strokescalefixed)
- [strokeCap](IEllipseData.md#strokecap)
- [strokeJoin](IEllipseData.md#strokejoin)
- [dashPattern](IEllipseData.md#dashpattern)
- [dashOffset](IEllipseData.md#dashoffset)
- [miterLimit](IEllipseData.md#miterlimit)
- [fontFamily](IEllipseData.md#fontfamily)
- [fontSize](IEllipseData.md#fontsize)
- [fontWeight](IEllipseData.md#fontweight)
- [italic](IEllipseData.md#italic)
- [textCase](IEllipseData.md#textcase)
- [textDecoration](IEllipseData.md#textdecoration)
- [letterSpacing](IEllipseData.md#letterspacing)
- [lineHeight](IEllipseData.md#lineheight)
- [paraIndent](IEllipseData.md#paraindent)
- [paraSpacing](IEllipseData.md#paraspacing)
- [writingMode](IEllipseData.md#writingmode)
- [textAlign](IEllipseData.md#textalign)
- [verticalAlign](IEllipseData.md#verticalalign)
- [autoSizeAlign](IEllipseData.md#autosizealign)
- [textWrap](IEllipseData.md#textwrap)
- [textOverflow](IEllipseData.md#textoverflow)
- [shadow](IEllipseData.md#shadow)
- [innerShadow](IEllipseData.md#innershadow)
- [blur](IEllipseData.md#blur)
- [backgroundBlur](IEllipseData.md#backgroundblur)
- [grayscale](IEllipseData.md#grayscale)
- [startAngle](IEllipseData.md#startangle)
- [endAngle](IEllipseData.md#endangle)
- [innerRadius](IEllipseData.md#innerradius)
- [animation](IEllipseData.md#animation)
- [animationOut](IEllipseData.md#animationout)
- [transition](IEllipseData.md#transition)
- [transitionOut](IEllipseData.md#transitionout)
- [states](IEllipseData.md#states)
- [state](IEllipseData.md#state)
- [hoverStyle](IEllipseData.md#hoverstyle)
- [pressStyle](IEllipseData.md#pressstyle)
- [focusStyle](IEllipseData.md#focusstyle)
- [selectedStyle](IEllipseData.md#selectedstyle)
- [disabledStyle](IEllipseData.md#disabledstyle)
- [placeholderStyle](IEllipseData.md#placeholderstyle)
- [placeholderColor](IEllipseData.md#placeholdercolor)
- [placeholderDelay](IEllipseData.md#placeholderdelay)
- [editConfig](IEllipseData.md#editconfig)
- [editOuter](IEllipseData.md#editouter)
- [editInner](IEllipseData.md#editinner)
- [scale](IEllipseData.md#scale)
- [\_\_isFills](IEllipseData.md#__isfills)
- [\_\_isStrokes](IEllipseData.md#__isstrokes)
- [\_\_strokeWidth](IEllipseData.md#__strokewidth)
- [\_\_maxStrokeWidth](IEllipseData.md#__maxstrokewidth)
- [\_\_strokeWidthCache](IEllipseData.md#__strokewidthcache)
- [\_\_hasMultiStrokeStyle](IEllipseData.md#__hasmultistrokestyle)
- [\_\_hasMultiPaint](IEllipseData.md#__hasmultipaint)
- [\_\_isAlphaPixelFill](IEllipseData.md#__isalphapixelfill)
- [\_\_isAlphaPixelStroke](IEllipseData.md#__isalphapixelstroke)
- [\_\_isTransparentFill](IEllipseData.md#__istransparentfill)
- [\_\_isTransparentStroke](IEllipseData.md#__istransparentstroke)
- [\_\_isHitPixel](IEllipseData.md#__ishitpixel)
- [\_\_isCanvas](IEllipseData.md#__iscanvas)
- [\_\_isFastShadow](IEllipseData.md#__isfastshadow)
- [\_\_fillAfterStroke](IEllipseData.md#__fillafterstroke)
- [\_\_drawAfterFill](IEllipseData.md#__drawafterfill)
- [\_\_clipAfterFill](IEllipseData.md#__clipafterfill)
- [\_\_hasSurface](IEllipseData.md#__hassurface)
- [\_\_blendLayer](IEllipseData.md#__blendlayer)
- [\_\_boxStroke](IEllipseData.md#__boxstroke)
- [\_\_font](IEllipseData.md#__font)
- [\_\_textDrawData](IEllipseData.md#__textdrawdata)
- [\_\_needComputePaint](IEllipseData.md#__needcomputepaint)

### Methods

- [\_\_get](IEllipseData.md#__get)
- [\_\_getData](IEllipseData.md#__getdata)
- [\_\_setInput](IEllipseData.md#__setinput)
- [\_\_getInput](IEllipseData.md#__getinput)
- [\_\_removeInput](IEllipseData.md#__removeinput)
- [\_\_getInputData](IEllipseData.md#__getinputdata)
- [\_\_setMiddle](IEllipseData.md#__setmiddle)
- [\_\_getMiddle](IEllipseData.md#__getmiddle)
- [destroy](IEllipseData.md#destroy)
- [\_\_checkSingle](IEllipseData.md#__checksingle)
- [\_\_removeNaturalSize](IEllipseData.md#__removenaturalsize)
- [\_\_computePaint](IEllipseData.md#__computepaint)
- [\_\_getRealStrokeWidth](IEllipseData.md#__getrealstrokewidth)
- [\_\_setPaint](IEllipseData.md#__setpaint)
- [\_\_removePaint](IEllipseData.md#__removepaint)
