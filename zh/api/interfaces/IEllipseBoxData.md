...
- [\_\_leaf](IEllipseBoxData.md#__leaf)
- [\_\_input](IEllipseBoxData.md#__input)
- [\_\_middle](IEllipseBoxData.md#__middle)
- [\_\_single](IEllipseBoxData.md#__single)
- [\_\_willDestroy](IEllipseBoxData.md#__willdestroy)
- [id](IEllipseBoxData.md#id)
- [name](IEllipseBoxData.md#name)
- [className](IEllipseBoxData.md#classname)
- [blendMode](IEllipseBoxData.md#blendmode)
- [opacity](IEllipseBoxData.md#opacity)
- [visible](IEllipseBoxData.md#visible)
- [selected](IEllipseBoxData.md#selected)
- [disabled](IEllipseBoxData.md#disabled)
- [locked](IEllipseBoxData.md#locked)
- [zIndex](IEllipseBoxData.md#zindex)
- [dim](IEllipseBoxData.md#dim)
- [dimskip](IEllipseBoxData.md#dimskip)
- [bright](IEllipseBoxData.md#bright)
- [mask](IEllipseBoxData.md#mask)
- [eraser](IEllipseBoxData.md#eraser)
- [filter](IEllipseBoxData.md#filter)
- [complex](IEllipseBoxData.md#complex)
- [x](IEllipseBoxData.md#x)
- [y](IEllipseBoxData.md#y)
- [width](IEllipseBoxData.md#width)
- [height](IEllipseBoxData.md#height)
- [scaleX](IEllipseBoxData.md#scalex)
- [scaleY](IEllipseBoxData.md#scaley)
- [scaleFixed](IEllipseBoxData.md#scalefixed)
- [rotation](IEllipseBoxData.md#rotation)
- [skewX](IEllipseBoxData.md#skewx)
- [skewY](IEllipseBoxData.md#skewy)
- [offsetX](IEllipseBoxData.md#offsetx)
- [offsetY](IEllipseBoxData.md#offsety)
- [scrollX](IEllipseBoxData.md#scrollx)
- [scrollY](IEllipseBoxData.md#scrolly)
- [origin](IEllipseBoxData.md#origin)
- [around](IEllipseBoxData.md#around)
- [lazy](IEllipseBoxData.md#lazy)
- [pixelRatio](IEllipseBoxData.md#pixelratio)
- [renderSpread](IEllipseBoxData.md#renderspread)
- [path](IEllipseBoxData.md#path)
- [windingRule](IEllipseBoxData.md#windingrule)
- [closed](IEllipseBoxData.md#closed)
- [flow](IEllipseBoxData.md#flow)
- [padding](IEllipseBoxData.md#padding)
- [gap](IEllipseBoxData.md#gap)
- [flowAlign](IEllipseBoxData.md#flowalign)
- [flowWrap](IEllipseBoxData.md#flowwrap)
- [itemBox](IEllipseBoxData.md#itembox)
- [inFlow](IEllipseBoxData.md#inflow)
- [autoWidth](IEllipseBoxData.md#autowidth)
- [autoHeight](IEllipseBoxData.md#autoheight)
- [lockRatio](IEllipseBoxData.md#lockratio)
- [autoBox](IEllipseBoxData.md#autobox)
- [widthRange](IEllipseBoxData.md#widthrange)
- [heightRange](IEllipseBoxData.md#heightrange)
- [draggable](IEllipseBoxData.md#draggable)
- [dragBounds](IEllipseBoxData.md#dragbounds)
- [dragBoundsType](IEllipseBoxData.md#dragboundstype)
- [editable](IEllipseBoxData.md#editable)
- [hittable](IEllipseBoxData.md#hittable)
- [hitFill](IEllipseBoxData.md#hitfill)
- [hitStroke](IEllipseBoxData.md#hitstroke)
- [hitBox](IEllipseBoxData.md#hitbox)
- [hitChildren](IEllipseBoxData.md#hitchildren)
- [hitSelf](IEllipseBoxData.md#hitself)
- [hitRadius](IEllipseBoxData.md#hitradius)
- [button](IEllipseBoxData.md#button)
- [cursor](IEllipseBoxData.md#cursor)
- [motionPath](IEllipseBoxData.md#motionpath)
- [motionPrecision](IEllipseBoxData.md#motionprecision)
- [motion](IEllipseBoxData.md#motion)
- [motionRotation](IEllipseBoxData.md#motionrotation)
- [normalStyle](IEllipseBoxData.md#normalstyle)
- [data](IEllipseBoxData.md#data)
- [\_\_childBranchNumber](IEllipseBoxData.md#__childbranchnumber)
- [\_\_complex](IEllipseBoxData.md#__complex)
- [\_\_complexData](IEllipseBoxData.md#__complexdata)
- [\_\_naturalWidth](IEllipseBoxData.md#__naturalwidth)
- [\_\_naturalHeight](IEllipseBoxData.md#__naturalheight)
- [\_\_autoWidth](IEllipseBoxData.md#__autowidth)
- [\_\_autoHeight](IEllipseBoxData.md#__autoheight)
- [\_\_autoSide](IEllipseBoxData.md#__autoside)
- [\_\_autoSize](IEllipseBoxData.md#__autosize)
- [\_\_useNaturalRatio](IEllipseBoxData.md#__usenaturalratio)
- [\_\_isLinePath](IEllipseBoxData.md#__islinepath)
- [\_\_blendMode](IEllipseBoxData.md#__blendmode)
- [\_\_useStroke](IEllipseBoxData.md#__usestroke)
- [\_\_useArrow](IEllipseBoxData.md#__usearrow)
- [\_\_useEffect](IEllipseBoxData.md#__useeffect)
- [\_\_usePathBox](IEllipseBoxData.md#__usepathbox)
- [\_\_useDim](IEllipseBoxData.md#__usedim)
- [\_\_pathInputed](IEllipseBoxData.md#__pathinputed)
- [\_\_pathForRender](IEllipseBoxData.md#__pathforrender)
- [\_\_path2DForRender](IEllipseBoxData.md#__path2dforrender)
- [\_\_startArrowPath](IEllipseBoxData.md#__startarrowpath)
- [\_\_endArrowPath](IEllipseBoxData.md#__endarrowpath)
- [\_\_pathForMotion](IEllipseBoxData.md#__pathformotion)
- [cornerRadius](IEllipseBoxData.md#cornerradius)
- [cornerSmoothing](IEllipseBoxData.md#cornersmoothing)
- [fill](IEllipseBoxData.md#fill)
- [borderWidth](IEllipseBoxData.md#borderwidth)
- [borderRadius](IEllipseBoxData.md#borderradius)
- [stroke](IEllipseBoxData.md#stroke)
- [startArrow](IEllipseBoxData.md#startarrow)
- [endArrow](IEllipseBoxData.md#endarrow)
- [strokeAlign](IEllipseBoxData.md#strokealign)
- [strokeWidth](IEllipseBoxData.md#strokewidth)
- [strokeWidths](IEllipseBoxData.md#strokewidths)
- [strokeScaleFixed](IEllipseBoxData.md#strokescalefixed)
- [strokeCap](IEllipseBoxData.md#strokecap)
- [strokeJoin](IEllipseBoxData.md#strokejoin)
- [dashPattern](IEllipseBoxData.md#dashpattern)
- [dashOffset](IEllipseBoxData.md#dashoffset)
- [miterLimit](IEllipseBoxData.md#miterlimit)
- [fontFamily](IEllipseBoxData.md#fontfamily)
- [fontSize](IEllipseBoxData.md#fontsize)
- [fontWeight](IEllipseBoxData.md#fontweight)
- [italic](IEllipseBoxData.md#italic)
- [textCase](IEllipseBoxData.md#textcase)
- [textDecoration](IEllipseBoxData.md#textdecoration)
- [letterSpacing](IEllipseBoxData.md#letterspacing)
- [lineHeight](IEllipseBoxData.md#lineheight)
- [paraIndent](IEllipseBoxData.md#paraindent)
- [paraSpacing](IEllipseBoxData.md#paraspacing)
- [writingMode](IEllipseBoxData.md#writingmode)
- [textAlign](IEllipseBoxData.md#textalign)
- [verticalAlign](IEllipseBoxData.md#verticalalign)
- [autoSizeAlign](IEllipseBoxData.md#autosizealign)
- [textWrap](IEllipseBoxData.md#textwrap)
- [textOverflow](IEllipseBoxData.md#textoverflow)
- [shadow](IEllipseBoxData.md#shadow)
- [innerShadow](IEllipseBoxData.md#innershadow)
- [blur](IEllipseBoxData.md#blur)
- [backgroundBlur](IEllipseBoxData.md#backgroundblur)
- [grayscale](IEllipseBoxData.md#grayscale)
- [startAngle](IEllipseBoxData.md#startangle)
- [endAngle](IEllipseBoxData.md#endangle)
- [innerRadius](IEllipseBoxData.md#innerradius)
- [overflow](IEllipseBoxData.md#overflow)
- [scrollConfig](IEllipseBoxData.md#scrollconfig)
- [resizeChildren](IEllipseBoxData.md#resizechildren)
- [textBox](IEllipseBoxData.md#textbox)
- [animation](IEllipseBoxData.md#animation)
- [animationOut](IEllipseBoxData.md#animationout)
- [transition](IEllipseBoxData.md#transition)
- [transitionOut](IEllipseBoxData.md#transitionout)
- [states](IEllipseBoxData.md#states)
- [state](IEllipseBoxData.md#state)
- [hoverStyle](IEllipseBoxData.md#hoverstyle)
- [pressStyle](IEllipseBoxData.md#pressstyle)
- [focusStyle](IEllipseBoxData.md#focusstyle)
- [selectedStyle](IEllipseBoxData.md#selectedstyle)
- [disabledStyle](IEllipseBoxData.md#disabledstyle)
- [placeholderStyle](IEllipseBoxData.md#placeholderstyle)
- [placeholderColor](IEllipseBoxData.md#placeholdercolor)
- [placeholderDelay](IEllipseBoxData.md#placeholderdelay)
- [editConfig](IEllipseBoxData.md#editconfig)
- [editOuter](IEllipseBoxData.md#editouter)
- [editInner](IEllipseBoxData.md#editinner)
- [scale](IEllipseBoxData.md#scale)
- [\_\_isFills](IEllipseBoxData.md#__isfills)
- [\_\_isStrokes](IEllipseBoxData.md#__isstrokes)
- [\_\_strokeWidth](IEllipseBoxData.md#__strokewidth)
- [\_\_maxStrokeWidth](IEllipseBoxData.md#__maxstrokewidth)
- [\_\_strokeWidthCache](IEllipseBoxData.md#__strokewidthcache)
- [\_\_hasMultiStrokeStyle](IEllipseBoxData.md#__hasmultistrokestyle)
- [\_\_hasMultiPaint](IEllipseBoxData.md#__hasmultipaint)
- [\_\_isAlphaPixelFill](IEllipseBoxData.md#__isalphapixelfill)
- [\_\_isAlphaPixelStroke](IEllipseBoxData.md#__isalphapixelstroke)
- [\_\_isTransparentFill](IEllipseBoxData.md#__istransparentfill)
- [\_\_isTransparentStroke](IEllipseBoxData.md#__istransparentstroke)
- [\_\_isHitPixel](IEllipseBoxData.md#__ishitpixel)
- [\_\_isCanvas](IEllipseBoxData.md#__iscanvas)
- [\_\_isFastShadow](IEllipseBoxData.md#__isfastshadow)
- [\_\_fillAfterStroke](IEllipseBoxData.md#__fillafterstroke)
- [\_\_drawAfterFill](IEllipseBoxData.md#__drawafterfill)
- [\_\_clipAfterFill](IEllipseBoxData.md#__clipafterfill)
- [\_\_hasSurface](IEllipseBoxData.md#__hassurface)
- [\_\_blendLayer](IEllipseBoxData.md#__blendlayer)
- [\_\_boxStroke](IEllipseBoxData.md#__boxstroke)
- [\_\_font](IEllipseBoxData.md#__font)
- [\_\_textDrawData](IEllipseBoxData.md#__textdrawdata)
- [\_\_needComputePaint](IEllipseBoxData.md#__needcomputepaint)

### Methods

- [\_\_get](IEllipseBoxData.md#__get)
- [\_\_getData](IEllipseBoxData.md#__getdata)
- [\_\_setInput](IEllipseBoxData.md#__setinput)
- [\_\_getInput](IEllipseBoxData.md#__getinput)
- [\_\_removeInput](IEllipseBoxData.md#__removeinput)
- [\_\_getInputData](IEllipseBoxData.md#__getinputdata)
- [\_\_setMiddle](IEllipseBoxData.md#__setmiddle)
- [\_\_getMiddle](IEllipseBoxData.md#__getmiddle)
- [destroy](IEllipseBoxData.md#destroy)
- [\_\_checkSingle](IEllipseBoxData.md#__checksingle)
- [\_\_removeNaturalSize](IEllipseBoxData.md#__removenaturalsize)
- [\_\_computePaint](IEllipseBoxData.md#__computepaint)
- [\_\_getRealStrokeWidth](IEllipseBoxData.md#__getrealstrokewidth)
- [\_\_setPaint](IEllipseBoxData.md#__setpaint)
- [\_\_removePaint](IEllipseBoxData.md#__removepaint)
