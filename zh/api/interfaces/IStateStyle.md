...
- [dim](IStateStyle.md#dim)
- [dimskip](IStateStyle.md#dimskip)
- [bright](IStateStyle.md#bright)
- [mask](IStateStyle.md#mask)
- [eraser](IStateStyle.md#eraser)
- [filter](IStateStyle.md#filter)
- [complex](IStateStyle.md#complex)
- [x](IStateStyle.md#x)
- [y](IStateStyle.md#y)
...
- [scaleFixed](IStateStyle.md#scalefixed)
...
- [renderSpread](IStateStyle.md#renderspread)
...
- [dragBoundsType](IStateStyle.md#dragboundstype)
- [editable](IStateStyle.md#editable)
- [hittable](IStateStyle.md#hittable)
...
- [strokeScaleFixed](IStateStyle.md#strokescalefixed)
...
- [points](IStateStyle.md#points)
- [curve](IStateStyle.md#curve)
- [corners](IStateStyle.md#corners)
- [text](IStateStyle.md#text)
- [placeholder](IStateStyle.md#placeholder)
- [resizeFontSize](IStateStyle.md#resizefontsize)
- [boxStyle](IStateStyle.md#boxstyle)
- [textEditing](IStateStyle.md#textediting)
- [url](IStateStyle.md#url)
- [foreground](IStateStyle.md#foreground)
- [background](IStateStyle.md#background)
...
- [scrollConfig](IStateStyle.md#scrollconfig)
...
- [placeholderColor](IStateStyle.md#placeholdercolor)
- [placeholderDelay](IStateStyle.md#placeholderdelay)
