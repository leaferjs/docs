...
- [\_\_leaf](IPolygonBoxData.md#__leaf)
- [\_\_input](IPolygonBoxData.md#__input)
- [\_\_middle](IPolygonBoxData.md#__middle)
- [\_\_single](IPolygonBoxData.md#__single)
- [\_\_willDestroy](IPolygonBoxData.md#__willdestroy)
- [id](IPolygonBoxData.md#id)
- [name](IPolygonBoxData.md#name)
- [className](IPolygonBoxData.md#classname)
- [blendMode](IPolygonBoxData.md#blendmode)
- [opacity](IPolygonBoxData.md#opacity)
- [visible](IPolygonBoxData.md#visible)
- [selected](IPolygonBoxData.md#selected)
- [disabled](IPolygonBoxData.md#disabled)
- [locked](IPolygonBoxData.md#locked)
- [zIndex](IPolygonBoxData.md#zindex)
- [dim](IPolygonBoxData.md#dim)
- [dimskip](IPolygonBoxData.md#dimskip)
- [bright](IPolygonBoxData.md#bright)
- [mask](IPolygonBoxData.md#mask)
- [eraser](IPolygonBoxData.md#eraser)
- [filter](IPolygonBoxData.md#filter)
- [complex](IPolygonBoxData.md#complex)
- [x](IPolygonBoxData.md#x)
- [y](IPolygonBoxData.md#y)
- [width](IPolygonBoxData.md#width)
- [height](IPolygonBoxData.md#height)
- [scaleX](IPolygonBoxData.md#scalex)
- [scaleY](IPolygonBoxData.md#scaley)
- [scaleFixed](IPolygonBoxData.md#scalefixed)
- [rotation](IPolygonBoxData.md#rotation)
- [skewX](IPolygonBoxData.md#skewx)
- [skewY](IPolygonBoxData.md#skewy)
- [offsetX](IPolygonBoxData.md#offsetx)
- [offsetY](IPolygonBoxData.md#offsety)
- [scrollX](IPolygonBoxData.md#scrollx)
- [scrollY](IPolygonBoxData.md#scrolly)
- [origin](IPolygonBoxData.md#origin)
- [around](IPolygonBoxData.md#around)
- [lazy](IPolygonBoxData.md#lazy)
- [pixelRatio](IPolygonBoxData.md#pixelratio)
- [renderSpread](IPolygonBoxData.md#renderspread)
- [path](IPolygonBoxData.md#path)
- [windingRule](IPolygonBoxData.md#windingrule)
- [closed](IPolygonBoxData.md#closed)
- [flow](IPolygonBoxData.md#flow)
- [padding](IPolygonBoxData.md#padding)
- [gap](IPolygonBoxData.md#gap)
- [flowAlign](IPolygonBoxData.md#flowalign)
- [flowWrap](IPolygonBoxData.md#flowwrap)
- [itemBox](IPolygonBoxData.md#itembox)
- [inFlow](IPolygonBoxData.md#inflow)
- [autoWidth](IPolygonBoxData.md#autowidth)
- [autoHeight](IPolygonBoxData.md#autoheight)
- [lockRatio](IPolygonBoxData.md#lockratio)
- [autoBox](IPolygonBoxData.md#autobox)
- [widthRange](IPolygonBoxData.md#widthrange)
- [heightRange](IPolygonBoxData.md#heightrange)
- [draggable](IPolygonBoxData.md#draggable)
- [dragBounds](IPolygonBoxData.md#dragbounds)
- [dragBoundsType](IPolygonBoxData.md#dragboundstype)
- [editable](IPolygonBoxData.md#editable)
- [hittable](IPolygonBoxData.md#hittable)
- [hitFill](IPolygonBoxData.md#hitfill)
- [hitStroke](IPolygonBoxData.md#hitstroke)
- [hitBox](IPolygonBoxData.md#hitbox)
- [hitChildren](IPolygonBoxData.md#hitchildren)
- [hitSelf](IPolygonBoxData.md#hitself)
- [hitRadius](IPolygonBoxData.md#hitradius)
- [button](IPolygonBoxData.md#button)
- [cursor](IPolygonBoxData.md#cursor)
- [motionPath](IPolygonBoxData.md#motionpath)
- [motionPrecision](IPolygonBoxData.md#motionprecision)
- [motion](IPolygonBoxData.md#motion)
- [motionRotation](IPolygonBoxData.md#motionrotation)
- [normalStyle](IPolygonBoxData.md#normalstyle)
- [data](IPolygonBoxData.md#data)
- [\_\_childBranchNumber](IPolygonBoxData.md#__childbranchnumber)
- [\_\_complex](IPolygonBoxData.md#__complex)
- [\_\_complexData](IPolygonBoxData.md#__complexdata)
- [\_\_naturalWidth](IPolygonBoxData.md#__naturalwidth)
- [\_\_naturalHeight](IPolygonBoxData.md#__naturalheight)
- [\_\_autoWidth](IPolygonBoxData.md#__autowidth)
- [\_\_autoHeight](IPolygonBoxData.md#__autoheight)
- [\_\_autoSide](IPolygonBoxData.md#__autoside)
- [\_\_autoSize](IPolygonBoxData.md#__autosize)
- [\_\_useNaturalRatio](IPolygonBoxData.md#__usenaturalratio)
- [\_\_isLinePath](IPolygonBoxData.md#__islinepath)
- [\_\_blendMode](IPolygonBoxData.md#__blendmode)
- [\_\_useStroke](IPolygonBoxData.md#__usestroke)
- [\_\_useArrow](IPolygonBoxData.md#__usearrow)
- [\_\_useEffect](IPolygonBoxData.md#__useeffect)
- [\_\_usePathBox](IPolygonBoxData.md#__usepathbox)
- [\_\_useDim](IPolygonBoxData.md#__usedim)
- [\_\_pathInputed](IPolygonBoxData.md#__pathinputed)
- [\_\_pathForRender](IPolygonBoxData.md#__pathforrender)
- [\_\_path2DForRender](IPolygonBoxData.md#__path2dforrender)
- [\_\_startArrowPath](IPolygonBoxData.md#__startarrowpath)
- [\_\_endArrowPath](IPolygonBoxData.md#__endarrowpath)
- [\_\_pathForMotion](IPolygonBoxData.md#__pathformotion)
- [cornerRadius](IPolygonBoxData.md#cornerradius)
- [cornerSmoothing](IPolygonBoxData.md#cornersmoothing)
- [fill](IPolygonBoxData.md#fill)
- [borderWidth](IPolygonBoxData.md#borderwidth)
- [borderRadius](IPolygonBoxData.md#borderradius)
- [stroke](IPolygonBoxData.md#stroke)
- [startArrow](IPolygonBoxData.md#startarrow)
- [endArrow](IPolygonBoxData.md#endarrow)
- [strokeAlign](IPolygonBoxData.md#strokealign)
- [strokeWidth](IPolygonBoxData.md#strokewidth)
- [strokeWidths](IPolygonBoxData.md#strokewidths)
- [strokeScaleFixed](IPolygonBoxData.md#strokescalefixed)
- [strokeCap](IPolygonBoxData.md#strokecap)
- [strokeJoin](IPolygonBoxData.md#strokejoin)
- [dashPattern](IPolygonBoxData.md#dashpattern)
- [dashOffset](IPolygonBoxData.md#dashoffset)
- [miterLimit](IPolygonBoxData.md#miterlimit)
- [fontFamily](IPolygonBoxData.md#fontfamily)
- [fontSize](IPolygonBoxData.md#fontsize)
- [fontWeight](IPolygonBoxData.md#fontweight)
- [italic](IPolygonBoxData.md#italic)
- [textCase](IPolygonBoxData.md#textcase)
- [textDecoration](IPolygonBoxData.md#textdecoration)
- [letterSpacing](IPolygonBoxData.md#letterspacing)
- [lineHeight](IPolygonBoxData.md#lineheight)
- [paraIndent](IPolygonBoxData.md#paraindent)
- [paraSpacing](IPolygonBoxData.md#paraspacing)
- [writingMode](IPolygonBoxData.md#writingmode)
- [textAlign](IPolygonBoxData.md#textalign)
- [verticalAlign](IPolygonBoxData.md#verticalalign)
- [autoSizeAlign](IPolygonBoxData.md#autosizealign)
- [textWrap](IPolygonBoxData.md#textwrap)
- [textOverflow](IPolygonBoxData.md#textoverflow)
- [shadow](IPolygonBoxData.md#shadow)
- [innerShadow](IPolygonBoxData.md#innershadow)
- [blur](IPolygonBoxData.md#blur)
- [backgroundBlur](IPolygonBoxData.md#backgroundblur)
- [grayscale](IPolygonBoxData.md#grayscale)
- [sides](IPolygonBoxData.md#sides)
- [points](IPolygonBoxData.md#points)
- [curve](IPolygonBoxData.md#curve)
- [overflow](IPolygonBoxData.md#overflow)
- [scrollConfig](IPolygonBoxData.md#scrollconfig)
- [resizeChildren](IPolygonBoxData.md#resizechildren)
- [textBox](IPolygonBoxData.md#textbox)
- [animation](IPolygonBoxData.md#animation)
- [animationOut](IPolygonBoxData.md#animationout)
- [transition](IPolygonBoxData.md#transition)
- [transitionOut](IPolygonBoxData.md#transitionout)
- [states](IPolygonBoxData.md#states)
- [state](IPolygonBoxData.md#state)
- [hoverStyle](IPolygonBoxData.md#hoverstyle)
- [pressStyle](IPolygonBoxData.md#pressstyle)
- [focusStyle](IPolygonBoxData.md#focusstyle)
- [selectedStyle](IPolygonBoxData.md#selectedstyle)
- [disabledStyle](IPolygonBoxData.md#disabledstyle)
- [placeholderStyle](IPolygonBoxData.md#placeholderstyle)
- [placeholderColor](IPolygonBoxData.md#placeholdercolor)
- [placeholderDelay](IPolygonBoxData.md#placeholderdelay)
- [editConfig](IPolygonBoxData.md#editconfig)
- [editOuter](IPolygonBoxData.md#editouter)
- [editInner](IPolygonBoxData.md#editinner)
- [scale](IPolygonBoxData.md#scale)
- [\_\_isFills](IPolygonBoxData.md#__isfills)
- [\_\_isStrokes](IPolygonBoxData.md#__isstrokes)
- [\_\_strokeWidth](IPolygonBoxData.md#__strokewidth)
- [\_\_maxStrokeWidth](IPolygonBoxData.md#__maxstrokewidth)
- [\_\_strokeWidthCache](IPolygonBoxData.md#__strokewidthcache)
- [\_\_hasMultiStrokeStyle](IPolygonBoxData.md#__hasmultistrokestyle)
- [\_\_hasMultiPaint](IPolygonBoxData.md#__hasmultipaint)
- [\_\_isAlphaPixelFill](IPolygonBoxData.md#__isalphapixelfill)
- [\_\_isAlphaPixelStroke](IPolygonBoxData.md#__isalphapixelstroke)
- [\_\_isTransparentFill](IPolygonBoxData.md#__istransparentfill)
- [\_\_isTransparentStroke](IPolygonBoxData.md#__istransparentstroke)
- [\_\_isHitPixel](IPolygonBoxData.md#__ishitpixel)
- [\_\_isCanvas](IPolygonBoxData.md#__iscanvas)
- [\_\_isFastShadow](IPolygonBoxData.md#__isfastshadow)
- [\_\_fillAfterStroke](IPolygonBoxData.md#__fillafterstroke)
- [\_\_drawAfterFill](IPolygonBoxData.md#__drawafterfill)
- [\_\_clipAfterFill](IPolygonBoxData.md#__clipafterfill)
- [\_\_hasSurface](IPolygonBoxData.md#__hassurface)
- [\_\_blendLayer](IPolygonBoxData.md#__blendlayer)
- [\_\_boxStroke](IPolygonBoxData.md#__boxstroke)
- [\_\_font](IPolygonBoxData.md#__font)
- [\_\_textDrawData](IPolygonBoxData.md#__textdrawdata)
- [\_\_needComputePaint](IPolygonBoxData.md#__needcomputepaint)

### Methods

- [\_\_get](IPolygonBoxData.md#__get)
- [\_\_getData](IPolygonBoxData.md#__getdata)
- [\_\_setInput](IPolygonBoxData.md#__setinput)
- [\_\_getInput](IPolygonBoxData.md#__getinput)
- [\_\_removeInput](IPolygonBoxData.md#__removeinput)
- [\_\_getInputData](IPolygonBoxData.md#__getinputdata)
- [\_\_setMiddle](IPolygonBoxData.md#__setmiddle)
- [\_\_getMiddle](IPolygonBoxData.md#__getmiddle)
- [destroy](IPolygonBoxData.md#destroy)
- [\_\_checkSingle](IPolygonBoxData.md#__checksingle)
- [\_\_removeNaturalSize](IPolygonBoxData.md#__removenaturalsize)
- [\_\_computePaint](IPolygonBoxData.md#__computepaint)
- [\_\_getRealStrokeWidth](IPolygonBoxData.md#__getrealstrokewidth)
- [\_\_setPaint](IPolygonBoxData.md#__setpaint)
- [\_\_removePaint](IPolygonBoxData.md#__removepaint)
