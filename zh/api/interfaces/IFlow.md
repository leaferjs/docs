...
- [bright](IFlow.md#bright)
- [mask](IFlow.md#mask)
- [eraser](IFlow.md#eraser)
- [filter](IFlow.md#filter)
- [complex](IFlow.md#complex)
- [x](IFlow.md#x)
- [y](IFlow.md#y)
...
- [scaleFixed](IFlow.md#scalefixed)
...
- [\_\_nowWorldShapeBounds](IFlow.md#__nowworldshapebounds)
...
- [\_\_hasComplex](IFlow.md#__hascomplex)
...
- [strokeScaleFixed](IFlow.md#strokescalefixed)
...
- [startLinker](IFlow.md#startlinker)
- [endLinker](IFlow.md#endlinker)
...
- [clearProxyData](IFlow.md#clearproxydata)
- [find](IFlow.md#find)
...
[src/ui/packages/interface/src/IUI.ts:95](https://github.com/leaferjs/leafer-ui/blob/88373cdd6f1051b44f1295f2d1866778d0675b15/packages/interface/src/IUI.ts#L95)
...
▸ **get**\<`K`\>(`name`): [`IFlow`](IFlow.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IFlow`](IFlow.md) |
