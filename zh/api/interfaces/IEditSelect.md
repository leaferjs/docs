...
- [editor](IEditSelect.md#editor)
- [dragging](IEditSelect.md#dragging)
- [running](IEditSelect.md#running)
- [hoverStroker](IEditSelect.md#hoverstroker)
- [targetStroker](IEditSelect.md#targetstroker)
- [selectArea](IEditSelect.md#selectarea)
- [bounds](IEditSelect.md#bounds)
- [id](IEditSelect.md#id)
- [name](IEditSelect.md#name)
- [className](IEditSelect.md#classname)
- [blendMode](IEditSelect.md#blendmode)
- [opacity](IEditSelect.md#opacity)
- [visible](IEditSelect.md#visible)
- [selected](IEditSelect.md#selected)
- [disabled](IEditSelect.md#disabled)
- [locked](IEditSelect.md#locked)
- [zIndex](IEditSelect.md#zindex)
- [dim](IEditSelect.md#dim)
- [dimskip](IEditSelect.md#dimskip)
- [bright](IEditSelect.md#bright)
- [mask](IEditSelect.md#mask)
- [eraser](IEditSelect.md#eraser)
- [filter](IEditSelect.md#filter)
- [complex](IEditSelect.md#complex)
- [x](IEditSelect.md#x)
- [y](IEditSelect.md#y)
- [width](IEditSelect.md#width)
- [height](IEditSelect.md#height)
- [scaleX](IEditSelect.md#scalex)
- [scaleY](IEditSelect.md#scaley)
- [scaleFixed](IEditSelect.md#scalefixed)
- [rotation](IEditSelect.md#rotation)
- [skewX](IEditSelect.md#skewx)
- [skewY](IEditSelect.md#skewy)
- [scale](IEditSelect.md#scale)
- [offsetX](IEditSelect.md#offsetx)
- [offsetY](IEditSelect.md#offsety)
- [scrollX](IEditSelect.md#scrollx)
- [scrollY](IEditSelect.md#scrolly)
- [origin](IEditSelect.md#origin)
- [around](IEditSelect.md#around)
- [lazy](IEditSelect.md#lazy)
- [pixelRatio](IEditSelect.md#pixelratio)
- [renderSpread](IEditSelect.md#renderspread)
- [path](IEditSelect.md#path)
- [windingRule](IEditSelect.md#windingrule)
- [closed](IEditSelect.md#closed)
- [flow](IEditSelect.md#flow)
- [padding](IEditSelect.md#padding)
- [gap](IEditSelect.md#gap)
- [flowAlign](IEditSelect.md#flowalign)
- [flowWrap](IEditSelect.md#flowwrap)
- [itemBox](IEditSelect.md#itembox)
- [inFlow](IEditSelect.md#inflow)
- [autoWidth](IEditSelect.md#autowidth)
- [autoHeight](IEditSelect.md#autoheight)
- [lockRatio](IEditSelect.md#lockratio)
- [autoBox](IEditSelect.md#autobox)
- [widthRange](IEditSelect.md#widthrange)
- [heightRange](IEditSelect.md#heightrange)
- [draggable](IEditSelect.md#draggable)
- [dragBounds](IEditSelect.md#dragbounds)
- [dragBoundsType](IEditSelect.md#dragboundstype)
- [editable](IEditSelect.md#editable)
- [hittable](IEditSelect.md#hittable)
- [hitFill](IEditSelect.md#hitfill)
- [hitStroke](IEditSelect.md#hitstroke)
- [hitBox](IEditSelect.md#hitbox)
- [hitChildren](IEditSelect.md#hitchildren)
- [hitSelf](IEditSelect.md#hitself)
- [hitRadius](IEditSelect.md#hitradius)
- [button](IEditSelect.md#button)
- [cursor](IEditSelect.md#cursor)
- [motionPath](IEditSelect.md#motionpath)
- [motionPrecision](IEditSelect.md#motionprecision)
- [motion](IEditSelect.md#motion)
- [motionRotation](IEditSelect.md#motionrotation)
- [normalStyle](IEditSelect.md#normalstyle)
- [event](IEditSelect.md#event)
- [data](IEditSelect.md#data)
- [tag](IEditSelect.md#tag)
- [\_\_tag](IEditSelect.md#__tag)
- [innerName](IEditSelect.md#innername)
- [\_\_DataProcessor](IEditSelect.md#__dataprocessor)
- [\_\_LayoutProcessor](IEditSelect.md#__layoutprocessor)
- [leaferIsCreated](IEditSelect.md#leaferiscreated)
- [leaferIsReady](IEditSelect.md#leaferisready)
- [isApp](IEditSelect.md#isapp)
- [isLeafer](IEditSelect.md#isleafer)
- [isBranch](IEditSelect.md#isbranch)
- [isBranchLeaf](IEditSelect.md#isbranchleaf)
- [isOutside](IEditSelect.md#isoutside)
- [skipJSON](IEditSelect.md#skipjson)
- [syncEventer](IEditSelect.md#synceventer)
- [lockNormalStyle](IEditSelect.md#locknormalstyle)
- [\_\_layout](IEditSelect.md#__layout)
- [\_\_world](IEditSelect.md#__world)
- [\_\_local](IEditSelect.md#__local)
- [\_\_nowWorld](IEditSelect.md#__nowworld)
- [\_\_cameraWorld](IEditSelect.md#__cameraworld)
- [\_\_nowWorldShapeBounds](IEditSelect.md#__nowworldshapebounds)
- [\_\_localMatrix](IEditSelect.md#__localmatrix)
- [\_\_localBoxBounds](IEditSelect.md#__localboxbounds)
- [\_\_worldOpacity](IEditSelect.md#__worldopacity)
- [worldTransform](IEditSelect.md#worldtransform)
- [localTransform](IEditSelect.md#localtransform)
- [\_\_scrollWorld](IEditSelect.md#__scrollworld)
- [scrollWorldTransform](IEditSelect.md#scrollworldtransform)
- [boxBounds](IEditSelect.md#boxbounds)
- [renderBounds](IEditSelect.md#renderbounds)
- [worldBoxBounds](IEditSelect.md#worldboxbounds)
- [worldStrokeBounds](IEditSelect.md#worldstrokebounds)
- [worldRenderBounds](IEditSelect.md#worldrenderbounds)
- [worldOpacity](IEditSelect.md#worldopacity)
- [\_\_level](IEditSelect.md#__level)
- [\_\_tempNumber](IEditSelect.md#__tempnumber)
- [\_\_worldFlipped](IEditSelect.md#__worldflipped)
- [\_\_hasAutoLayout](IEditSelect.md#__hasautolayout)
- [\_\_hasMotionPath](IEditSelect.md#__hasmotionpath)
- [\_\_hasComplex](IEditSelect.md#__hascomplex)
- [\_\_hasMask](IEditSelect.md#__hasmask)
- [\_\_hasEraser](IEditSelect.md#__haseraser)
- [\_\_hitCanvas](IEditSelect.md#__hitcanvas)
- [\_\_flowBounds](IEditSelect.md#__flowbounds)
- [\_\_widthGrow](IEditSelect.md#__widthgrow)
- [\_\_heightGrow](IEditSelect.md#__heightgrow)
- [\_\_hasGrow](IEditSelect.md#__hasgrow)
- [\_\_onlyHitMask](IEditSelect.md#__onlyhitmask)
- [\_\_ignoreHitWorld](IEditSelect.md#__ignorehitworld)
- [\_\_inLazyBounds](IEditSelect.md#__inlazybounds)
- [pathInputed](IEditSelect.md#pathinputed)
- [isAutoWidth](IEditSelect.md#isautowidth)
- [isAutoHeight](IEditSelect.md#isautoheight)
- [destroyed](IEditSelect.md#destroyed)
- [topChildren](IEditSelect.md#topchildren)
- [innerId](IEditSelect.md#innerid)
- [\_\_captureMap](IEditSelect.md#__capturemap)
- [\_\_bubbleMap](IEditSelect.md#__bubblemap)
- [\_\_hasLocalEvent](IEditSelect.md#__haslocalevent)
- [\_\_hasWorldEvent](IEditSelect.md#__hasworldevent)
- [cornerRadius](IEditSelect.md#cornerradius)
- [cornerSmoothing](IEditSelect.md#cornersmoothing)
- [fill](IEditSelect.md#fill)
- [stroke](IEditSelect.md#stroke)
- [startArrow](IEditSelect.md#startarrow)
- [endArrow](IEditSelect.md#endarrow)
- [strokeAlign](IEditSelect.md#strokealign)
- [strokeWidth](IEditSelect.md#strokewidth)
- [strokeScaleFixed](IEditSelect.md#strokescalefixed)
- [strokeCap](IEditSelect.md#strokecap)
- [strokeJoin](IEditSelect.md#strokejoin)
- [dashPattern](IEditSelect.md#dashpattern)
- [dashOffset](IEditSelect.md#dashoffset)
- [miterLimit](IEditSelect.md#miterlimit)
- [shadow](IEditSelect.md#shadow)
- [innerShadow](IEditSelect.md#innershadow)
- [blur](IEditSelect.md#blur)
- [backgroundBlur](IEditSelect.md#backgroundblur)
- [grayscale](IEditSelect.md#grayscale)
- [\_\_](IEditSelect.md#__)
- [children](IEditSelect.md#children)
- [childlessJSON](IEditSelect.md#childlessjson)
- [app](IEditSelect.md#app)
- [leafer](IEditSelect.md#leafer)
- [parent](IEditSelect.md#parent)
- [zoomLayer](IEditSelect.md#zoomlayer)
- [isFrame](IEditSelect.md#isframe)
- [isOverflow](IEditSelect.md#isoverflow)
- [useFastShadow](IEditSelect.md#usefastshadow)
- [proxyData](IEditSelect.md#proxydata)
- [\_\_proxyData](IEditSelect.md#__proxydata)
- [animation](IEditSelect.md#animation)
- [animationOut](IEditSelect.md#animationout)
- [startLinker](IEditSelect.md#startlinker)
- [endLinker](IEditSelect.md#endlinker)
- [\_\_box](IEditSelect.md#__box)
- [\_\_animate](IEditSelect.md#__animate)
- [pen](IEditSelect.md#pen)
- [transition](IEditSelect.md#transition)
- [transitionOut](IEditSelect.md#transitionout)
- [states](IEditSelect.md#states)
- [state](IEditSelect.md#state)
- [hoverStyle](IEditSelect.md#hoverstyle)
- [pressStyle](IEditSelect.md#pressstyle)
- [focusStyle](IEditSelect.md#focusstyle)
- [selectedStyle](IEditSelect.md#selectedstyle)
- [disabledStyle](IEditSelect.md#disabledstyle)
- [placeholderStyle](IEditSelect.md#placeholderstyle)
- [placeholderColor](IEditSelect.md#placeholdercolor)
- [placeholderDelay](IEditSelect.md#placeholderdelay)
- [editConfig](IEditSelect.md#editconfig)
- [editOuter](IEditSelect.md#editouter)
- [editInner](IEditSelect.md#editinner)

### Methods

- [findUI](IEditSelect.md#findui)
- [findDeepOne](IEditSelect.md#finddeepone)
- [update](IEditSelect.md#update)
- [resetCustom](IEditSelect.md#resetcustom)
- [waitParent](IEditSelect.md#waitparent)
- [waitLeafer](IEditSelect.md#waitleafer)
- [nextRender](IEditSelect.md#nextrender)
- [removeNextRender](IEditSelect.md#removenextrender)
- [\_\_bindLeafer](IEditSelect.md#__bindleafer)
- [setAttr](IEditSelect.md#setattr)
- [getAttr](IEditSelect.md#getattr)
- [getComputedAttr](IEditSelect.md#getcomputedattr)
- [toString](IEditSelect.md#tostring)
- [toSVG](IEditSelect.md#tosvg)
- [\_\_SVG](IEditSelect.md#__svg)
- [toHTML](IEditSelect.md#tohtml)
- [\_\_setAttr](IEditSelect.md#__setattr)
- [\_\_getAttr](IEditSelect.md#__getattr)
- [setProxyAttr](IEditSelect.md#setproxyattr)
- [getProxyAttr](IEditSelect.md#getproxyattr)
- [focus](IEditSelect.md#focus)
- [updateState](IEditSelect.md#updatestate)
- [updateLayout](IEditSelect.md#updatelayout)
- [forceUpdate](IEditSelect.md#forceupdate)
- [forceRender](IEditSelect.md#forcerender)
- [\_\_extraUpdate](IEditSelect.md#__extraupdate)
- [\_\_updateWorldMatrix](IEditSelect.md#__updateworldmatrix)
- [\_\_updateLocalMatrix](IEditSelect.md#__updatelocalmatrix)
- [\_\_updateWorldBounds](IEditSelect.md#__updateworldbounds)
- [\_\_updateLocalBounds](IEditSelect.md#__updatelocalbounds)
- [\_\_updateLocalBoxBounds](IEditSelect.md#__updatelocalboxbounds)
- [\_\_updateLocalStrokeBounds](IEditSelect.md#__updatelocalstrokebounds)
- [\_\_updateLocalRenderBounds](IEditSelect.md#__updatelocalrenderbounds)
- [\_\_updateContentBounds](IEditSelect.md#__updatecontentbounds)
- [\_\_updateBoxBounds](IEditSelect.md#__updateboxbounds)
- [\_\_updateStrokeBounds](IEditSelect.md#__updatestrokebounds)
- [\_\_updateRenderBounds](IEditSelect.md#__updaterenderbounds)
- [\_\_updateAutoLayout](IEditSelect.md#__updateautolayout)
- [\_\_updateFlowLayout](IEditSelect.md#__updateflowlayout)
- [\_\_updateNaturalSize](IEditSelect.md#__updatenaturalsize)
- [\_\_updateStrokeSpread](IEditSelect.md#__updatestrokespread)
- [\_\_updateRenderSpread](IEditSelect.md#__updaterenderspread)
- [\_\_onUpdateSize](IEditSelect.md#__onupdatesize)
- [\_\_updateEraser](IEditSelect.md#__updateeraser)
- [\_\_updateMask](IEditSelect.md#__updatemask)
- [\_\_renderMask](IEditSelect.md#__rendermask)
- [\_\_renderEraser](IEditSelect.md#__rendereraser)
- [\_\_getNowWorld](IEditSelect.md#__getnowworld)
- [getClampRenderScale](IEditSelect.md#getclamprenderscale)
- [getRenderScaleData](IEditSelect.md#getrenderscaledata)
- [getTransform](IEditSelect.md#gettransform)
- [getBounds](IEditSelect.md#getbounds)
- [getLayoutBounds](IEditSelect.md#getlayoutbounds)
- [getLayoutPoints](IEditSelect.md#getlayoutpoints)
- [getWorldBounds](IEditSelect.md#getworldbounds)
- [worldToLocal](IEditSelect.md#worldtolocal)
- [localToWorld](IEditSelect.md#localtoworld)
- [worldToInner](IEditSelect.md#worldtoinner)
- [innerToWorld](IEditSelect.md#innertoworld)
- [getBoxPoint](IEditSelect.md#getboxpoint)
- [getBoxPointByInner](IEditSelect.md#getboxpointbyinner)
- [getInnerPoint](IEditSelect.md#getinnerpoint)
- [getInnerPointByBox](IEditSelect.md#getinnerpointbybox)
- [getInnerPointByLocal](IEditSelect.md#getinnerpointbylocal)
- [getLocalPoint](IEditSelect.md#getlocalpoint)
- [getLocalPointByInner](IEditSelect.md#getlocalpointbyinner)
- [getPagePoint](IEditSelect.md#getpagepoint)
- [getWorldPoint](IEditSelect.md#getworldpoint)
- [getWorldPointByBox](IEditSelect.md#getworldpointbybox)
- [getWorldPointByLocal](IEditSelect.md#getworldpointbylocal)
- [getWorldPointByPage](IEditSelect.md#getworldpointbypage)
- [setTransform](IEditSelect.md#settransform)
- [transform](IEditSelect.md#transform)
- [move](IEditSelect.md#move)
- [moveInner](IEditSelect.md#moveinner)
- [scaleOf](IEditSelect.md#scaleof)
- [rotateOf](IEditSelect.md#rotateof)
- [skewOf](IEditSelect.md#skewof)
- [transformWorld](IEditSelect.md#transformworld)
- [moveWorld](IEditSelect.md#moveworld)
- [scaleOfWorld](IEditSelect.md#scaleofworld)
- [rotateOfWorld](IEditSelect.md#rotateofworld)
- [skewOfWorld](IEditSelect.md#skewofworld)
- [flip](IEditSelect.md#flip)
- [scaleResize](IEditSelect.md#scaleresize)
- [\_\_scaleResize](IEditSelect.md#__scaleresize)
- [resizeWidth](IEditSelect.md#resizewidth)
- [resizeHeight](IEditSelect.md#resizeheight)
- [hit](IEditSelect.md#hit)
- [\_\_hitWorld](IEditSelect.md#__hitworld)
- [\_\_hit](IEditSelect.md#__hit)
- [\_\_hitFill](IEditSelect.md#__hitfill)
- [\_\_hitStroke](IEditSelect.md#__hitstroke)
- [\_\_hitPixel](IEditSelect.md#__hitpixel)
- [\_\_drawHitPath](IEditSelect.md#__drawhitpath)
- [\_\_updateHitCanvas](IEditSelect.md#__updatehitcanvas)
- [\_\_render](IEditSelect.md#__render)
- [\_\_drawFast](IEditSelect.md#__drawfast)
- [\_\_draw](IEditSelect.md#__draw)
- [\_\_clip](IEditSelect.md#__clip)
- [\_\_renderShape](IEditSelect.md#__rendershape)
- [\_\_drawShape](IEditSelect.md#__drawshape)
- [\_\_updateWorldOpacity](IEditSelect.md#__updateworldopacity)
- [\_\_updateChange](IEditSelect.md#__updatechange)
- [\_\_drawPath](IEditSelect.md#__drawpath)
- [\_\_drawRenderPath](IEditSelect.md#__drawrenderpath)
- [\_\_updatePath](IEditSelect.md#__updatepath)
- [\_\_updateRenderPath](IEditSelect.md#__updaterenderpath)
- [getMotionPathData](IEditSelect.md#getmotionpathdata)
- [getMotionPoint](IEditSelect.md#getmotionpoint)
- [getMotionTotal](IEditSelect.md#getmotiontotal)
- [\_\_updateMotionPath](IEditSelect.md#__updatemotionpath)
- [\_\_runAnimation](IEditSelect.md#__runanimation)
- [\_\_emitLifeEvent](IEditSelect.md#__emitlifeevent)
- [\_\_updateSortChildren](IEditSelect.md#__updatesortchildren)
- [dropTo](IEditSelect.md#dropto)
- [\_\_realSetAttr](IEditSelect.md#__realsetattr)
- [emitPropertyEvent](IEditSelect.md#emitpropertyevent)
- [destroyEventer](IEditSelect.md#destroyeventer)
- [on](IEditSelect.md#on)
- [off](IEditSelect.md#off)
- [on\_](IEditSelect.md#on_)
- [off\_](IEditSelect.md#off_)
- [once](IEditSelect.md#once)
- [emit](IEditSelect.md#emit)
- [emitEvent](IEditSelect.md#emitevent)
- [hasEvent](IEditSelect.md#hasevent)
- [destroy](IEditSelect.md#destroy)
- [pick](IEditSelect.md#pick)
- [add](IEditSelect.md#add)
- [addAt](IEditSelect.md#addat)
- [addAfter](IEditSelect.md#addafter)
- [addBefore](IEditSelect.md#addbefore)
- [addMany](IEditSelect.md#addmany)
- [remove](IEditSelect.md#remove)
- [removeAll](IEditSelect.md#removeall)
- [clear](IEditSelect.md#clear)
- [reset](IEditSelect.md#reset)
- [set](IEditSelect.md#set)
- [toJSON](IEditSelect.md#tojson)
- [get](IEditSelect.md#get)
- [createProxyData](IEditSelect.md#createproxydata)
- [clearProxyData](IEditSelect.md#clearproxydata)
- [find](IEditSelect.md#find)
- [findTag](IEditSelect.md#findtag)
- [findOne](IEditSelect.md#findone)
- [findId](IEditSelect.md#findid)
- [getPath](IEditSelect.md#getpath)
- [getPathString](IEditSelect.md#getpathstring)
- [asPath](IEditSelect.md#aspath)
- [load](IEditSelect.md#load)
- [\_\_drawPathByData](IEditSelect.md#__drawpathbydata)
- [\_\_drawPathByBox](IEditSelect.md#__drawpathbybox)
- [\_\_drawAfterFill](IEditSelect.md#__drawafterfill)
- [\_\_drawContent](IEditSelect.md#__drawcontent)
- [drawImagePlaceholder](IEditSelect.md#drawimageplaceholder)
- [animate](IEditSelect.md#animate)
- [killAnimate](IEditSelect.md#killanimate)
- [export](IEditSelect.md#export)
- [syncExport](IEditSelect.md#syncexport)
- [clone](IEditSelect.md#clone)
...
[src/in/packages/interface/src/editor/IEditSelect.ts:8](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L8)
...
[src/in/packages/interface/src/editor/IEditSelect.ts:10](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L10)
...
[src/in/packages/interface/src/editor/IEditSelect.ts:11](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L11)

___

### hoverStroker

• **hoverStroker**: [`IStroker`](IStroker.md)

#### Defined in

[src/in/packages/interface/src/editor/IEditSelect.ts:13](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L13)

___

### targetStroker

• **targetStroker**: [`IStroker`](IStroker.md)

#### Defined in

[src/in/packages/interface/src/editor/IEditSelect.ts:14](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L14)

___

### selectArea

• **selectArea**: [`ISelectArea`](ISelectArea.md)

#### Defined in

[src/in/packages/interface/src/editor/IEditSelect.ts:16](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L16)
...
[src/in/packages/interface/src/editor/IEditSelect.ts:17](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L17)
...
| Name | Type |
| :------ | :------ |
| `e` | [`IPointerEvent`](IPointerEvent.md) |
...
[src/in/packages/interface/src/editor/IEditSelect.ts:19](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L19)

___

### findDeepOne

▸ **findDeepOne**(`e`): [`IUI`](IUI.md)
...
[src/in/packages/interface/src/editor/IEditSelect.ts:20](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L20)
...
[src/in/packages/interface/src/editor/IEditSelect.ts:21](https://github.com/leaferjs/leafer-in/blob/d97f6888a45310d40717e43f47796d4f7d0dce1d/packages/interface/src/editor/IEditSelect.ts#L21)
...
▸ **get**\<`K`\>(`name`): [`IEditSelect`](IEditSelect.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IEditSelect`](IEditSelect.md) |
