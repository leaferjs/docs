...
- [scaleFixed](IFrame.md#scalefixed)
...
- [\_\_hasComplex](IFrame.md#__hascomplex)
...
- [strokeScaleFixed](IFrame.md#strokescalefixed)
...
- [startLinker](IFrame.md#startlinker)
- [endLinker](IFrame.md#endlinker)
...
- [clearProxyData](IFrame.md#clearproxydata)
- [find](IFrame.md#find)
...
[src/ui/packages/interface/src/IUI.ts:389](https://github.com/leaferjs/leafer-ui/blob/88373cdd6f1051b44f1295f2d1866778d0675b15/packages/interface/src/IUI.ts#L389)
...
▸ **get**\<`K`\>(`name`): [`IFrame`](IFrame.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IFrame`](IFrame.md) |
