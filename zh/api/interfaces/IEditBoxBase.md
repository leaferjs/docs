...
- [scaleFixed](IEditBoxBase.md#scalefixed)
...
- [skipJSON](IEditBoxBase.md#skipjson)
...
- [\_\_nowWorldShapeBounds](IEditBoxBase.md#__nowworldshapebounds)
...
- [\_\_hasComplex](IEditBoxBase.md#__hascomplex)
...
- [strokeScaleFixed](IEditBoxBase.md#strokescalefixed)
...
- [startLinker](IEditBoxBase.md#startlinker)
- [endLinker](IEditBoxBase.md#endlinker)
...
- [clearProxyData](IEditBoxBase.md#clearproxydata)
...
[src/ui/packages/interface/src/editor/IEditor.ts:272](https://github.com/leaferjs/leafer-ui/blob/88373cdd6f1051b44f1295f2d1866778d0675b15/packages/interface/src/editor/IEditor.ts#L272)
...
▸ **get**\<`K`\>(`name`): [`IEditBoxBase`](IEditBoxBase.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IEditBoxBase`](IEditBoxBase.md) |
...
[`IEditBoxBase`](IEditBoxBase.md)[`K`]
