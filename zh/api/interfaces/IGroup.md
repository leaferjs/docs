...
- [bright](IGroup.md#bright)
- [mask](IGroup.md#mask)
- [eraser](IGroup.md#eraser)
- [filter](IGroup.md#filter)
- [complex](IGroup.md#complex)
- [x](IGroup.md#x)
- [y](IGroup.md#y)
...
- [scaleFixed](IGroup.md#scalefixed)
...
- [\_\_nowWorldShapeBounds](IGroup.md#__nowworldshapebounds)
...
- [\_\_hasComplex](IGroup.md#__hascomplex)
...
- [strokeScaleFixed](IGroup.md#strokescalefixed)
...
- [startLinker](IGroup.md#startlinker)
- [endLinker](IGroup.md#endlinker)
...
- [clearProxyData](IGroup.md#clearproxydata)
- [find](IGroup.md#find)
...
▸ **get**\<`K`\>(`name`): [`IGroup`](IGroup.md)[`K`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`IGroup`](IGroup.md) |
