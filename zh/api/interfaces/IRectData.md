...
- [\_\_willDestroy](IRectData.md#__willdestroy)
- [id](IRectData.md#id)
...
- [scaleFixed](IRectData.md#scalefixed)
...
- [renderSpread](IRectData.md#renderspread)
- [path](IRectData.md#path)
- [windingRule](IRectData.md#windingrule)
...
- [dragBoundsType](IRectData.md#dragboundstype)
...
- [\_\_complexData](IRectData.md#__complexdata)
...
- [\_\_useStroke](IRectData.md#__usestroke)
- [\_\_useArrow](IRectData.md#__usearrow)
- [\_\_useEffect](IRectData.md#__useeffect)
- [\_\_usePathBox](IRectData.md#__usepathbox)
- [\_\_useDim](IRectData.md#__usedim)
...
- [\_\_startArrowPath](IRectData.md#__startarrowpath)
- [\_\_endArrowPath](IRectData.md#__endarrowpath)
...
- [placeholderColor](IRectData.md#placeholdercolor)
- [placeholderDelay](IRectData.md#placeholderdelay)
...
- [\_\_maxStrokeWidth](IRectData.md#__maxstrokewidth)
- [\_\_strokeWidthCache](IRectData.md#__strokewidthcache)
- [\_\_hasMultiStrokeStyle](IRectData.md#__hasmultistrokestyle)
- [\_\_hasMultiPaint](IRectData.md#__hasmultipaint)
- [\_\_isAlphaPixelFill](IRectData.md#__isalphapixelfill)
- [\_\_isAlphaPixelStroke](IRectData.md#__isalphapixelstroke)
- [\_\_isTransparentFill](IRectData.md#__istransparentfill)
- [\_\_isTransparentStroke](IRectData.md#__istransparentstroke)
- [\_\_isHitPixel](IRectData.md#__ishitpixel)
- [\_\_isCanvas](IRectData.md#__iscanvas)
- [\_\_isFastShadow](IRectData.md#__isfastshadow)
- [\_\_fillAfterStroke](IRectData.md#__fillafterstroke)
...
- [\_\_getRealStrokeWidth](IRectData.md#__getrealstrokewidth)
- [\_\_setPaint](IRectData.md#__setpaint)
- [\_\_removePaint](IRectData.md#__removepaint)
