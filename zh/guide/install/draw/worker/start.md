...
相对 [@leafer-ui/worker](../../ui/worker/start.md)，减少了 [App](../../../../reference/display/App.md) 、事件交互等功能，适用于纯绘图场景。
...
```js [worker.min.js]
importScripts('https://unpkg.com/@leafer-draw/worker@2.1.11/dist/worker.min.js')
```

```js [worker.js]
importScripts('https://unpkg.com/@leafer-draw/worker@2.1.11/dist/worker.js')
```
