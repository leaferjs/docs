...
LeaferJS 采用 MIT 协议，免费开源，使用前请阅读 [免责声明](./disclaimer.md)。

我们鼓励社区用户相互帮助、分享经验，共同参与 LeaferJS 的建设。由于精力有限，我们无法解答或修复所有问题，但会尽力参与和维护。

我们的主要精力将持续投入在产品开发与开源建设上，也希望更多开发者参与进来，让 LeaferJS 变得更强大，让开源社区更加繁荣。
...
希望我们能一起创办出 **一家新型互联网企业和社区，** 如果你喜欢这样的文化，欢迎了解 [开源森林](../forest/welcome.md)，可以按照你自己的节奏逐步参与进来。
