...
<script src="https://unpkg.com/@leafer-in/motion-path@2.2.3/dist/motion-path.min.js"></script>
```

```html [motion-path]
<script src="https://unpkg.com/@leafer-in/motion-path@2.2.3/dist/motion-path.js"></script>
```
